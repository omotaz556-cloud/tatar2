...
if (!empty($_GET['id'])) {
	...
	<link href="<?php echo GP_LOCATE; ?>lang/en/statistiken.css?f4b7i" rel="stylesheet" type="text/css" />
	<?php
...
if(isset($_GET['id'])) {
	switch($_GET['id']) {
		...
		case 43:
			...
			break;
		case 50:
			// Statistici grafice (Novaterra Plus). Sablonul isi verifica singur si
