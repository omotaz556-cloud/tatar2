...
$GLOBALS['INSTALL_STRINGS'] = [
    'en' => [
        ...
        'server_duration'   => 'Server duration',
        'server_speed_intro'=> 'Choose the server duration and the speed is set automatically:',
        'server_speed_formula' => 'Simple formula: speed = 300 / number of days',
        'server_speed_timings' => 'Engine timings: artifacts at speed / 100 days, building plans at speed / 200, and wonders at speed / 250.',
        'server_speed_note' => 'Army movement speed does not follow server speed. It stays at twice the normal speed.',
        'duration_days'     => 'days',
        'duration_day'      => 'day',
    ...
    'ar' => [
        ...
        'server_duration'   => 'مدة السيرفر',
        'server_speed_intro'=> 'اختر مدة السيرفر وستُضبط السرعة تلقائيًا:',
        'server_speed_formula' => 'المعادلة: السرعة = 300 ÷ عدد الأيام',
        'server_speed_timings' => 'التوقيتات: التحف عند السرعة ÷ 100 يوم، وخطط المعجزة عند السرعة ÷ 200، وبدء المعجزة عند السرعة ÷ 250.',
        'server_speed_note' => 'تنبيه: سرعة نقل الجيوش لا تتبع سرعة السيرفر، وتبقى ضعفين مهما رفعت السرعة.',
        'duration_days'     => 'أيام',
        'duration_day'      => 'يوم',
