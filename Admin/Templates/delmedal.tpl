	...
	<tbody>
		<?php
			for($j = 0; $j<$week; $j++)
			{
				...
				echo "<tr><td>$newweek</td><td>$tot</td><td><input type=\"image\" name=\"medalweek\" value=\"".$newweek."\" style=\"background-image: url('../gpack/novaterra_classic/img/a/del.gif'); height: 12px; width: 12px;\" src=\"../gpack/novaterra_classic/img/a/x.gif\"></td>";
			}
		?>
	</tbody>
</table>
