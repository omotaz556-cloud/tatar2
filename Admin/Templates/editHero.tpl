...
if(isset($_GET['uid'])){
    ...
    if ($hero === null) {
        echo '<p style="padding:12px;color:#b91c1c;">No hero found for this player.</p>';
        echo '<p><a href="admin.php?p=player&uid='.(int)$id.'">&laquo; Back</a></p>';
    } else {
