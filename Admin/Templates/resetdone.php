...
// generated in resetServer.php, then clears it from session so it can't be
// re-displayed by refreshing this page.
$mh_password = $_SESSION['mh_reset_password'] ?? '(unavailable — check admin_log or reset Multihunter password manually)';
