...
body > img[src*="Novaterra"], img[src*="admin.gif"]{display:none !important}
...
<div class="login-page">
  <div class="login-container">
    ...
    <div class="login-header">
      <div class="novaterra-logo">TRA<span>VIAN</span>Z</div>
    ...
    <div class="login-card">
      <div class="login-title">
        ...
        <p><?php echo ADM_SECURE_ACCESS_TO_NOVATERRA_PANEL; ?></p>
      </div>
