        ...
        <div class="config-card">
            ...
            <table class="config-table">
                ...
                <tr>
                    ...
                    <td>
                        <select name="qtype">
                            <option value="25" <?php if(QTYPE == 25) echo "selected";?>><?php echo ADM_NOVATERRA_OFFICIAL; ?></option>
                            <option value="37" <?php if(QTYPE == 37) echo "selected";?>><?php echo ADM_NOVATERRA_EXTENDED; ?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                            $gpCurrent = defined('GP_LOCATE') ? GP_LOCATE : 'gpack/novaterra_classic/';
