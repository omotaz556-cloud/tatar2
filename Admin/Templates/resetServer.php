...
// 4. Conturi sistem
// SECURITY FIX (2026-08-15): previously hashed a hardcoded weak password
// ("12345"). Now generates a random password per reset and hands it to
// resetdone.php via session (never via URL/GET) for one-time display.
$mh_plain_password = bin2hex(random_bytes(6)); // 12 hex chars, random per reset
...
(1, 'Support', '', 'support@novaterra.example', 0, 8, 0, 0, 0),
(2, 'Nature', '', 'nature@novaterra.example', 4, 8, 0, 0, 0),
(4, 'Taskmaster', '', 'taskmaster@novaterra.example', 0, 8, 0, 0, 0),
(5, 'Multihunter', '$passw', 'multihunter@novaterra.mail', 0, 9, 0, 0, 0)");
