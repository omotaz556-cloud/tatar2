    ...
    <form action="../GameEngine/Admin/Mods/editExtraSet.php" method="POST">
        ...
        <div class="config-card">
            <div class="config-head">
                <span><?php echo EDIT_EXTRA_SETT ?></span>
            </div>
            <table class="config-table">
                ...
                <tr>
                    <td class="b"><?php echo CONF_EXTRA_MAXMAIL ?> <em class="tooltip">?<span class="classic"><?php echo CONF_EXTRA_MAXMAIL_TOOLTIP ?></span></em></td>
                    <td>30</td>
                </tr>
                </tbody>
            </table>
