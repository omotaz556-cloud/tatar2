 ...
 * absent (IDs are always >= 1 in Novaterra).
 */
...
// other Novaterra bootstrap code — we only add, never remove.
if (!headers_sent()) {
            ...
            <div id="lleft">
                ...
                <p class="center-img">
                    <a href="<?php echo e(HOMEPAGE); ?>">
                        <img src="/Admin/img/novaterra_admin_logo.png"
                             alt="Novaterra Admin Panel"
