...
<div id="build" class="gid29">
    ...
    <?php $trainlist = $technology->getTrainingList(5); ?>
    ...
    <?php $trainlist = $technology->getTrainingList(5); include("training_gold.tpl"); if (count($trainlist) > 0): $TrainCount = 0; $NextFinished = '';?>
