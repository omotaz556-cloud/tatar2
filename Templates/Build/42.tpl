...
<div id="build" class="gid42">
    <img class="wall-model" src="gpack/novaterra_classic/img/g/g42.gif" alt="<?php echo STONEWALL;?>" style="float:right;margin:2px 0 10px 14px;max-width:110px;height:auto;" />
