...
<div id="build" class="gid50">
    <img class="wall-model" src="gpack/novaterra_classic/img/g/g50.gif" alt="<?php echo BARRICADE;?>" style="float:right;margin:2px 0 10px 14px;max-width:110px;height:auto;" />
