...
<div id="build" class="gid31">
    <img class="wall-model" src="gpack/novaterra_classic/img/g/g31.gif" alt="<?php echo CITYWALL;?>" style="float:right;margin:2px 0 10px 14px;max-width:110px;height:auto;" />
