...
<div id="build" class="gid43">
    <img class="wall-model" src="gpack/novaterra_classic/img/g/g43.gif" alt="<?php echo MAKESHIFTWALL;?>" style="float:right;margin:2px 0 10px 14px;max-width:110px;height:auto;" />
