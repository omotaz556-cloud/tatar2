...
<div id="build" class="gid32">
    <img class="wall-model" src="gpack/novaterra_classic/img/g/g32.gif" alt="<?php echo EARTHWALL;?>" style="float:right;margin:2px 0 10px 14px;max-width:110px;height:auto;" />
