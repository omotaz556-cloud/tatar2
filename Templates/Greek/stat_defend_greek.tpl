<?php
/**
 * Greek.sa most successful defenders ranking.
 */
...
$pageTitle = defined('TZ_THE_MOST_SUCCESSFUL_DEFENDERS')
    ? TZ_THE_MOST_SUCCESSFUL_DEFENDERS : 'أكثر المدافعين نجاحًا';
?>
...
<a title="<?php echo DEFENDER; ?>" href="statistiken.php?id=32"><img class="btn_def active" src="img/x.gif" alt="" /></a>
...
if (count($rankArray) > 1) {
    for ($i = $start; $i < $start + 20; $i++) {
        ...
        echo '<th class="po' . $lcCls . '"><bdi dir="ltr">' . number_format((int) ($row['dpall'] ?? 0)) . '</bdi></th>';
        echo '</tr>';
    }
} else {
