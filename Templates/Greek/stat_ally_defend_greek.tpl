<?php
/**
 * Greek.sa best alliances (defense) — statistiken.php?id=42
 */
...
$pageTitle = defined('TZ_THE_BEST_ALLIANCES_DEF')
    ? TZ_THE_BEST_ALLIANCES_DEF : 'أفضل التحالفات (دفاع)';
?>
...
<a title="<?php echo DEFENDER; ?>" href="statistiken.php?id=42"><img class="btn_def active" src="img/x.gif" alt="" /></a>
