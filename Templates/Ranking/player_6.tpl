        ...
        <tr>
            <th colspan="5">
                <div class="statHeadBar">
                    ...
                    <span class="statHeadTitle"><?php echo TZ_THE_LARGEST_HUNS; ?></span>
                    <div id="submenu2">
                    ...
                    <?php if (defined('NEW_FUNCTION_TRIBE_HUNS') && NEW_FUNCTION_TRIBE_HUNS): ?><a title="<?php echo TRIBE6; ?>" href="statistiken.php?id=16"><img class="active btn_v6" src="img/x.gif" alt="<?php echo TRIBE6; ?>"></a><?php endif; ?>
