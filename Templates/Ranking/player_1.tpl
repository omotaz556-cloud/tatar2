        ...
        <tr>
            <th colspan="5">
                <div class="statHeadBar">
                    ...
                    <span class="statHeadTitle"><?php echo TZ_THE_LARGEST_ROMANS; ?></span>
                    <div id="submenu2">
                    <a title="<?php echo TRIBE1; ?>" href="statistiken.php?id=11"><img class="active btn_v1" src="img/x.gif" alt="<?php echo ATTACKER; ?>"></a>
