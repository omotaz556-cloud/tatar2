        ...
        <tr>
            <th colspan="5">
                <div class="statHeadBar">
                    ...
                    <span class="statHeadTitle"><?php echo TZ_THE_LARGEST_EGYPTIANS; ?></span>
                    <div id="submenu2">
                    ...
                    <?php if (defined('NEW_FUNCTION_TRIBE_EGIPTEANS') && NEW_FUNCTION_TRIBE_EGIPTEANS): ?><a title="<?php echo TRIBE7; ?>" href="statistiken.php?id=17"><img class="active btn_v7" src="img/x.gif" alt="<?php echo TRIBE7; ?>"></a><?php endif; ?>
