        ...
        <tr>
            <th colspan="5">
                <div class="statHeadBar">
                    ...
                    <span class="statHeadTitle"><?php echo TZ_THE_LARGEST_VIKINGS; ?></span>
                    <div id="submenu2">
                    ...
                    <?php if (defined('NEW_FUNCTION_TRIBE_VIKINGS') && NEW_FUNCTION_TRIBE_VIKINGS): ?><a title="<?php echo TRIBE9; ?>" href="statistiken.php?id=19"><img class="active btn_v9" src="img/x.gif" alt="<?php echo TRIBE9; ?>"></a><?php endif; ?>
                    </div>
                </div>
            </th>
        </tr>
