<h1><img class="unit u68" src="img/x.gif" alt="<?php echo U68; ?>" title="<?php echo U68; ?>" /> <?php echo U68; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>65</td><td>55</td><td>10</td>
	<td>980</td><td>1510</td><td>660</td><td>100</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u68" src="img/x.gif" alt="<?php echo U68; ?>" title="<?php echo U68; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_68; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=69" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
