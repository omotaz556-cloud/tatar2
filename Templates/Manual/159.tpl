<h1><img class="unit u59" src="img/x.gif" alt="<?php echo U59; ?>" title="<?php echo U59; ?>" /> <?php echo U59; ?> <span class="tribe">(<?php echo TRIBE6; ?>)</span></h1>
...
<tbody><tr>
	<td>50</td><td>40</td><td>30</td>
	<td>37200</td><td>27600</td><td>25200</td><td>27600</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u59" src="img/x.gif" alt="<?php echo U59; ?>" title="<?php echo U59; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_59; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=44"><?php echo COMMANDCENTER; ?></a> <?php echo LEVEL; ?> 10, <a href="manual.php?typ=4&amp;gid=16"><?php echo RALLYPOINT; ?></a> <?php echo LEVEL; ?> 10, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 20</div>
<map id="nav" name="nav">
