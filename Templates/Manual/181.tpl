<h1><img class="unit u81" src="img/x.gif" alt="<?php echo U81; ?>" title="<?php echo U81; ?>" /> <?php echo U81; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	...
	<td>105</td><td>85</td><td>65</td><td>35</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:16:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u81" src="img/x.gif" alt="<?php echo U81; ?>" title="<?php echo U81; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_81; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=82" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
