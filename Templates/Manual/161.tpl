<h1><img class="unit u61" src="img/x.gif" alt="<?php echo U61; ?>" title="<?php echo U61; ?>" /> <?php echo U61; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>10</td><td>30</td><td>20</td>
	<td>45</td><td>60</td><td>30</td><td>30</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:10:40</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u61" src="img/x.gif" alt="<?php echo U61; ?>" title="<?php echo U61; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_61; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=62" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
