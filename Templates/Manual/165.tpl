<h1><img class="unit u65" src="img/x.gif" alt="<?php echo U65; ?>" title="<?php echo U65; ?>" /> <?php echo U65; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>50</td><td>110</td><td>50</td>
	<td>360</td><td>330</td><td>280</td><td>120</td>
</tr></tbody>
</table>
...
<tbody><tr>
	...
	<td><b>15</b> <?php echo MANUAL_FIELDS_HOUR; ?></td>
</tr>
<tr>
...
<img id="big_unit" class="big_u65" src="img/x.gif" alt="<?php echo U65; ?>" title="<?php echo U65; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_65; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 5, <a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 5</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=66" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
