<h1><img class="unit u89" src="img/x.gif" alt="<?php echo U89; ?>" title="<?php echo U89; ?>" /> <?php echo U89; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	...
	<td>35800</td><td>29200</td><td>28600</td><td>31500</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u89" src="img/x.gif" alt="<?php echo U89; ?>" title="<?php echo U89; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_89; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=90" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
