<h1><img class="unit ugeb" src="img/x.gif" alt="" title="" /> <?php echo BUILDINGS; ?> (<?php echo Q17_BUTN1; ?>)</h1>
<ul>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=3&amp;s=3" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
