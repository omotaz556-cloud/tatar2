<h1><img class="unit u72" src="img/x.gif" alt="<?php echo U72; ?>" title="<?php echo U72; ?>" /> <?php echo U72; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>40</td><td>85</td><td>45</td>
	<td>145</td><td>95</td><td>245</td><td>45</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:32:30</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u72" src="img/x.gif" alt="<?php echo U72; ?>" title="<?php echo U72; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_72; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=73" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
