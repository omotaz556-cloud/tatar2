<h1><img class="unit u52" src="img/x.gif" alt="<?php echo U52; ?>" title="<?php echo U52; ?>" /> <?php echo U52; ?> <span class="tribe">(<?php echo TRIBE6; ?>)</span></h1>
...
<img id="big_unit" class="big_u52" src="img/x.gif" alt="<?php echo U52; ?>" title="<?php echo U52; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_52; ?></div>
