<h1><img class="unit u71" src="img/x.gif" alt="<?php echo U71; ?>" title="<?php echo U71; ?>" /> <?php echo U71; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>50</td><td>35</td><td>30</td>
	<td>110</td><td>185</td><td>110</td><td>35</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:28:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u71" src="img/x.gif" alt="<?php echo U71; ?>" title="<?php echo U71; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_71; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=72" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
