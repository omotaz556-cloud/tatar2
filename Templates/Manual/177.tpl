<h1><img class="unit u77" src="img/x.gif" alt="<?php echo U77; ?>" title="<?php echo U77; ?>" /> <?php echo U77; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>65</td><td>30</td><td>85</td>
	<td>980</td><td>545</td><td>390</td><td>80</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u77" src="img/x.gif" alt="<?php echo U77; ?>" title="<?php echo U77; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_77; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=78" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
