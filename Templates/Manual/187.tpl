<h1><img class="unit u87" src="img/x.gif" alt="<?php echo U87; ?>" title="<?php echo U87; ?>" /> <?php echo U87; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>65</td><td>35</td><td>80</td>
	<td>1010</td><td>415</td><td>440</td><td>75</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 1:18:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u87" src="img/x.gif" alt="<?php echo U87; ?>" title="<?php echo U87; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_87; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=21"><?php echo WORKSHOP; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 10, <a href="manual.php?typ=4&amp;gid=21"><?php echo WORKSHOP; ?></a> <?php echo LEVEL; ?> 1</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=88" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
