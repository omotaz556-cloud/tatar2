<h1><img class="unit u66" src="img/x.gif" alt="<?php echo U66; ?>" title="<?php echo U66; ?>" /> <?php echo U66; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>110</td><td>120</td><td>150</td>
	<td>450</td><td>560</td><td>610</td><td>180</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u66" src="img/x.gif" alt="<?php echo U66; ?>" title="<?php echo U66; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_66; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=67" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
