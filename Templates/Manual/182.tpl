<h1><img class="unit u82" src="img/x.gif" alt="<?php echo U82; ?>" title="<?php echo U82; ?>" /> <?php echo U82; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>0</td><td>15</td><td>8</td>
	<td>155</td><td>110</td><td>45</td><td>45</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u82" src="img/x.gif" alt="<?php echo U82; ?>" title="<?php echo U82; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_82; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=19"><?php echo BARRACKS; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=15"><?php echo MAINBUILDING; ?></a> <?php echo LEVEL; ?> 5</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=83" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
