<h1><img class="unit u55" src="img/x.gif" alt="<?php echo U55; ?>" title="<?php echo U55; ?>" /> <?php echo U55; ?> <span class="tribe">(<?php echo TRIBE6; ?>)</span></h1>
...
<tbody><tr>
	<td>180</td><td>60</td><td>40</td>
	<td>450</td><td>560</td><td>610</td><td>140</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u55" src="img/x.gif" alt="<?php echo U55; ?>" title="<?php echo U55; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_55; ?></div>
