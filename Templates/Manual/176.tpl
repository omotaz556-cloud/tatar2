<h1><img class="unit u76" src="img/x.gif" alt="<?php echo U76; ?>" title="<?php echo U76; ?>" /> <?php echo U76; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>195</td><td>55</td><td>80</td>
	<td>660</td><td>495</td><td>995</td><td>165</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:57:30</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u76" src="img/x.gif" alt="<?php echo U76; ?>" title="<?php echo U76; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_76; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=77" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
