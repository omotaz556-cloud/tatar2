<h1><img class="unit u67" src="img/x.gif" alt="<?php echo U67; ?>" title="<?php echo U67; ?>" /> <?php echo U67; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>55</td><td>30</td><td>95</td>
	<td>995</td><td>575</td><td>340</td><td>80</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 1:20:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u67" src="img/x.gif" alt="<?php echo U67; ?>" title="<?php echo U67; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_67; ?></div>
...
<map id="nav" name="nav">
    <area href="manual.php?s=7&amp;typ=2" title="<?php echo BACK; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo OVERVIEW; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=68" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
