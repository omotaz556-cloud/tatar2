<h1><img class="unit u58" src="img/x.gif" alt="<?php echo U58; ?>" title="<?php echo U58; ?>" /> <?php echo U58; ?> <span class="tribe">(<?php echo TRIBE6; ?>)</span></h1>
...
<tbody><tr>
	<td>45</td><td>55</td><td>10</td>
	<td>950</td><td>1280</td><td>620</td><td>60</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u58" src="img/x.gif" alt="<?php echo U58; ?>" title="<?php echo U58; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_58; ?></div>
