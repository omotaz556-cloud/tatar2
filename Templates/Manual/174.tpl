<h1><img class="unit u74" src="img/x.gif" alt="<?php echo U74; ?>" title="<?php echo U74; ?>" /> <?php echo U74; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>0</td><td>25</td><td>12</td>
	<td>185</td><td>150</td><td>35</td><td>75</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u74" src="img/x.gif" alt="<?php echo U74; ?>" title="<?php echo U74; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_74; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=19"><?php echo BARRACKS; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=12"><?php echo BLACKSMITH; ?></a> <?php echo LEVEL; ?> 1</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=75" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
