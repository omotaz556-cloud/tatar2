<h1><img class="unit u79" src="img/x.gif" alt="<?php echo U79; ?>" title="<?php echo U79; ?>" /> <?php echo U79; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>45</td><td>50</td><td>45</td>
	<td>33450</td><td>30665</td><td>36240</td><td>27375</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u79" src="img/x.gif" alt="<?php echo U79; ?>" title="<?php echo U79; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_79; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=25"><?php echo RESIDENCE; ?></a> <?php echo LEVEL; ?> 10, <a href="manual.php?typ=4&amp;gid=16"><?php echo RALLYPOINT; ?></a> <?php echo LEVEL; ?> 10, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 20</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=80" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
