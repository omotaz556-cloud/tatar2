<h1><img class="unit u70" src="img/x.gif" alt="<?php echo U70; ?>" title="<?php echo U70; ?>" /> <?php echo U70; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>0</td><td>80</td><td>80</td>
	<td>5040</td><td>6510</td><td>4830</td><td>4620</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 6:53:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u70" src="img/x.gif" alt="<?php echo U70; ?>" title="<?php echo U70; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_70; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=2&amp;s=7" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
