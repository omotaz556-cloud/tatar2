<h1><img class="unit u86" src="img/x.gif" alt="<?php echo U86; ?>" title="<?php echo U86; ?>" /> <?php echo U86; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>165</td><td>95</td><td>100</td>
	<td>590</td><td>640</td><td>715</td><td>160</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:55:00</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u86" src="img/x.gif" alt="<?php echo U86; ?>" title="<?php echo U86; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_86; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 15, <a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 10</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=87" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
