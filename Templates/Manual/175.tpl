<h1><img class="unit u75" src="img/x.gif" alt="<?php echo U75; ?>" title="<?php echo U75; ?>" /> <?php echo U75; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>55</td><td>120</td><td>90</td>
	<td>555</td><td>445</td><td>330</td><td>110</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:43:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u75" src="img/x.gif" alt="<?php echo U75; ?>" title="<?php echo U75; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_75; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 3</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=76" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
