<h1><img class="unit u56" src="img/x.gif" alt="<?php echo U56; ?>" title="<?php echo U56; ?>" /> <?php echo U56; ?> <span class="tribe">(<?php echo TRIBE6; ?>)</span></h1>
...
<tbody><tr>
	<td>230</td><td>90</td><td>65</td>
	<td>660</td><td>750</td><td>800</td><td>180</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u56" src="img/x.gif" alt="<?php echo U56; ?>" title="<?php echo U56; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_56; ?></div>
