<h1><img class="unit u84" src="img/x.gif" alt="<?php echo U84; ?>" title="<?php echo U84; ?>" /> <?php echo U84; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>105</td><td>45</td><td>30</td>
	<td>190</td><td>220</td><td>340</td><td>90</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:32:40</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u84" src="img/x.gif" alt="<?php echo U84; ?>" title="<?php echo U84; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_84; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=19"><?php echo BARRACKS; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 5, <a href="manual.php?typ=4&amp;gid=12"><?php echo BLACKSMITH; ?></a> <?php echo LEVEL; ?> 1</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=85" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
