<h1><img class="unit u78" src="img/x.gif" alt="<?php echo U78; ?>" title="<?php echo U78; ?>" /> <?php echo U78; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	<td>60</td><td>55</td><td>10</td>
	<td>1200</td><td>1240</td><td>610</td><td>80</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u78" src="img/x.gif" alt="<?php echo U78; ?>" title="<?php echo U78; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_78; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=21"><?php echo WORKSHOP; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 15, <a href="manual.php?typ=4&amp;gid=21"><?php echo WORKSHOP; ?></a> <?php echo LEVEL; ?> 10</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=79" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
