...
<map id="nav" name="nav">
    ...
    <area href="<?php echo NEW_FUNCTIONS_MANUAL_NATURENATARS ? "manual.php?typ=2&amp;s=4" : "manual.php?typ=3&amp;s=1"; ?>" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
