<h1><img class="unit u62" src="img/x.gif" alt="<?php echo U62; ?>" title="<?php echo U62; ?>" /> <?php echo U62; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>30</td><td>55</td><td>40</td>
	<td>115</td><td>100</td><td>145</td><td>60</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:24:10</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u62" src="img/x.gif" alt="<?php echo U62; ?>" title="<?php echo U62; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_62; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=19"><?php echo BARRACKS; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=13"><?php echo ARMOURY; ?></a> <?php echo LEVEL; ?> 1</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=63" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
