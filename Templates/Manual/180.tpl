<h1><img class="unit u80" src="img/x.gif" alt="<?php echo U80; ?>" title="<?php echo U80; ?>" /> <?php echo U80; ?> <span class="tribe">(<?php echo TRIBE8; ?>)</span></h1>
...
<tbody><tr>
	...
	<td>5115</td><td>5580</td><td>6360</td><td>4485</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u80" src="img/x.gif" alt="<?php echo U80; ?>" title="<?php echo U80; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_80; ?></div>
