<h1><img class="unit u63" src="img/x.gif" alt="<?php echo U63; ?>" title="<?php echo U63; ?>" /> <?php echo U63; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>25</td><td>110</td><td>80</td>
	<td>170</td><td>180</td><td>220</td><td>80</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u63" src="img/x.gif" alt="<?php echo U63; ?>" title="<?php echo U63; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_63; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=64" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
