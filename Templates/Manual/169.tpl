<h1><img class="unit u69" src="img/x.gif" alt="<?php echo U69; ?>" title="<?php echo U69; ?>" /> <?php echo U69; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>40</td><td>50</td><td>50</td>
	<td>34000</td><td>50000</td><td>34000</td><td>42000</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u69" src="img/x.gif" alt="<?php echo U69; ?>" title="<?php echo U69; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_69; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=70" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
