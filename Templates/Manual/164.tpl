<h1><img class="unit u64" src="img/x.gif" alt="<?php echo U64; ?>" title="<?php echo U64; ?>" /> <?php echo U64; ?> <span class="tribe">(<?php echo TRIBE7; ?>)</span></h1>
...
<tbody><tr>
	<td>0</td><td>20</td><td>10</td>
	<td>170</td><td>150</td><td>20</td><td>40</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u64" src="img/x.gif" alt="<?php echo U64; ?>" title="<?php echo U64; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_64; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 5, <a href="manual.php?typ=4&amp;gid=20"><?php echo STABLE; ?></a> <?php echo LEVEL; ?> 1</div>
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=65" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
