<h1><img class="unit u83" src="img/x.gif" alt="<?php echo U83; ?>" title="<?php echo U83; ?>" /> <?php echo U83; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>70</td><td>35</td><td>25</td>
	<td>145</td><td>135</td><td>185</td><td>70</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><b>55</b> <?php echo RESOURCES; ?></td>
</tr>
<tr>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 0:23:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u83" src="img/x.gif" alt="<?php echo U83; ?>" title="<?php echo U83; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_83; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=19"><?php echo BARRACKS; ?></a> <?php echo LEVEL; ?> 1, <a href="manual.php?typ=4&amp;gid=22"><?php echo ACADEMY; ?></a> <?php echo LEVEL; ?> 3, <a href="manual.php?typ=4&amp;gid=12"><?php echo BLACKSMITH; ?></a> <?php echo LEVEL; ?> 1</div>
<map id="nav" name="nav">
    <area href="manual.php?s=9&amp;typ=2" title="<?php echo BACK; ?>" coords="0,0,45,18" shape="rect" alt="" />
    <area href="manual.php?s=1" title="<?php echo OVERVIEW; ?>" coords="46,0,70,18" shape="rect" alt="" />
    <area href="manual.php?typ=1&amp;s=84" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
