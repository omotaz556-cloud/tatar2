<h1><img class="unit u90" src="img/x.gif" alt="<?php echo U90; ?>" title="<?php echo U90; ?>" /> <?php echo U90; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>10</td><td>80</td><td>80</td>
	<td>5900</td><td>5200</td><td>5700</td><td>5800</td>
</tr></tbody>
</table>
...
<tr>
	...
	<td><img class="clock" src="img/x.gif" alt="<?php echo DURATION; ?>" title="<?php echo DURATION; ?>" /> 7:38:20</td>
</tr></tbody>
</table>

<img id="big_unit" class="big_u90" src="img/x.gif" alt="<?php echo U90; ?>" title="<?php echo U90; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_90; ?></div>
<div id="prereqs"><b><?php echo PREREQUISITES; ?></b><br /><a href="manual.php?typ=4&amp;gid=25"><?php echo RESIDENCE; ?></a> <?php echo LEVEL; ?> 10</div>
<map id="nav" name="nav">
