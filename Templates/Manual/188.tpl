<h1><img class="unit u88" src="img/x.gif" alt="<?php echo U88; ?>" title="<?php echo U88; ?>" /> <?php echo U88; ?> <span class="tribe">(<?php echo TRIBE9; ?>)</span></h1>
...
<tbody><tr>
	<td>55</td><td>60</td><td>10</td>
	<td>930</td><td>1350</td><td>640</td><td>80</td>
</tr></tbody>
</table>
...
<img id="big_unit" class="big_u88" src="img/x.gif" alt="<?php echo U88; ?>" title="<?php echo U88; ?>" /><div id="t_desc"><?php echo MANUAL_UDESC_88; ?></div>
...
<map id="nav" name="nav">
    ...
    <area href="manual.php?typ=1&amp;s=89" title="<?php echo FORWARD; ?>" coords="71,0,116,18" shape="rect" alt="" />
</map>
