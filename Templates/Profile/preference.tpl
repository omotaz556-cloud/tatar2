...
<!-- =========================
         UPGRADE NAVIGATION
========================= -->
<table cellpadding="1" cellspacing="1" id="upgrade_navigation" class="set">
<thead>
<tr>
    <th colspan="2"><?php echo TZ_UPGRADE_NAVIGATION; ?></th>
</tr>
</thead>
<tbody>
<tr>
...
<tr><td colspan="2"><?php echo TZ_HERE_YOU_CAN_CHANGE_NOVATERRA_S_DISP; ?></td></tr>
</thead>
<tbody>
