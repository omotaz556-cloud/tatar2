...
/**
 * NOTE: the AJAX build-popup behaviour that used to live here has been
 * removed on request. Field/upgrade links (data-ajax-build="1") now use
 * their plain href with no JS interception, so clicking one is a normal
 * full page load to build.php - same as any other link on the site.
 * Templates/BuildPopup.tpl is a leftover empty shell and can be removed
 * from dorf1.php / dorf2.php whenever convenient; it does nothing now.
 */