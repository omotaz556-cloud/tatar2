...
<meta name="application-name" content="ارض حرب التتار">
...
<div class="world">
<a href="https://tatarwars-fv7-ex-lts-last.smartservs.net/register" title="سجل في أخر عالم في ترافيان كلاسيك">
...
<li><a href="https://tatarwars-fv7-ex-lts-last.smartservs.net/register" title="أحدث سيرفرات حرب التتار">اخر سيرفر فتح</a></li>
...
<h1 class="caption-heading">الشروط والأحكام</h1>
<div class="box-info about-desciption contact-block-2">
<div class="full-terms-info">
 <h2>1. مقدمة</h2>
        <p>مرحبًا بك في [اسم الموقع أو الخدمة]. يُرجى قراءة هذه الشروط والأحكام بعناية قبل استخدام الموقع أو الخدمة. باستخدامك للموقع أو الخدمة، فإنك توافق على الالتزام بهذه الشروط والأحكام.</p>

        <h2>2. التعديلات</h2>
        <p>تحتفظ [اسم الشركة] بالحق في تعديل أو تغيير هذه الشروط والأحكام في أي وقت. سيتم نشر أي تغييرات على هذه الصفحة، ويجب عليك مراجعتها بانتظام. استمرارك في استخدام الموقع أو الخدمة بعد أي تغييرات يعني قبولك لهذه التعديلات.</p>

        <h2>3. الاستخدام المسموح به</h2>
        <p>يجب عليك استخدام الموقع أو الخدمة فقط للأغراض القانونية وفقًا لهذه الشروط والأحكام. يمنع منعًا باتًا استخدام الموقع أو الخدمة لأي غرض غير قانوني أو احتيالي.</p>

        <h2>4. الحسابات</h2>
        <p>للاستفادة من بعض ميزات الموقع أو الخدمة، قد يُطلب منك إنشاء حساب. يجب عليك تقديم معلومات دقيقة وكاملة عند التسجيل. أنت مسؤول عن الحفاظ على سرية معلومات حسابك وأي نشاط يحدث تحت حسابك.</p>

        <h2>5. الملكية الفكرية</h2>
        <p>جميع المحتويات والمواد الموجودة على الموقع أو الخدمة، بما في ذلك النصوص والصور والشعارات، هي ملكية حصرية لـ [اسم الشركة] أو الجهات المالكة المرخصة لها. يُحظر استخدام أي من هذه المواد دون الحصول على إذن مسبق.</p>

        <h2>6. المسؤولية</h2>
        <p>لا تتحمل [اسم الشركة] أي مسؤولية عن أي أضرار مباشرة أو غير مباشرة أو تبعية قد تنجم عن استخدامك للموقع أو الخدمة. يتم تقديم الموقع والخدمة "كما هي" و"وفقًا لتوافرها".</p>

        <h2>7. الروابط الخارجية</h2>
        <p>قد يحتوي الموقع على روابط لمواقع خارجية. لا تتحمل [اسم الشركة] أي مسؤولية عن محتوى أو سياسات الخصوصية لتلك المواقع.</p>

        <h2>8. سياسة الخصوصية</h2>
        <p>نحن ملتزمون بحماية خصوصيتك. يرجى مراجعة سياسة الخصوصية الخاصة بنا لفهم كيفية جمع واستخدام معلوماتك الشخصية.</p>

        <h2>9. القانون الواجب التطبيق</h2>
        <p>تخضع هذه الشروط والأحكام لقوانين [اسم البلد]. أي نزاع ينشأ عن أو يتعلق باستخدام الموقع أو الخدمة يتم حله وفقًا للقوانين المعمول بها في [اسم البلد].</p>

        <h2>10. التواصل</h2>
        <p>لأي استفسارات أو شكاوى بشأن هذه الشروط والأحكام، يمكنك التواصل معنا عبر [بريد إلكتروني / عنوان مخصص].</p>
...
<div id="register-box">
<div>
اخر عالم تم افتتاحه هو : <b>العالم 5</b>
</div>
<a class="btn-primary" href="https://s5.x-tatar.com/register">
سجل الان
</a>
</div>
<div id="modal">
