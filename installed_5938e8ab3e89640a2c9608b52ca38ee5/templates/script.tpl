...
#footer, .footer, #ce, div[style*="GAMEBRAND"], .copyright {display:none !important;}
...
document.addEventListener('DOMContentLoaded',function(){
  ...
  h.innerHTML = `
    ...
    <div><h1><?=t('page_title')?></h1><p><?=install_is_rtl()?'معالج الإعداد • الإصدار 11.0 - إعادة هيكلة وتصميم كاملة':'Setup wizard • v.11.0 Full Refactor&Redesign'?></p></div>
  `;
  ...
  f.innerHTML = `<div><?=install_is_rtl()?'© 2010 - 2026 نوفاتيرا • جميع الحقوق محفوظة':'© 2010 - 2026 Novaterra • All rights reserved'?></div><div><?=install_is_rtl()?'السيرفر يعمل على':'Server running on'?> <b>v.10.0 Full Refactor&Redesign</b></div>`;
