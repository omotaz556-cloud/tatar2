...
$gkShell = true;
$gkPageTitle = SERVER_NAME . ' - Crop Finder';
tz_greek_shell_head($gkPageTitle, 'pg-crop_finder', array('includeNew2Js' => false));
tz_greek_shell_open('player', array('contentWrap' => true));
?>
<h1>Crop Finder</h1>
<div style="text-align: center">
    <img width="200" src="gpack/novaterra_classic/img/g/f6.jpg" />
    <img width="200" src="gpack/novaterra_classic/img/g/f1.jpg" />
</div>
<br /><br />
