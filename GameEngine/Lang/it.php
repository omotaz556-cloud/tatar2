...
//COPYRIGHT
tz_def("NOVATERRA_COPYRIGHT","Novaterra - Clone di Novaterra 100% Open Source.");
...
tz_def("Q2_REWARD","Il tuo premio:<\/p>1 giorno Novaterra");
...
tz_def("Q9_DESC","In Novaterra c'è sempre qualcosa da fare! Mentre aspetti l'arrivo dell'enorme esercito, ora dovremmo aumentare un po' la tua produzione di risorse. Estendi tutte le tue caselle di risorse al livello 1.");
...
tz_def("Q10_REWARD","Il tuo premio:<\/p>2 giorni Novaterra");
...
tz_def("Q28_DESC","Il lavoro di squadra è importante in Novaterra. I giocatori che lavorano insieme si organizzano in alleanze. Ricevi un inivito da un'alleanza nella tua regione e unisciti a questa alleanza. In alternativa, puoi fondare la tua alleanza. Per far ciò, è necessaria un ambasciata a livello 3.");
...
tz_def("T5","preso");
tz_def("T6","In attesa");
tz_def("T7","1 giorno Novaterra ");
tz_def("T8","2 giorni Novaterra ");
...
tz_def("Q25_10_REWARD","Il tuo premio:<\/p>2 giorni in più in Novaterra");
...
tz_def("Q25_28_DESC","Il mondo di Novaterra è pericoloso. Hai già costruito una botola per proteggerti dagli aggressori.<br \/><br \/>Una buona alleanza ti darà una protezione ancora migliore.");
...
tz_def("Q25_29_DESC","Il lavoro di squadra è importante in Novaterra. I giocatori che lavorano insieme si organizzano in alleanze. Ricevi un invito da un'alleanza nella tua regione e unisciti a questa alleanza. In alternativa, puoi fondare la tua alleanza. Per fare ciò, hai bisogno di un'ambasciata di livello 3.");
...
tz_def("U46","Cavaliere Tatarian");
tz_def("U47","Elefante da guerra");
tz_def("U48","Ballista");
tz_def("U49","Imperatore Tatarian");
...
tz_def("BEFORE_REGISTER","Prima di registrare un account dovresti leggere le <a href='../anleitung.php' target='_blank'>istruzioni</a> di Novaterra ro1 per vedere i vantaggi e gli svantaggi specifici delle tre tribù.");
...
tz_def("ARTEFACT","<h1><b>Artefatti di Tatar</b></h1>

Voci sussurrate riecheggiano nei villaggi, condividendo leggende raccontate solo dai migliori narratori. Si riferisce a TATARS, il guerriero più temuto del mondo NOVATERRA. La loro uccisione è il sogno di ogni eroe, lo scopo di ogni combattente. Nessuno sa come i TATARS siano riusciti a ottenere un tale potere e i loro guerrieri così crudeli. Determinati a scoprire la fonte del potere TATARS, i combattenti inviano un gruppo di spie d'élite per spiarli. Non passo molte ore e torno con la paura negli occhi e bilanciando teorie fantastiche: sembra che il potere naturale provenga dagli oggetti misteriosi che chiamano artefatti che hanno rubato ai nostri antenati. Cerca di rubare i loro artefatti e potrai controllarne il potere.

<img src=\"img/x.gif\" class=\"ArtifactsAnnouncement\">

È giunto il momento di reclamare i manufatti. Collabora con la tua alleanza e porta i tuoi guerrieri a ottenere questi oggetti ricercati. Tuttavia, TATARS non si arrenderà senza guerra ai manufatti ... né ai tuoi nemici. Se riesci a recuperare gli artefatti e sarai in grado di respingere i nemici, sarai in grado di raccogliere le ricompense. I tuoi edifici diventeranno incredibilmente forti e potenti, e le truppe saranno molto più veloci e consumeranno meno cibo. Cattura i manufatti, porta gloria al tuo impero e diventa una nuova leggenda per i tuoi seguaci.
...
Sono trascorsi innumerevoli giorni dalle prime battaglie sulle mura dei villaggi maledetti dei Dread Tatars, molti eserciti sia di quelli liberi che dell'impero Tatarian hanno lottato e sono morti davanti alle mura delle numerose roccaforti da cui un tempo i Tatar avevano governato tutta la creazione . Ora che la polvere si era calmata e si era instaurata una relativa calma, gli eserciti cominciarono a contare le loro perdite e a raccogliere i loro morti, il fetore del combattimento ancora aleggiava nell'aria della notte, un odore di un massacro indimenticabile per la sua estensione e brutalità che presto sarebbe stato sminuito da altri ancora. I più grandi eserciti dei Liberi e dei Dread Tatar si stavano schierando per l'ennesimo rinnovato assalto alle ambite ex roccaforti dell'Impero Tatarian.
Presto arrivarono gli esploratori raccontando uno spettacolo fantastico e un ricordo agghiacciante, un terribile esercito di dimensioni insondabili era stato avvistato schierarsi alla fine del mondo, la capitale Tatarian, una forza così grande e inarrestabile che la polvere della loro marcia avrebbe soffocato spegnere ogni luce, una forza così brutale e spietata che avrebbe schiacciato ogni speranza. Le persone libere sapevano che dovevano correre ora, correre contro il tempo e le infinite orde dell'Impero Tatarian per sollevare una Meraviglia del Mondo per riportare il mondo alla pace e sconfiggere la minaccia Tatarian.
...
Decine di migliaia di esploratori hanno vagato per tutta l'esistenza cercando invano questi piani mistici, cercando in tutti i luoghi tranne la temuta capitale Tatarian, ma non sono riusciti a trovarli. Oggi però tornano portando buone notizie, tornano mettendo a nudo i luoghi dei piani, nascosti dagli eserciti dei Tatar all'interno di roccaforti segrete costruite per essere celate agli occhi dell'uomo.
Ora inizia il tratto finale, quando i più grandi eserciti del Popolo Libero e dei Tatar si scontreranno in tutto il mondo per il destino di tutto ciò che giace sotto il cielo. This is the war that will echo across the eons, this is your war, and here you shall etch your name across history, here you shall become legend.
...
Molte lune fa le tribù di Novaterra furono sorprese dall'imprevisto ritorno dei Tatar. Questa tribù da tempi immemorabili che superava tutti in saggezza, potenza e gloria stava per turbare di nuovo i liberi. Così hanno messo tutti i loro sforzi nel preparare un'ultima guerra contro i Tatar e sconfiggerli per sempre. Molti hanno pensato alle cosiddette 'Meraviglie del Mondo', costruzione di tante leggende, come unica soluzione. È stato detto che avrebbe reso chiunque invincibile una volta completato. Alla fine, i costruttori sono diventati i dominatori e i conquistatori di tutti i Novaterra conosciuti.
...
Oggi, però, quest'ultimo segreto verrà svelato. Le privazioni e gli sforzi del passato non saranno stati vani, poiché oggi gli esploratori di diverse tribù hanno ottenuto con successo dove si trovavano i piani di costruzione. Ben sorvegliati dai Tatar, giacciono nascosti in diverse oasi che si trovano in tutta Novaterra. Solo gli eroi più valorosi saranno in grado di assicurarsi un tale piano e portarlo a casa sano e salvo in modo che la costruzione possa iniziare. 

Alla fine, vedremo se le tribù libere di Novaterra potranno ancora una volta superare in astuzia i Tatar e sconfiggerli una volta per tutte. Non essere così sciocco da presumere che i Tatar se ne andranno senza combattere!

<img src=\"img/x.gif\" class=\"WWBuildingPlansAnnouncement\" title=\"".PLAN."\" alt=\"".PLAN."\">

Per rubare una serie di piani di costruzione ai Tatar, devono accadere le seguenti cose:
...
tz_def("CONF_SERV_NATUNITSMULTIPLIER","Moltiplicatore unità tatars");
tz_def("CONF_SERV_NATUNITSMULTIPLIER_TOOLTIP","Questo parametro è responsabile del numero di truppe di tatars, su artefatti e villaggi meraviglia nel mondo.");
tz_def("CONF_SERV_NATARS_SPAWN_TIME","Generazione Tatar");
tz_def("CONF_SERV_NATARS_SPAWN_TIME_TOOLTIP","Dopo quanto tempo Tatar e artefatti verranno generati dalla data di inizio del server, in giorni");
...
tz_def("CONF_SERV_NATARSTAT","Mostra tatars nelle statistiche");
tz_def("CONF_SERV_NATARSTAT_TOOLTIP","Abilita (True) o disabilita (False) la visualizzazione dell'account Tatars nelle statistiche.");
...
*/
	   ...
	   $lang['index'][0][13] = "Gioca con e contro migliaia di altri giocatori reali e conquista il mondo di Novaterra.";
...
tz_def('TZ_FEATURES_OF_NOVATERRA', 'Caratteristiche di Novaterra');
...
tz_def('TZ_RELEASED_BY_NOVATERRA_TEAM', 'Rilasciato da: il team Novaterra');
tz_def('TZ_RELEASE_BY_NOVATERRA', '[Rilasciato da: Novaterra]');
...
tz_def('TZ_ADDITIONALLY_THE_NOVATERRA_TEAM_WILL', 'Inoltre, il team Novaterra non fornirà informazioni sui ban a nessuno, tranne al proprietario dell\'account.');
tz_def('TZ_ADVERTISEMENT_OF_ANY_KIND_THAT_HAS', 'Qualsiasi pubblicità non autorizzata dal team Novaterra non è consentita.');
...
tz_def('TZ_ANY_SALES_OR_PURCHASES_CONCERNING', 'Qualsiasi vendita o acquisto con denaro reale riguardante account, unità, villaggi, risorse, servizi o qualsiasi altro aspetto di Novaterra non è consentito. La vendita di account Novaterra così come qualsiasi trasferimento indiretto (anche come regalo) in connessione con siti d\'asta o altre transazioni di denaro non è consentita.');
...
tz_def('TZ_BLACKMAILING_PLAYERS_IN_A_WAY_THAT', 'Ricattare i giocatori in un modo che viola una qualsiasi delle regole di Novaterra secondo i Termini e le Condizioni Generali.');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_NOVATERRA_S_DISP', 'Qui puoi cambiare l\'ora visualizzata di Novaterra per adattarla al tuo fuso orario.');
...
tz_def('TZ_INCITING_MANIPULATING_ENCOURAGING', 'Incitare, manipolare, incoraggiare, assistere o cospirare con altri per violare una qualsiasi delle regole di Novaterra non è consentito. Queste regole si applicano senza eccezioni ai giocatori che elimineranno i loro account o li stanno eliminando.');
...
tz_def('TZ_IN_ORDER_TO_PLAY_NOVATERRA_YOU_NEED', 'Per giocare a Novaterra ti serve un indirizzo e-mail valido a cui inviare il codice di attivazione. In casi eccezionali questa e-mail potrebbe non arrivare.');
...
tz_def('TZ_IN_ORDER_TO_SWITCH_AN_ACCOUNT_WITH', 'Per scambiare un account con un\'altra persona nello stesso mondo di gioco, entrambe le persone devono inviare un\'e-mail a admin@novaterra.com dall\'indirizzo e-mail attualmente registrato per l\'account. L\'e-mail deve contenere le seguenti informazioni:');
tz_def('TZ_IN_THE_BEGINNING_YOUR_SMALL_VILLAG', 'All\'inizio il tuo piccolo villaggio avrà un solo edificio.');
tz_def('TZ_IN_NOVATERRA_YOU_ARE_NOT_ALONE_YOU_I', 'In Novaterra non sei solo; interagisci con migliaia di altri giocatori nel mondo di Novaterra.');
...
tz_def('TZ_NOW_YOU_KNOW_EVERYTHING_IMPORTANT', 'Ora sai tutto ciò che è importante su Novaterra. Dopo la registrazione puoi iniziare a giocare!');
...
tz_def('TZ_THERE_ARE_FOUR_DIFFERENT_TYPES_OF', 'In Novaterra ci sono quattro diversi tipi di risorse: legno, argilla, ferro e grano.');
tz_def('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG', 'Non c\'è alcun risarcimento per i danni causati da un sostituto. I proprietari dell\'account sono pienamente responsabili delle azioni compiute dai sostituti scelti per il loro account. Nel caso in cui i sostituti di un account non rispettino queste regole e i Termini e le Condizioni Generali di Novaterra, sia il proprietario dell\'account sia il sostituto possono essere ritenuti responsabili e puniti.');
tz_def('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG_2', 'Non c\'è alcun risarcimento per i danni causati da qualcuno che conosce la password di un account. La persona che riceve la password è soggetta alle regole di Novaterra e ai Termini e Condizioni Generali.');
tz_def('TZ_THERE_IS_NO_SPECIAL_TREATMENT_FOR', 'Non c\'è alcun trattamento speciale per gli utenti Novaterra Plus/Oro riguardo alle regole di gioco, né nel tempo necessario per gestire il caso né nella punizione.');
...
tz_def('TZ_THE_NOVATERRA_TEAM_RESERVES_THE_RIGH', 'Il team Novaterra si riserva il diritto di modificare le regole in qualsiasi momento.');
...
tz_def('TZ_ML_GPACK_ALTER_APPEARANCE', 'Con un pacchetto grafico puoi modificare l\'aspetto di Novaterra. Puoi sceglierne uno dalla lista o fornire un percorso personalizzato.');
...
tz_def('TZ_ML_ACCOUNT_FROZEN', '. Durante questo periodo il tuo account è essenzialmente congelato. Nessuna risorsa, truppa o ricerca progredirà e i tuoi villaggi non possono essere attaccati. Ricorda, questo congela solo il tuo Novaterra, non il tempo.');
...
tz_def('MANUAL_NEW_FEATURES_DESC', "Queste sono novità che non troverai nella versione reale del gioco Novaterra T3.6. Qui puoi conoscere tutte le novità in dettaglio.");
