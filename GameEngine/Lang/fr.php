...
tz_def('NOVATERRA_PLUS', 'Novaterra <b><span class=\"plus_g\">P</span><span class=\"plus_o\">l</span><span class=\"plus_g\">u</span><span class=\"plus_o\">s</span></span></span></b>');
...
//COPYRIGHT
tz_def('NOVATERRA_COPYRIGHT', 'Novaterra — Clone de Novaterra 100 % open source.');
...
tz_def('NATAR_COUNTERFORCE', 'Contre-offensive Tatar');
...
tz_def('Q2_REWARD', 'Votre récompense :</p>1 jour Novaterra');
...
tz_def('Q9_DESC', 'Dans Novaterra, il y a toujours quelque chose à faire ! Pendant que vous attendez l\'arrivée de l\'immense armée, nous devrions augmenter un peu votre production de ressources. Améliorez toutes vos cases de ressources au niveau 1.');
...
tz_def('Q10_REWARD', 'Votre récompense :</p>2 jours Novaterra');
...
tz_def('Q28_DESC', 'Le travail d\'équipe est important dans Novaterra. Les joueurs qui collaborent s\'organisent en alliances. Recevez une invitation d\'une alliance dans votre région et rejoignez-la. Sinon, vous pouvez fonder votre propre alliance. Pour cela, vous avez besoin d\'une ambassade de niveau 3.');
...
tz_def('ONE_DAY_OF_NOVATERRA', '1 jour Novaterra ');
tz_def('TWO_DAYS_OF_NOVATERRA', '2 jours Novaterra ');
...
tz_def('Q25_10_REWARD', 'Votre récompense :</p>2 jours de plus dans Novaterra');
...
tz_def('Q25_28_DESC', 'Le monde de Novaterra est dangereux. Vous avez déjà construit une cachette pour vous protéger des attaquants.<br><br>Une bonne alliance vous donnera une protection encore meilleure.');
...
tz_def('Q25_29_DESC', 'Le travail d\'équipe est important dans Novaterra. Les joueurs qui collaborent s\'organisent en alliances. Recevez une invitation d\'une alliance dans votre région et rejoignez-la. Sinon, vous pouvez fonder votre propre alliance. Pour cela, vous avez besoin d\'une ambassade de niveau 3.');
...
tz_def('U46', 'Chevalier Tatar');
tz_def('U47', 'Éléphant de Guerre');
tz_def('U48', 'Baliste');
tz_def('U49', 'Empereur Tatar');
tz_def('U50', 'Colon Tatar');
//HUNS (TRIBE 6)
...
tz_def('BEFORE_REGISTER', 'Avant de créer un compte, vous devez lire les <a href="../anleitung.php" target="_blank">instructions</a> de Novaterra RO1 pour voir les avantages spécifiques et les inconvénients des différentes tribus.');
...
tz_def('GOLD_BUY_RESOURCES', 'Acheter des ressources avec de l\'or');
tz_def('GOLD_BUY_RESOURCES_DESC', 'Ajoutez instantanément des ressources à ce village, payées en or.');
tz_def('GOLD_BUY_CHOOSE_RESOURCE', 'Ressource');
tz_def('GOLD_BUY_MIX', 'Répartition égale (4 ressources)');
tz_def('GOLD_BUY_HOW_MUCH_GOLD', 'Or à dépenser');
tz_def('GOLD_BUY_RATE_NOTE_PREFIX', 'Taux :');
tz_def('GOLD_BUY_RATE_NOTE_SUFFIX', 'ressources.');
tz_def('GOLD_BUY_COMPLETED', 'Ressources achetées');
tz_def('GOLD_BUY_ERR_GOLD', 'Or insuffisant pour cet achat.');
tz_def('GOLD_BUY_ERR_AMOUNT', 'Veuillez saisir une quantité d\'or valide.');
tz_def('GOLD_BUY_ERR_FULL', 'Votre entrepôt/grenier est déjà plein - aucun or n\'a été débité.');
tz_def('GOLD_BUY_ERR_DISABLED', 'Cette fonctionnalité est actuellement désactivée.');
...
tz_def('GREATWAREHOUSE_DESC', 'Le grand dépôt a 3 fois la capacité d\'un dépôt normal.<br>Ce bâtiment ne peut être construit que dans les villages de Merveille du monde ou avec un artefact tatarien spécial.');

tz_def('GREATGRANARY', 'Grand Grenier');
tz_def('GREATGRANARY_DESC', 'Le grand grenier a 3 fois la capacité d\'un grenier normal.<br>Ce bâtiment ne peut être construit que dans les villages de Merveille du monde ou avec un artefact tatarien spécial.');

tz_def('WONDER', 'Merveille Du Monde');
tz_def('WORLD_WONDER', 'Merveille');
tz_def('WONDER_DESC', 'Une Merveille du monde (aussi appelée WW) est aussi impressionnante qu\'elle en a l\'air. Chaque niveau coûte beaucoup de ressources. Il est presque impossible pour un seul joueur de construire une WW seul. La raison est que vous n\'avez pas seulement besoin de beaucoup de ressources, mais aussi de troupes pour protéger votre précieux bâtiment.<br>Pour construire une WW, vous avez besoin d\'un plan de construction antique. Vous pouvez l\'obtenir en attaquant un village Tatar avec votre héros. Vous devez avoir une trésorerie vide de niveau 10 et votre héros doit survivre. Avec ces plans et un très haut niveau de ressources, vous pouvez démarrer la merveille.<br>Une fois au niveau 50, vous aurez besoin que quelqu\'un d\'autre dans votre alliance possède un deuxième plan actif. Vous ne pouvez pas tout faire vous-même.<br>Terminer une WW niveau 100, vous gagnerez le serveur Novaterra et c\'est la fin d\'un monde de jeu.<br>Une fois terminé, un message s\'affichera disant qui a gagné et les statistiques. Vous ne pouvez plus construire, mais vous pouvez envoyer des messages aux gens jusqu\'au redémarrage du serveur.');
...
tz_def('NATARS_ACC', 'Compte Tatar officiel'); // Natars
tz_def('WW_V_M', 'Village officiel des Merveilles du Monde'); // WW Village
tz_def('ROMAN_T_M', 'Les Romains : Grâce à leur haut niveau de développement social et technologique, les Romains excellent dans la construction et sa coordination. De plus, leurs troupes font partie de l\'élite de Novaterra. Elles sont très équilibrées et efficaces en attaque comme en défense'); // roman tribe medal
...
tz_def('GAUL_T_M', 'Les Gaulois : Les Gaulois sont la plus pacifique des trois tribus de Novaterra. Leurs troupes sont entraînées pour une excellente défense, mais leur capacité d\'attaque n\'a rien à envier aux deux autres tribus. Les Gaulois sont des cavaliers nés et leurs chevaux sont célèbres pour leur vitesse. Cela signifie que leurs cavaliers peuvent frapper l\'ennemi exactement là où il peut infliger le plus de dégâts et l\'éliminer rapidement.'); // gaul tribe medal
tz_def('ADMIN_M', 'Administrateur officiel du serveur');
tz_def('MH_M', 'Multihunter officiel du serveur');
tz_def('MH_M2', 'Le Multihunter est une fonction officielle de Novaterra, principalement utilisée pour faire respecter les règles de Novaterra au sein d\'un serveur. Tous les Multihunters utilisent le compte nommé Multihunter, dont le seul village est situé en (0|0). Un Multihunter ne peut pas jouer sur le serveur où il occupe ce rôle, mais peut être un joueur actif sur d\'autres serveurs.');
tz_def('NATURE_M2', 'Les troupes de la Nature sont les animaux vivant dans les oasis inoccupées. Vous pouvez utiliser le simulateur de combat pour vérifier si vous avez suffisamment de troupes pour vaincre les animaux d\'une oasis que vous souhaitez conquérir, mais n\'oubliez pas que vous ne pouvez que piller les oasis. Sachez que tous les animaux supérieurs à l\'Ours peuvent tuer toutes les troupes de Novaterra de niveau maximum en combat singulier.');
tz_def('TASKMASTER_M', 'Compte Maître du jeu');
tz_def('VETERAN_P', 'Joueur vétéran');
tz_def('VETERAN_3_M', 'Médaille obtenue pour 3 ans de jeu sur Novaterra');
tz_def('VETERAN_5_M', 'Médaille obtenue pour 5 ans de service sur Novaterra');
tz_def('VETERAN_10_M', 'Médaille obtenue pour 10 ans de service sur Novaterra');
...
tz_def('TIME_ZONES_DESC', 'Ici, vous pouvez modifier l\'heure affichée par Novaterra pour qu\'elle corresponde à votre fuseau horaire');
...
D\'innombrables jours se sont écoulés depuis les premières batailles aux murailles des villages maudits des terribles Tatars. De nombreuses armées, tant des hommes libres que de l\'empire tatarien, ont lutté et péri devant les murs des nombreuses forteresses d\'où les Tatars régnaient autrefois sur toute la création. Maintenant que la poussière retombe et qu\'un calme relatif s\'est installé, les armées commencent à compter leurs pertes et à rassembler leurs morts, l\'odeur du combat flottant encore dans l\'air nocturne, une odeur de massacre inoubliable par son ampleur et sa brutalité, qui sera bientôt éclipsée par d\'autres encore. Les plus grandes armées des hommes libres et des terribles Tatars se rassemblaient pour un énième assaut renouvelé contre les ex-forteresses convoitées de l\'empire tatarien.
Bientôt les éclaireurs arrivent annonçant une vision incroyable et un rappel glaçant : une armée terrifiante d\'une taille insondable a été repérée se rassemblant à la fin du monde, la capitale tatarienne, une force si grande et inarrêtable que la poussière de leur marche étoufferait toute lumière, une force si brutale et impitoyable qu\'elle écraserait tout espoir. Les hommes libres savaient qu\'ils devaient maintenant courir, courir contre le temps et les hordes infinies de l\'empire tatarien pour ériger une Merveille du monde, ramener la paix dans le monde et vaincre la menace tatarienne.
...
Des dizaines de milliers d\'éclaireurs ont arpenté toute l\'existence à la recherche en vain de ces plans mystiques, cherchant partout sauf dans la redoutable capitale tatarienne, sans pouvoir les trouver. Aujourd\'hui cependant, ils reviennent porteurs de bonnes nouvelles, ils reviennent avec les emplacements des plans, dissimulés par les armées des Tatars dans des forteresses secrètes construites pour être cachées aux yeux des hommes.
Maintenant commence la dernière ligne droite, où les plus grandes armées des hommes libres et des Tatars s\'affronteront à travers le monde pour le destin de tout ce qui repose sous le ciel. C\'est la guerre qui résonnera à travers les âges, c\'est votre guerre, et c\'est ici que vous graverez votre nom dans l\'histoire, ici que vous deviendrez légende.
...
Il y a de nombreuses lunes, les tribus de Novaterra furent surprises par le retour imprévu des Tatars. Cette tribu qui depuis des temps immémoriaux surpassait tous en sagesse, puissance et gloire, était sur le point de troubler à nouveau les hommes libres. Ils mirent donc toutes leurs forces dans la préparation d\'une ultime guerre contre les Tatars pour les vaincre à jamais. Beaucoup pensèrent aux fameuses « Merveilles du monde », bâtiments de nombreuses légendes, comme seule solution. On disait qu\'elles rendraient quiconque invincible une fois terminées, faisant finalement de leurs constructeurs les maîtres et conquérants de tout Novaterra.
...
Aujourd\'hui cependant, ce dernier secret va être révélé. Les privations et les efforts du passé n\'auront pas été vains, car aujourd\'hui les éclaireurs de plusieurs tribus ont obtenu avec succès l\'emplacement des plans de construction. Bien gardés par les Tatars, ils gisent cachés dans plusieurs oasis disséminées à travers tout Novaterra. Seuls les héros les plus vaillants pourront sécuriser un tel plan et le ramener à la maison sain et sauf afin que la construction puisse commencer.

Au final, nous verrons si les tribus libres de Novaterra pourront une fois de plus déjouer les Tatars et les vaincre une fois pour toutes. Ne soyez pas assez fou pour croire que les Tatars partiront sans combattre !

<img src="/img/x.gif" class="WWBuildingPlansAnnouncement" title="'.PLAN.'" alt="'.PLAN.'">

Pour voler un jeu de plans de construction aux Tatars, les conditions suivantes doivent être réunies :
...
tz_def('CONF_SERV_NATUNITSMULTIPLIER', 'Multiplicateur Unités Tatars');
tz_def('CONF_SERV_NATUNITSMULTIPLIER_TOOLTIP', 'Ce paramètre est responsable du nombre de troupes Tatars, sur des villages Artefacts et Merveilles.');
tz_def('CONF_SERV_NATARS_SPAWN_TIME', 'Apparition des Tatars');
tz_def('CONF_SERV_NATARS_SPAWN_TIME_TOOLTIP', 'Après combien de temps Tatars et les artefacts apparaîtront à partir de la date de démarrage du serveur, en jours');
...
tz_def('CONF_SERV_NATARSTAT', 'Afficher Tatars dans les statistiques');
tz_def('CONF_SERV_NATARSTAT_TOOLTIP', 'Activez ou désactivez l\'affichage du compte Tatars dans les statistiques.');
...
$lang['index'][0][13] = "Jouez avec et contre des milliers d'autres joueurs r&eacute;els et dominez le monde de Novaterra.";
...
tz_def('TZ_FEATURES_OF_NOVATERRA', 'Fonctionnalités de Novaterra');
...
tz_def('TZ_NOVATERRA_NAME', 'Novaterra');
tz_def('TZ_NOVATERRA', 'Novaterra');
tz_def('TZ_GAME_BRAND', 'Novaterra');
...
tz_def('TZ_RELEASED_BY_NOVATERRA_TEAM', 'Publié par : l\'équipe Novaterra');
tz_def('TZ_RELEASE_BY_NOVATERRA', '[Publié par : Novaterra]');
...
tz_def('TZ_NOVATERRA_DEFAULT', 'Novaterra Default');
tz_def('TZ_NOVATERRA_GOLD_CLUB', 'Novaterra Gold Club');
tz_def('TZ_NOVATERRA_T4_STYLE', 'Novaterra T4 Style');
...
tz_def('TZ_MILESTONE_HERO_MASTER', 'Premier Maitre des Heros (equipement tier 3 complet)');

// ===== i18n etape 2 (lot suivant) =====
tz_def('TZ_ACCOUNT_OR_INCREASE_YOUR_RESOURCE', '-Compte ou augmentez votre production de ressources. Pour ce faire, cliquez');
tz_def('TZ_ADDITIONALLY_THE_NOVATERRA_TEAM_WILL', 'De plus, l\'équipe Novaterra ne fournira d\'informations concernant les bannissements à aucune personne autre que le propriétaire du compte.');
tz_def('TZ_ADVERTISEMENT_OF_ANY_KIND_THAT_HAS', 'Toute publicité non autorisée par l\'équipe Novaterra est interdite.');
...
tz_def('TZ_ANY_SALES_OR_PURCHASES_CONCERNING', 'Toute vente ou achat impliquant de l\'argent réel concernant des comptes, unités, villages, ressources, services ou tout autre aspect de Novaterra est interdit. La vente de comptes Novaterra ainsi que tout transfert indirect (même sous forme de cadeau) en lien avec des sites d\'enchères ou d\'autres transactions monétaires est interdit.');
...
tz_def('TZ_BLACKMAILING_PLAYERS_IN_A_WAY_THAT', 'Faire chanter des joueurs d\'une manière qui enfreint l\'une des règles de Novaterra conformément aux Conditions Générales.');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_NOVATERRA_S_DISP', 'Ici vous pouvez modifier l\'heure affichée de Novaterra pour l\'adapter à votre fuseau horaire.');
...
tz_def('TZ_INCITING_MANIPULATING_ENCOURAGING', 'Inciter, manipuler, encourager, aider ou conspirer avec d\'autres pour enfreindre l\'une des règles de Novaterra est interdit. Ces règles s\'appliquent sans exception aux joueurs qui supprimeront leur compte ou sont en train de le supprimer.');
...
tz_def('TZ_IN_ORDER_TO_PLAY_NOVATERRA_YOU_NEED', 'Pour jouer à Novaterra, vous avez besoin d\'une adresse e-mail valide à laquelle le code d\'activation peut être envoyé. Dans des cas exceptionnels, cet e-mail peut ne pas arriver.');
...
tz_def('TZ_IN_ORDER_TO_SWITCH_AN_ACCOUNT_WITH', 'Pour échanger un compte avec une autre personne sur le même monde de jeu, les deux personnes doivent envoyer un e-mail à admin@novaterra.com depuis l\'adresse e-mail actuellement enregistrée pour le compte. L\'e-mail doit contenir les informations suivantes :');
tz_def('TZ_IN_THE_BEGINNING_YOUR_SMALL_VILLAG', 'Au début, votre petit village n\'aura qu\'un seul bâtiment.');
tz_def('TZ_IN_NOVATERRA_YOU_ARE_NOT_ALONE_YOU_I', 'Dans Novaterra, vous n\'êtes pas seul ; vous interagissez avec des milliers d\'autres joueurs dans le monde de Novaterra.');
...
tz_def('TZ_NOW_YOU_KNOW_EVERYTHING_IMPORTANT', 'Vous savez maintenant tout ce qui est important sur Novaterra. Après l\'inscription, vous pouvez commencer à jouer !');
...
tz_def('TZ_RESOURCES_BUILDINGS_VILLAGES_OR_TR', 'Les ressources, bâtiments, villages ou troupes perdus pendant la durée de suspension ne comptent pas comme une sanction et ne seront pas remplacés par l\'équipe Novaterra. Aucun joueur n\'a le droit de réclamer un paiement ou un remplacement pour le temps de Plus/Or perdu en raison d\'une suspension.');
...
tz_def('TZ_THERE_ARE_FOUR_DIFFERENT_TYPES_OF', 'Il existe quatre types de ressources différents dans Novaterra : bois, argile, fer et céréales.');
tz_def('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG', 'Il n\'y a aucune compensation pour les dommages causés par un remplaçant. Les propriétaires de compte sont entièrement responsables des actions effectuées par les remplaçants choisis pour leur compte. Si les remplaçants d\'un compte ne respectent pas ces règles et les Conditions Générales de Novaterra, le propriétaire du compte et le remplaçant peuvent être tenus responsables et sanctionnés.');
tz_def('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG_2', 'Il n\'y a aucune compensation pour les dommages causés par une personne connaissant le mot de passe d\'un compte. La personne recevant le mot de passe est soumise aux règles de Novaterra ainsi qu\'aux Conditions Générales.');
tz_def('TZ_THERE_IS_NO_SPECIAL_TREATMENT_FOR', 'Il n\'y a aucun traitement particulier pour les utilisateurs de Novaterra Plus/Or concernant les règles du jeu, ni dans le délai de traitement du dossier, ni dans la sanction.');
...
tz_def('TZ_THE_NOVATERRA_TEAM_RESERVES_THE_RIGH', 'L\'équipe Novaterra se réserve le droit de modifier les règles à tout moment.');
...
tz_def('TZ_ML_GPACK_ALTER_APPEARANCE', 'Avec un pack graphique, vous pouvez modifier l\'apparence de Novaterra. Vous pouvez en choisir un dans la liste ou indiquer un chemin personnalisé.');
...
tz_def('TZ_ML_ACCOUNT_FROZEN', '. Pendant cette période, votre compte est essentiellement gelé. Aucune ressource, troupe ou recherche ne progressera et vos villages ne peuvent pas être attaqués. N\'oubliez pas : cela ne gèle que votre Novaterra, pas le temps.');
...
tz_def('MANUAL_NEW_FEATURES_DESC', 'Ce sont des nouveautés que vous ne trouverez pas dans la version originale du jeu Novaterra T3.6. Vous pouvez ici découvrir toutes ces nouveautés en détail.');
...
tz_def('MANUAL_NPC_NATARS', 'Cette description est fournie à titre indicatif uniquement. Les Tatars sont une tribu purement PNJ et ne peuvent donc pas être incarnés.');
...
tz_def('MANUAL_UDESC_11', 'Les Combattants au gourdin sont l\'unité la moins chère de Novaterra. Ils sont entraînés rapidement et possèdent des capacités d\'attaque moyennes, mais leur armure n\'est pas la meilleure. Les Combattants au gourdin sont presque sans défense face à la cavalerie et se font piétiner avec facilité.');
...
tz_def('MANUAL_UDESC_44', 'Les Tatars utilisent des nuées d\'oiseaux pour recueillir des renseignements sur leurs ennemis. Grâce à l\'avantage de l\'observation aérienne, il est presque impossible d\'arrêter les escadrons d\'éclaireurs tatariens ; en revanche, même un villageois simple d\'esprit peut facilement remarquer ces nuées criardes et emplumées.');
tz_def('MANUAL_UDESC_41', 'Leurs longues piques pointues constituent la principale ligne de défense de toute bataille. Les Piquiers tatariens sont des guerriers hardis et audacieux qui usent de leur dextérité pour abattre rapidement les cavaliers ennemis et les achever.');
tz_def('MANUAL_UDESC_42', 'Les excroissances en forme d\'épines sur leurs casques, leurs brassards et les épaulières de leur armure donnent leur nom aux Guerriers épineux. Les hommes qui combattent pour les Tatars en tant que Guerriers épineux sont tenaces et bien entraînés, offrant une bataille sanglante à quiconque est assez insensé pour les attaquer.');
tz_def('MANUAL_UDESC_43', 'Adorés par leur peuple et craints par leurs ennemis, les Gardes combattent sans monture mais figurent néanmoins parmi les soldats les plus précieux de l\'armée tatarienne, grâce à leur polyvalence. Considérés comme des combattants bien entraînés, ils ne laissent à leurs ennemis presque aucune chance de l\'emporter. Grâce à leur lourde armure, ils peuvent aussi servir de troupes de défense solides et fiables.');
...
tz_def('MANUAL_NF_T_21', 'Manuel sur la Nature et les Tatars');
...
tz_def('MANUAL_NF_D_11', 'Si une oasis conquise se trouve dans le village, elle sera affichée dans le profil du joueur en face du village correspondant, avec le type de ressource approprié et un bonus de production. Cette fonction a été présentée dans Novaterra T4.');
...
tz_def('MANUAL_NF_D_17', 'Si un artefact se trouve dans l\'un des villages, il sera affiché dans le profil du joueur en face du village correspondant dans lequel il se trouve. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_18', 'Si le village dispose d\'un emplacement pour la construction de la Merveille du monde, celui-ci sera affiché dans le profil en face du village correspondant. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_19', 'Le mode vacances vous permet de protéger votre empire de toute action hostile des autres joueurs pendant votre longue absence. Certes, certaines conditions s\'appliquent et entraîneront un retard dans le développement de votre empire. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_20', 'Si vous envoyez les catapultes lors d\'une attaque normale, vous pouvez voir au point de ralliement quelles cibles vous avez définies pour l\'attaque. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_21', 'À l\'aide de ces informations du manuel, vous pouvez trouver une description des forces de la Nature et des Tatars.');
tz_def('MANUAL_NF_D_22', 'L\'emplacement des liens directs change. Dans le Novaterra T3.6 d\'origine, les liens directs sont placés dans le menu de droite, sous la liste des villages, ce qui n\'est pas entièrement pratique. Si cette option est activée, les liens directs seront placés dans le menu de gauche, ce qui est bien plus pratique.');
tz_def('MANUAL_NF_D_23', 'Médaille décernée aux joueurs utilisant la même adresse e-mail depuis 3 ans ou plus. Peut être ajoutée à la description du profil. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_24', 'Médaille décernée aux joueurs utilisant la même adresse e-mail depuis 5 ans ou plus. Peut être ajoutée à la description du profil. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_25', 'Médaille décernée aux joueurs utilisant la même adresse e-mail depuis 10 ans ou plus. Peut être ajoutée à la description du profil. Cette fonction a été présentée dans Novaterra T4.');
tz_def('MANUAL_NF_D_26', 'Médaille décernée aux joueurs utilisant la même adresse e-mail depuis 10 ans ou plus. Peut être ajoutée à la description du profil. Cette fonction a été présentée dans Novaterra T4.');
...
tz_def('HB_TXT_VS_NATARS',  'puissance contre les Tatars');
...
tz_def('ADMIN_NATARS_MANAGEMENT', 'Gestion des Tatars');
...
tz_def('ADMIN_FEATURE_FLAGS', 'Commutateurs de fonctionnalites');
...
tz_def('PUBLIC_WELCOME_TO', 'Bienvenue sur');
tz_def('PUBLIC_MANUAL', 'Manuel');
tz_def('PUBLIC_REGISTER', 'Inscription');
tz_def('PUBLIC_TRIBES', 'Les peuples');
tz_def('PUBLIC_CLOSE', 'Fermer');
tz_def('PUBLIC_BACK', 'retour');
tz_def('PUBLIC_FORWARD', 'suivant');
tz_def('PUBLIC_TO_REGISTRATION', 'vers l’inscription');
tz_def('ANL_ROMANS', 'Les Romains');
tz_def('ANL_GAULS', 'Les Gaulois');
tz_def('ANL_TEUTONS', 'Les Germains');
tz_def('ANL_ROMAN_TROOPS', 'Les troupes romaines');
tz_def('ANL_GALLIC_TROOPS', 'Les troupes gauloises');
tz_def('ANL_TEUTONIC_TROOPS', 'Les troupes germaines');
tz_def('ANL_SPECIALTIES', 'Les particularités');
tz_def('ANL_ROMAN_DUAL_BUILD', 'Peut construire ou améliorer simultanément un bâtiment et un champ de ressources');
tz_def('ANL_ROMAN_WALL_BONUS', 'Le mur d’enceinte offre un important bonus de défense');
tz_def('ANL_GAUL_SPEED_BONUS', 'Bonus de vitesse : les troupes les plus rapides du jeu');
tz_def('ANL_GAUL_PALISADE_BONUS', 'La palissade offre un bonus de défense moyen');
tz_def('ANL_TEUTON_EARTH_WALL', 'Le mur de terre est presque indestructible, mais n’offre qu’un faible bonus de défense');
tz_def('ANL_TEUTON_CHEAP_TROOPS', 'Des troupes rapides et peu coûteuses, excellentes pour le pillage');
tz_def('ANL_TEUTON_WEAK_DEFENCE', 'Défense faible');
tz_def('ANL_ROMAN_DESC_1', 'Grâce à leur haut niveau de développement social et technologique, les Romains excellent dans la construction et son organisation. Leurs troupes font également partie de l’élite de Novaterra. Elles sont très équilibrées et efficaces aussi bien en attaque qu’en défense.');
tz_def('ANL_ROMAN_DESC_2', 'Cette polyvalence a un prix : les troupes romaines demandent beaucoup de temps et de ressources pour être entraînées. Leur infanterie est légendaire, mais leur défense contre la cavalerie ennemie est moins efficace que celle des autres peuples. Les marchands romains transportent aussi peu de ressources.');
tz_def('ANL_ROMAN_DESC_3', 'Comme ils sont vulnérables au début de la partie, les Romains constituent un choix difficile pour les débutants.');
tz_def('ANL_GAUL_DESC_1', 'Les Gaulois sont le peuple le plus pacifique des trois. Leurs troupes sont entraînées pour assurer une excellente défense, mais leurs capacités offensives restent comparables à celles des autres peuples. Cavaliers nés, ils disposent de chevaux réputés pour leur vitesse, ce qui leur permet de frapper rapidement là où l’ennemi est le plus vulnérable.');
tz_def('ANL_GAUL_DESC_2', 'Ce peuple est facile à défendre, tout en permettant une stratégie agressive. Il offre donc de nombreuses orientations : défense ou attaque, jeu solitaire ou soutien fiable, commerce ou pillage, infanterie ou cavalerie, colonisation ou conquête. Un peu d’expérience et de talent restent toutefois nécessaires.');
tz_def('ANL_GAUL_DESC_3', 'Pour les débutants et les joueurs qui hésitent encore sur leur style de jeu, les Gaulois constituent un excellent choix.');
tz_def('ANL_TEUTON_DESC_1', 'Les Germains sont le peuple le plus agressif. Leurs troupes sont réputées et redoutées pour leur rage et leur frénésie au combat. Elles se déplacent comme une horde de pillards qui ne craint même pas la mort.');
tz_def('ANL_TEUTON_DESC_2', 'Ils ne possèdent toutefois pas la discipline militaire des Gaulois ou des Romains, ce qui les rend moins performants en vitesse et en défense.');
tz_def('ANL_TEUTON_DESC_3', 'Pour les joueurs agressifs et expérimentés, les Germains sont un excellent choix !');
tz_def('ANL_TRIBES_INTRO', 'Vous pouvez choisir entre trois peuples dans Novaterra : les Romains, les Gaulois et les Germains. Chaque peuple possède ses avantages et ses inconvénients, et leurs troupes sont très différentes. Il est donc important de choisir celui qui correspond le mieux à votre style de jeu.');
tz_def('ANL_ROMAN_MERCHANT', 'Les marchands peuvent transporter 500 unités de ressources (vitesse : 16 cases/heure)');
tz_def('ANL_GAUL_MERCHANT', 'Les marchands peuvent transporter 750 unités de ressources (vitesse : 24 cases/heure)');
tz_def('ANL_TEUTON_MERCHANT', 'Les marchands peuvent transporter 1 000 unités de ressources (vitesse : 12 cases/heure)');
tz_def('ANL_TEUTON_PLUNDER_BONUS', 'Bonus de pillage : les cachettes ennemies ne protègent que 66 % de leur capacité normale dans Novaterra 2.5 et 3, et 80 % dans Novaterra 3.5.');
tz_def('ANL_ATTACK_VALUE', 'Valeur d’attaque');
tz_def('ANL_DEF_INFANTRY', 'Défense contre l’infanterie');
tz_def('ANL_DEF_CAVALRY', 'Défense contre la cavalerie');
tz_def('ANL_SPEED', 'Vitesse');
tz_def('ANL_BUILDINGS_INTRO_1', 'Au début, vous devez chercher à établir une base économique solide. Pour cela, améliorez les 18 champs de ressources visibles dans la vue du village. Il existe quatre types de champs : bûcheron, carrière d’argile, mine de fer et ferme. En cliquant sur l’un d’eux, vous obtenez davantage d’informations ainsi que la possibilité de l’améliorer.');
tz_def('ANL_BUILDINGS_INTRO_2', 'Plus tard dans la partie, les bâtiments du village deviennent eux aussi importants. Pour construire un nouveau bâtiment, cliquez sur l’un des emplacements verts. La liste des bâtiments disponibles s’affichera.');
tz_def('ANL_BUILDINGS_INTRO_3', 'Certains bâtiments ne peuvent être construits qu’après avoir satisfait leurs prérequis, généralement d’autres bâtiments.');
tz_def('ANL_TRIBE_ADVANTAGE', 'Avantage du peuple :');
tz_def('ANL_ROMAN_BUILD_ADVANTAGE', 'Romains : peuvent construire ou améliorer simultanément un champ de ressources et un bâtiment du village.');
tz_def('ANL_MAIN_BUILDING_DESC', 'Les maîtres bâtisseurs du village vivent dans le bâtiment principal. Plus son niveau est élevé, plus ils achèvent rapidement la construction de nouveaux bâtiments.');
tz_def('ANL_WAREHOUSE_DESC', 'Le bois, l’argile et le fer sont stockés dans l’entrepôt. Plus son niveau est élevé, plus sa capacité augmente.');
tz_def('ANL_GRANARY_DESC', 'Les céréales produites par vos fermes sont stockées dans le grenier. Plus son niveau est élevé, plus sa capacité augmente.');
tz_def('ANL_CRANNY_DESC', 'La cachette permet de dissimuler une partie de vos ressources lorsque le village est attaqué. Ces ressources ne peuvent pas être volées. Au niveau 1, elle protège 100 unités de chaque ressource.');
tz_def('ANL_GAUL_CRANNY', 'Gaulois : la cachette possède une capacité deux fois supérieure.');
tz_def('ANL_TEUTON_CRANNY', 'Germains : les cachettes ennemies ne protègent que 66 % de leur capacité normale dans Novaterra 2.5 et 3, et 80 % dans Novaterra 3.5.');
tz_def('ANL_EMBASSY_DESC', 'Pour rejoindre une alliance, vous avez besoin d’une ambassade. Avec une ambassade de niveau 3, vous pouvez même fonder votre propre alliance. Chaque niveau supplémentaire augmente de 3 le nombre maximal de membres.');
tz_def('ANL_RALLY_POINT_DESC', 'Au point de ralliement, vous pouvez donner des ordres à vos troupes et voir l’origine des troupes en approche. Il ne peut être construit que sur l’emplacement situé à droite du centre du village. Plus son niveau est élevé, plus les catapultes disposent de cibles.');
tz_def('ANL_MARKETPLACE_DESC', 'Au marché, vous pouvez échanger des ressources avec d’autres joueurs. Plus son niveau est élevé, plus la quantité de ressources transportable simultanément augmente.');
tz_def('ANL_BARRACKS_DESC', 'L’infanterie est entraînée dans la caserne. Plus son niveau est élevé, plus l’entraînement des troupes est rapide.');
tz_def('ANL_STABLE_DESC', 'La cavalerie est entraînée dans l’écurie. Plus son niveau est élevé, plus l’entraînement des troupes est rapide.');
tz_def('ANL_WORKSHOP_DESC', 'Les engins de siège, comme les catapultes et les béliers, sont construits dans l’atelier. Plus son niveau est élevé, plus leur production est rapide.');
tz_def('ANL_ACADEMY_DESC', 'De nouveaux types d’unités peuvent être développés à l’académie. Plus son niveau est élevé, plus vous pouvez rechercher des unités avancées.');
tz_def('ANL_BLACKSMITH_DESC', 'Les armes de vos guerriers sont améliorées dans les fourneaux de la forge. Plus son niveau est élevé, plus vous pouvez fabriquer des armes performantes.');
tz_def('ANL_ARMOURY_DESC', 'Les armures de vos guerriers sont améliorées dans les fourneaux de l’armurerie. Plus son niveau est élevé, plus vous pouvez fabriquer des protections performantes.');
tz_def('ANL_PALACE_DESC', 'Le roi ou la reine de l’empire réside dans le palais. Un seul palais peut être construit dans votre royaume et il permet de désigner un village comme capitale. Une capitale ne peut pas être conquise.');
tz_def('ANL_CAPITAL_DESC', 'La capitale est le seul endroit où la loge du tailleur de pierre peut être construite. C’est également le seul village où les champs de ressources peuvent être améliorés au-delà du niveau 10.');
tz_def('ANL_RESIDENCE_DESC', 'La résidence est un petit palais où séjourne le roi ou la reine lors de ses visites. Tant qu’elle n’est pas détruite, elle protège le village contre les tentatives de conquête.');
tz_def('ANL_TRADE_OFFICE_DESC', 'Au comptoir de commerce, les chariots des marchands sont améliorés et équipés de chevaux plus puissants. Plus son niveau est élevé, plus les marchands peuvent transporter de ressources.');
tz_def('ANL_TRADE_OFFICE_CAPACITY', 'Chaque niveau augmente la capacité de transport de 10 %. Au niveau 20, les marchands peuvent transporter trois fois leur capacité normale.');
tz_def('ANL_ROMAN_TRADE_OFFICE', 'Romains : dans Novaterra 3.5, le comptoir de commerce romain augmente la capacité de transport de 20 % par niveau.');
tz_def('ANL_TOURNAMENT_SQUARE_DESC', 'Sur la place du tournoi, vos troupes s’entraînent pour améliorer leur endurance. Plus son niveau est élevé, plus elles se déplacent rapidement au-delà d’une distance minimale de 30 cases.');
tz_def('ANL_FAQ_RALLY_POINT_LOCATION', 'Le point de ralliement ne peut être construit qu’à un seul emplacement : sur la prairie située à droite du centre du village.');
tz_def('ANL_FAQ_ALLIANCE', 'Pour fonder une alliance, vous avez besoin d’une ambassade de niveau 3. Pour en rejoindre une, une ambassade de niveau 1 suffit, ainsi qu’une invitation.');
tz_def('ANL_FAQ_RENAME_VILLAGE_Q', 'Comment changer le nom de mon village ?');
tz_def('ANL_FAQ_RENAME_VILLAGE_A', 'Sélectionnez d’abord le village concerné dans la liste. Ouvrez ensuite les paramètres du village, modifiez son nom dans le champ prévu à cet effet, puis validez avec OK.');
tz_def('ANL_FAQ_TRAIN_TROOPS_Q', 'Comment entraîner des troupes ?');
tz_def('ANL_FAQ_TRAIN_TROOPS_A', 'Vous avez besoin d’un point de ralliement de niveau 1 et d’un bâtiment principal de niveau 3. Vous pourrez alors construire une caserne et y entraîner de l’infanterie.');
tz_def('ANL_FAQ_DEFEND_VILLAGE_Q', 'Comment défendre mon village ?');
tz_def('ANL_FAQ_DEFEND_VILLAGE_A', 'Tant que des troupes se trouvent dans votre village, qu’elles vous appartiennent ou qu’elles aient été envoyées en renfort, elles le défendent automatiquement.');
tz_def('ANL_FAQ_LOW_PLUNDER_Q', 'Pourquoi mes troupes pillent-elles si peu de ressources ?');
tz_def('ANL_FAQ_LOW_PLUNDER_A', 'Deux raisons sont possibles. Premièrement, chaque type de troupe ne peut transporter qu’une quantité limitée de ressources. Deuxièmement, la victime peut posséder une cachette qui dissimule automatiquement une partie de ses ressources.');
tz_def('ANL_FAQ_LOSE_VILLAGE_Q', 'Puis-je perdre un village ?');
tz_def('ANL_FAQ_LOSE_VILLAGE_A', 'Tout village peut être réduit à 0 habitant par des catapultes. S’il ne s’agit pas du dernier village du compte, il disparaîtra après un court délai. La capitale ne peut pas être conquise, mais elle peut néanmoins être détruite.');
tz_def('ANL_FAQ_BUILD_RALLY_POINT_Q', 'Comment construire un point de ralliement ?');
tz_def('ANL_FAQ_FOUND_ALLIANCE_Q', 'Comment fonder une alliance ?');
tz_def('ANL_FAQ_FOUND_CONQUER_Q', 'Comment fonder ou conquérir de nouveaux villages ?');
tz_def('PUBLIC_ABOUT_PROJECT', 'À propos de ce projet :');
tz_def('PUBLIC_ADD_TRIBES', '- Ajouter de nouveaux peuples et de nouvelles mécaniques');
tz_def('PUBLIC_UNOFFICIAL_PROJECT', 'Ce projet non officiel est réalisé par des fans et n’est pas affilié à Novaterra GmbH.');
tz_def('PUBLIC_DELETE_COOKIES_NOTICE', 'Si d’autres personnes utilisent également cet ordinateur, supprimez vos cookies par sécurité :');
tz_def('PUBLIC_DELETE_COOKIES', 'supprimer les cookies');
tz_def('ANL_ROMAN_MERCHANT_500', 'Romains : chaque marchand peut transporter 500 ressources.');
tz_def('ANL_TEUTON_MERCHANT_1000', 'Germains : chaque marchand peut transporter 1 000 ressources.');
tz_def('ANL_GAUL_MERCHANT_750', 'Gaulois : chaque marchand peut transporter 750 ressources.');
tz_def('ANL_ROMAN_ALT', 'Romain');
tz_def('ANL_GAUL_ALT', 'Les Gaulois');
tz_def('ANL_TEUTON_ALT', 'Germain');
tz_def('ANL_CRANNY_DOUBLE', 'La cachette est deux fois plus grande');
tz_def('ANL_POPULATION_EXPLAIN', 'Chaque bâtiment augmente la population de votre village d’un certain nombre d’habitants. Le nombre d’habitants supplémentaires créés par sa construction ou son amélioration est indiqué à côté du symbole.');
tz_def('ANL_CROP_EXAMPLE_1', 'La valeur affichée correspond à votre production de céréales diminuée de la consommation de votre population. La production totale apparaît en haut à droite, par exemple 5/15.');
tz_def('ANL_CROP_EXAMPLE_2', 'Dans cet exemple, 8 correspond à la consommation, 15 à la production totale, soit 15 - 8 = 7 unités de céréales par heure.');
tz_def('PUBLIC_LOGOUT_SUCCESS_TITLE', 'Déconnexion réussie.');
tz_def('PUBLIC_LOGOUT_THANKS', 'Merci de votre visite.');
tz_def('ANL_POPULATION_EXPLAIN_HTML', 'Chaque bâtiment augmente la population de votre village d’un certain nombre d’habitants. Le nombre d’habitants supplémentaires créés par sa construction ou son amélioration est indiqué à côté du symbole.');
tz_def('ANL_CROP_EXPLAIN_HTML', 'Dans la production, la quantité affichée correspond à votre production de céréales diminuée de la consommation de la population et des troupes. Votre production totale apparaît en haut à droite.');
tz_def('ANL_CROP_EXAMPLE_HTML', 'Dans cet exemple, 8 correspond à votre consommation et 15 à votre production totale : 15 - 8 = 7 unités de céréales par heure.');
tz_def('ANL_USE_OF_CROP', 'Consommation de céréales');
tz_def('PUBLIC_TERMS_TITLE', 'Conditions générales');
tz_def('PUBLIC_TERMS_GENERAL_RULES', '1. Règles générales');
tz_def('PUBLIC_TERMS_PROJECT', 'Novaterra est un projet open source réalisé par des fans et créé par Shadow.');
tz_def('PUBLIC_TERMS_ACCEPTANCE', 'En utilisant ce serveur de jeu, vous acceptez de respecter l’ensemble des règles énoncées ici.');
tz_def('PUBLIC_TERMS_ACCOUNT_RESPONSIBILITY', '2. Responsabilité du compte');
tz_def('PUBLIC_TERMS_ACCOUNT_FULL_RESPONSIBILITY', 'Vous êtes entièrement responsable de votre compte.');
tz_def('PUBLIC_TERMS_ACCOUNT_SHARING', 'Le partage de compte n’est autorisé que si les règles du jeu le permettent.');
tz_def('PUBLIC_TERMS_CHEATING', 'La triche, l’utilisation de robots, l’abus de comptes multiples ou l’exploitation de mécanismes du jeu');
tz_def('PUBLIC_TERMS_SERVER_STATUS', '4. État du serveur');
tz_def('PUBLIC_TERMS_AS_IS', 'Ce serveur est fourni en l’état, sans garantie de disponibilité ni de stabilité.');
tz_def('PUBLIC_TERMS_RESET', 'Le développeur se réserve le droit de réinitialiser ou de modifier le serveur à tout moment.');
tz_def('PUBLIC_TERMS_NO_AFFILIATION', 'Ce projet n’est pas affilié à Novaterra.');
tz_def('PUBLIC_TERMS_UPDATES', 'Ces conditions peuvent être modifiées à tout moment sans préavis.');
tz_def('PUBLIC_RULES_TITLE', 'Règles du jeu');
tz_def('PUBLIC_RULES_INTRO_1', 'Les règles ci-dessous complètent les conditions générales de Novaterra. Vous devez également consulter ces conditions afin de vérifier ce qui est autorisé, notamment lorsqu’un compte a été suspendu pour infraction aux règles.');
tz_def('PUBLIC_RULES_INTRO_2', 'Il est interdit d’inciter, de manipuler, d’encourager, d’aider ou de s’entendre avec d’autres personnes pour enfreindre les règles de Novaterra. Ces règles s’appliquent sans exception, y compris aux joueurs qui prévoient de supprimer leur compte ou dont le compte est en cours de suppression.');
tz_def('PUBLIC_RULES_SECTION_1', '&sect;1 Mot de passe et propriété du compte');
tz_def('PUBLIC_RULES_ONE_ACCOUNT', 'Chaque joueur ne peut posséder et utiliser qu’un seul compte par serveur.');
tz_def('PUBLIC_RULES_EMAIL_OWNER', 'L’adresse électronique utilisée pour enregistrer un compte doit être placée sous le contrôle personnel et exclusif de la personne qui l’a créé. Le propriétaire de cette adresse est considéré comme le propriétaire du compte, quels que soient les accords personnels ou d’alliance conclus par ailleurs. Le propriétaire du compte est entièrement responsable de toutes les actions effectuées avec celui-ci.');
tz_def('PUBLIC_RULES_SECTION_1_2', '&sect;1.2 Mot de passe');
tz_def('PUBLIC_RULES_PASSWORD_SAME_WORLD', 'Le propriétaire d’un compte ne peut communiquer son mot de passe à une personne jouant sur le même monde de jeu. Il est également interdit de choisir sciemment le même mot de passe qu’une autre personne sur ce même monde. Ces pratiques sont considérées comme du multi-compte au sens des présentes règles.');
tz_def('PUBLIC_RULES_PASSWORD_OTHER_WORLD', 'Il est toutefois permis de communiquer le mot de passe à une personne jouant sur un autre monde, ou ne jouant pas du tout, afin de gérer ensemble un unique compte.');
tz_def('PUBLIC_RULES_PASSWORD_DAMAGE', 'Aucune compensation n’est accordée pour les dommages causés par une personne connaissant le mot de passe d’un compte. Toute personne recevant ce mot de passe est soumise aux règles de Novaterra ainsi qu’aux conditions générales.');
tz_def('PUBLIC_RULES_SECTION_1_3', '&sect;1.3 Changement d’adresse électronique et transfert de compte');
tz_def('PUBLIC_RULES_EMAIL_CHANGE', 'Pour modifier l’adresse électronique de votre compte ou transférer votre compte à un autre joueur ne jouant pas sur le même serveur, ouvrez votre profil (/spieler.php?s=3) et renseignez la nouvelle adresse électronique.');
tz_def('PUBLIC_RULES_SAME_WORLD_TRANSFER', 'Pour échanger un compte avec une personne jouant sur le même monde, les deux personnes doivent envoyer un message à admin@novaterra.com depuis l’adresse électronique actuellement associée au compte. Le message doit contenir les informations suivantes :');
tz_def('PUBLIC_RULES_WORLD_NAME', 'Le monde de jeu sur lequel se trouve le compte');
tz_def('PUBLIC_RULES_ACCOUNT_NICKNAME', 'Le pseudonyme du compte');
tz_def('PUBLIC_RULES_NEW_OWNER_EMAIL', 'L’adresse électronique du nouveau propriétaire.');
tz_def('PUBLIC_RULES_PASSWORD_REQUEST_AFTER_TRANSFER', 'Les deux personnes doivent ensuite demander le mot de passe de leur nouveau compte à l’aide de la fonction de récupération du mot de passe.');
tz_def('PUBLIC_RULES_SITTERS', 'Chaque joueur peut désigner deux cogestionnaires autorisés à jouer sur le compte pendant l’absence de son propriétaire. Les cogestionnaires doivent agir dans l’intérêt exclusif du compte. Tout abus de cette fonction est sanctionnable.');
tz_def('PUBLIC_RULES_SITTER_LOGIN', 'Le cogestionnaire doit utiliser la fonction de cogestion intégrée au jeu. Il ne doit pas se connecter avec le mot de passe du compte qu’il gère (voir &sect;1.2).');
tz_def('PUBLIC_RULES_SITTER_DAMAGE', 'Aucune compensation n’est accordée pour les dommages causés par un cogestionnaire. Le propriétaire du compte est entièrement responsable des actions de ses cogestionnaires. Si ceux-ci enfreignent les présentes règles ou les conditions générales de Novaterra, le propriétaire du compte comme le cogestionnaire peuvent être sanctionnés.');
tz_def('PUBLIC_RULES_SHARED_COMPUTER', 'Les joueurs utilisant le même ordinateur et souhaitant accéder au compte de l’autre doivent utiliser la fonction de cogestion.');
tz_def('PUBLIC_RULES_BROWSER', 'Le jeu doit être utilisé avec un navigateur internet non modifié. L’utilisation de scripts ou de robots automatisant le jeu est interdite.');
tz_def('PUBLIC_RULES_BUGS', 'Les erreurs du programme, également appelées bugs, ne doivent pas être exploitées à son avantage. Tout abus peut entraîner une sanction du compte.');
tz_def('PUBLIC_RULES_REAL_MONEY', 'Toute vente ou tout achat contre de l’argent réel concernant des comptes, unités, villages, ressources, services ou tout autre élément de Novaterra est interdit. La vente de comptes Novaterra, ainsi que tout transfert indirect, même à titre gratuit, lié à des sites d’enchères ou à d’autres transactions financières, est également interdite.');
tz_def('PUBLIC_RULES_POLITE_COMMUNICATION', 'Chacun doit communiquer de manière polie et courtoise. Les Multihunters peuvent modifier sans préavis les profils ou noms de village inappropriés.');
tz_def('PUBLIC_RULES_BEHAVIOUR_INTRO', 'Les comportements suivants sont sanctionnables et concernent toutes les descriptions, ainsi que les noms de compte, d’alliance, de village et les messages :');
tz_def('PUBLIC_RULES_LANGUAGE', 'Le français est la langue officielle utilisée sur ce serveur.');
tz_def('PUBLIC_RULES_BLACKMAIL', 'Faire chanter des joueurs d’une manière contraire aux règles de Novaterra ou aux conditions générales.');
tz_def('PUBLIC_RULES_ADVERTISING', 'Toute publicité n’ayant pas été autorisée par l’équipe Novaterra est interdite.');
tz_def('ANL_FOUND_VILLAGE_Q', 'Comment fonder un nouveau village ?');
tz_def('ANL_FOUND_VILLAGE_A', 'Pour fonder un nouveau village, vous avez besoin de trois colons, d’un emplacement libre sur la carte et d’un nombre suffisant de points de culture. Les colons n’ont pas besoin d’être recherchés : ils peuvent être entraînés directement dans un palais de niveau 10, 15 ou 20, ou dans une résidence de niveau 10 ou 20. La construction du palais nécessite un bâtiment principal de niveau 5 et une ambassade ; celle de la résidence nécessite seulement un bâtiment principal de niveau 5. Une fois les trois colons entraînés, choisissez un emplacement libre sur la carte puis cliquez sur « Fonder un nouveau village ». Vous devez disposer de 750 unités de chaque ressource.');
tz_def('ANL_CONQUER_VILLAGE_Q', 'Comment conquérir un village ?');
tz_def('ANL_CONQUER_VILLAGE_A1', 'Pour cela, vous avez également besoin d’une résidence ou d’un palais de niveau 10 au minimum, ainsi que d’un village ennemi pouvant être conquis. Un nombre suffisant de points de culture est aussi nécessaire, comme pour la fondation d’un nouveau village. Il est impossible de conquérir le dernier village d’un joueur ou sa capitale.');
tz_def('ANL_CONQUER_VILLAGE_A2', 'Après avoir recherché un administrateur — sénateur, chef ou chef de tribu — à l’académie, vous pouvez l’entraîner dans une résidence ou un palais comme un colon. Il ne doit toutefois pas y avoir déjà de colons entraînés dans l’emplacement concerné. Pour conquérir un village, l’administrateur doit l’attaquer plusieurs fois après la destruction de la résidence ou du palais ennemi. Lorsque la loyauté atteint zéro, le village devient vôtre. Il est alors recommandé d’y construire une résidence ou un palais afin de faire remonter sa loyauté.');
tz_def('ANL_CULTURE_POINTS_A', 'Les points de culture sont obtenus en construisant et en améliorant des bâtiments. Le nombre de points déjà produits est visible dans la résidence et le palais, qui indiquent également le nombre requis pour obtenir des villages supplémentaires.');
tz_def('PUBLIC_RULES_PROGRAM_ERRORS_HEADING', '&sect;4 Erreurs du programme');
tz_def('PUBLIC_RULES_PUNISHMENT', 'En cas d’infraction aux présentes règles, les Multihunters et, si nécessaire, les administrateurs suspendront le ou les comptes concernés et décideront d’une sanction appropriée. La sanction sera toujours supérieure au bénéfice tiré de l’infraction.');
tz_def('PUBLIC_RULES_NO_REPLACEMENT', 'Les ressources, bâtiments, villages ou troupes perdus pendant une suspension ne sont pas considérés comme faisant partie de la sanction et ne seront pas remplacés par l’équipe Novaterra. Aucun joueur ne peut réclamer le remboursement ou le remplacement du temps Plus/Or perdu pendant la suspension.');
tz_def('PUBLIC_RULES_NO_SPECIAL_TREATMENT', 'Les utilisateurs de Novaterra Plus/Or ne bénéficient d’aucun traitement particulier concernant les règles du jeu, ni dans le délai de traitement du dossier ni dans la sanction.');
tz_def('PUBLIC_RULES_APPEALS', 'Les joueurs peuvent contacter le Multihunter ayant prononcé la suspension ou un administrateur par message en jeu ou par courrier électronique. Les suspensions, sanctions et suppressions ne doivent pas être discutées publiquement, notamment dans le chat ou sur les forums. Les recours doivent être rédigés en français.');
tz_def('PUBLIC_RULES_OWNER_INFORMATION', 'L’équipe Novaterra ne communiquera par ailleurs aucune information à une personne autre que le propriétaire du compte.');
tz_def('PUBLIC_RULES_MULTI_DELETE', 'Les comptes multiples sur un serveur rapide ainsi que les comptes multiples de moins de 100 habitants peuvent être supprimés immédiatement et sans avertissement.');
tz_def('PUBLIC_RULES_SECTION_8', '&sect;8 Modification des règles');
tz_def('PUBLIC_RULES_CHANGE_ANY_TIME', 'L’équipe Novaterra se réserve le droit de modifier les règles à tout moment.');
tz_def('PUBLIC_RULES_SEVERABILITY', 'Si l’une des dispositions des présentes règles devait être inapplicable, cela n’affecterait pas la validité des autres dispositions. Les administrateurs s’engagent à remplacer aussi rapidement que possible toute disposition inapplicable par une nouvelle disposition appropriée.');
tz_def('ANL_BUILDINGS', 'Bâtiments');
tz_def('ANL_WAREHOUSE', 'Entrepôt');
tz_def('ANL_GRANARY', 'Grenier');
tz_def('ANL_MAIN_BUILDING', 'Bâtiment principal');
tz_def('ANL_MARKETPLACE', 'Marché');
tz_def('ANL_BARRACKS', 'Caserne');
tz_def('ANL_STABLE', 'Écurie');
tz_def('ANL_ACADEMY', 'Académie');
tz_def('ANL_CRANNY', 'Cachette');
tz_def('ANL_RESIDENCE', 'Résidence');
tz_def('ANL_PALACE', 'Palais');
tz_def('ANL_GREAT_BARRACKS', 'Grande caserne');
tz_def('ANL_GREAT_STABLE', 'Grande écurie');
tz_def('ANL_CULTURE_POINTS_MORE_VILLAGES', 'Plus un joueur possède de villages, plus le nombre de points de culture nécessaires pour en fonder ou en conquérir de nouveaux augmente. Les points de culture ne peuvent pas être perdus, mais le seuil requis progresse avec chaque village supplémentaire.');
tz_def('ANL_REQ_MAIN_BUILDING_1', 'Bâtiment principal niveau 1');
tz_def('ANL_REQ_MB3_WH1_GR1', 'Bâtiment principal niveau 3, entrepôt niveau 1, grenier niveau 1');
tz_def('ANL_REQ_RP1_MB3', 'Point de ralliement niveau 1, bâtiment principal niveau 3');
tz_def('ANL_REQ_BLACKSMITH3_ACADEMY5', 'Forge niveau 3, académie niveau 5');
tz_def('ANL_REQ_ACADEMY10_MB5', 'Académie niveau 10, bâtiment principal niveau 5');
tz_def('ANL_REQ_BARRACKS3_MB3', 'Caserne niveau 3, bâtiment principal niveau 3');
tz_def('ANL_REQ_MB3_ACADEMY3', 'Bâtiment principal niveau 3, académie niveau 3');
tz_def('ANL_REQ_MB3_ACADEMY1', 'Bâtiment principal niveau 3, académie niveau 1');
tz_def('ANL_REQ_EMBASSY1_MB5', 'Ambassade niveau 1, bâtiment principal niveau 5,');
tz_def('ANL_REQ_MB5', 'Bâtiment principal niveau 5,');
tz_def('ANL_REQ_MARKET20_STABLE10', 'Marché niveau 20, écurie niveau 10');
tz_def('ANL_SPEED_LABEL', 'Vitesse');
tz_def('ANL_FAQ_FOUND_CONQUER_FULL', 'Vous avez besoin de trois colons pour fonder un nouveau village. Pour conquérir un village, il vous faut un administrateur — sénateur, chef ou chef de tribu — entraîné dans un palais ou une résidence de niveau 10. Vous devez également disposer d’un nombre suffisant de points de culture.');
tz_def('ANL_CONSTRUCTION_TIME_LEVEL1', 'temps de construction du niveau 1 :');
tz_def('ANL_PALACE_SETTLERS_ADMIN', 'Aux niveaux 10, 15 et 20, trois colons ou un administrateur — sénateur, chef ou chef de tribu — peuvent être entraînés.');
tz_def('ANL_RESIDENCE_SETTLERS_ADMIN', 'Aux niveaux 10 et 20, trois colons ou un administrateur — sénateur, chef ou chef de tribu — peuvent être entraînés.');
tz_def('ANL_REQ_RALLY_POINT_15', 'Point de ralliement niveau 15');
tz_def('ANL_FAQ_FOUND_CONQUER_PREFIX', 'Vous avez besoin de trois colons pour fonder un nouveau village. Pour conquérir un village, il vous faut un administrateur — sénateur, chef ou chef de tribu — entraîné dans un palais ou une résidence de niveau 10. Vous devez également disposer d’un nombre suffisant de ');
tz_def('ANL_HOW_GET_CULTURE_POINTS', 'Comment obtenir des points de culture ?');
tz_def('ANL_LEVEL', 'Niveau');
tz_def('ANL_GREAT', 'Grande');
tz_def('ANL_CULTURE_POINTS_NEEDED', 'Points de culture nécessaires pour obtenir des villages supplémentaires');
tz_def('PUBLIC_MAIN_GOALS', 'Objectifs principaux :');
tz_def('PUBLIC_TERMS_SHORT', 'Conditions');

//////////////////////////////////////////////////////////////////////////////////////////////////////
// PANOU DE ADMINISTRARE - sabloane (lot 1: home, server_info, online, users,
// search, ban, notregistered, inactive, report, msg)
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_HELLO', 'Bonjour');
tz_def('ADM_TOTAL_PLAYERS', 'Total joueurs');
tz_def('ADM_ONLINE_NOW', 'En ligne');
tz_def('ADM_LAST_5_MIN', '5 dernières minutes');
tz_def('ADM_VILLAGES', 'Villages');
tz_def('ADM_GOLD_IN_GAME', 'Or en jeu');
tz_def('ADM_ACTIVE_BANS', 'Bannissements actifs');
tz_def('ADM_MANAGE', 'gérer');
tz_def('ADM_LAST_REGISTRATION', 'Dernière inscription');
tz_def('ADM_SERVER_CLOCK', 'Horloge du serveur');
tz_def('ADM_SERVER_TIMELINE', 'Chronologie du serveur');
tz_def('ADM_START_DATE', 'Date de début :');
tz_def('ADM_NATARS_C', 'Tatars :');
tz_def('ADM_ARTEFACTS_C', 'Artefacts :');
tz_def('ADM_WW_PLANS_C', 'Plans MdM :');
tz_def('ADM_SERVER_AGE', 'Âge du serveur :');
tz_def('ADM_NEXT_EVENT', 'Prochain événement :');
tz_def('ADM_LAST_5_ACTIONS', '5 dernières actions');
tz_def('ADM_VIEW_FULL_LOG', 'voir le journal →');
tz_def('ADM_QUICK_ACTIONS', 'Actions rapides');
tz_def('ADM_QA_SEARCH', '🔍 Chercher un joueur');
tz_def('ADM_QA_BAN', '🔨 Bannissements');
tz_def('ADM_QA_MAP', '🗺 Carte');
tz_def('ADM_QA_NATARS', '🏰 Tatars');
tz_def('ADM_QA_ADD_USER', '👤 Ajouter un joueur');
tz_def('ADM_QA_SERVER_INFO', '⚙ Infos serveur');
tz_def('ADM_WORLD_INFO', '🌍 Informations du monde');
tz_def('ADM_REGISTERED_PLAYERS', 'Joueurs inscrits');
tz_def('ADM_ACTIVE_PLAYERS', 'Joueurs actifs');
tz_def('ADM_PLAYERS_ONLINE', 'Joueurs connectés');
tz_def('ADM_PLAYERS_BANNED', 'Joueurs bannis');
tz_def('ADM_VILLAGES_SETTLED', 'Villages fondés');
tz_def('ADM_TOTAL_POPULATION', 'Population totale');
tz_def('ADM_PLAYER_DISTRIBUTION', '👥 Répartition des joueurs');
tz_def('ADM_SERVER_ECONOMY', '💰 Économie du serveur');
tz_def('ADM_TOTAL_GOLD', 'Or total');
tz_def('ADM_AVG_GOLD', 'Or moyen/joueur');
tz_def('ADM_SERVER_STARTED', 'Serveur démarré');
tz_def('ADM_UPTIME', 'Temps de fonctionnement');
tz_def('ADM_TROOPS_ON_SERVER', '⚔️ Troupes sur le serveur (villages + renforts)');
tz_def('ADM_ONLINE_USERS_H', '🟢 Joueurs connectés');
tz_def('ADM_NO_ONLINE_USERS', 'Aucun joueur connecté ces 5 dernières minutes');
tz_def('ADM_USERS_H', '👥 Joueurs');
tz_def('ADM_ALL', 'Tous');
tz_def('ADM_ADMINS', 'Administrateurs');
tz_def('ADM_NORMAL', 'Normaux');
tz_def('ADM_BANNED', 'Bannis');
tz_def('ADM_ONLINE', 'Connectés');
tz_def('ADM_ID', 'ID');
tz_def('ADM_USERNAME', 'Nom d\'utilisateur');
tz_def('ADM_EMAIL', 'E-mail');
tz_def('ADM_ACCESS', 'Accès');
tz_def('ADM_TRIBE', 'Tribu');
tz_def('ADM_GOLD', 'Or');
tz_def('ADM_LAST_ACTIVITY', 'Dernière activité');
tz_def('ADM_PREV', '« Préc.');
tz_def('ADM_NEXT', 'Suiv. »');
tz_def('ADM_SEARCH_PH', 'Rechercher...');
tz_def('ADM_ADMIN_SEARCH', 'Recherche');
tz_def('ADM_SEARCH_HINT', 'Nom, ID, e-mail ou IP...');
tz_def('ADM_SEARCH_BTN', 'Rechercher');
tz_def('ADM_BAN_MANAGEMENT', 'Gestion des bannissements');
tz_def('ADM_ACTIVE_USER_BANS', 'Joueurs bannis');
tz_def('ADM_ACTIVE_IP_BANS', 'IP bannies');
tz_def('ADM_HISTORY_50', 'Historique (50 derniers)');
tz_def('ADM_ADD_NEW_BAN', 'Nouveau bannissement');
tz_def('ADM_FOREVER', 'Définitif');
tz_def('ADM_BAN_USER', 'Bannir le joueur');
tz_def('ADM_BAN_IP_ADDRESS', 'Bannir une adresse IP');
tz_def('ADM_BAN_IP', 'Bannir l\'IP');
tz_def('ADM_BAN_HISTORY', 'Historique des bannissements');
tz_def('ADM_USER_ID', 'ID du joueur');
tz_def('ADM_IPV4_OR_IPV6', 'IPv4 ou IPv6');
tz_def('ADM_NOT_ACTIVATED_H', '✉️ Joueurs non activés');
tz_def('ADM_ACTIVATION_CODE', 'Code d\'activation');
tz_def('ADM_ACT2', 'Act2');
tz_def('ADM_TIME', 'Heure');
tz_def('ADM_SEARCH_USER_EMAIL', 'Nom d\'utilisateur ou e-mail...');
tz_def('ADM_INACTIVE_USERS', 'Joueurs inactifs');
tz_def('ADM_DELETE_L', 'supprimer');
tz_def('ADM_BACK_TO_REPORTS', '← Retour aux rapports');
tz_def('ADM_REPORT', 'Rapport');
tz_def('ADM_VIEW_ARROW', 'voir →');
tz_def('ADM_BACK_TO_MESSAGES', '← Retour aux messages');
tz_def('ADM_SENT_TO', 'Envoyé à');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_CRON_AUTOMATION', 'Cron et automatisation');
tz_def('ADM_AUTOMATION_SOURCE', 'Source de l\'automatisation');
tz_def('ADM_WHERE_THE_GAME_TICK_BATTLES_MOVEMENTS_TRAINI', 'D\'où provient le traitement du jeu (batailles, mouvements, entraînement, construction). Quand la tâche cron tourne, les pages des joueurs ne portent plus ce traitement.');
tz_def('ADM_LAST_CRON_TICK', 'Dernier passage du cron');
tz_def('ADM_WRITTEN_BY_CRON_PHP_ON_EVERY_TICK_INTO_GAMEE', 'Écrit par cron.php à chaque passage dans GameEngine/Prevention/cron_active.txt. Moins de 90 secondes signifie que le cron est actif.');
tz_def('ADM_INVOCATION_LENGTH', 'Durée d\'une invocation');
tz_def('ADM_CRON_LOOP_SECONDS_HOW_LONG_ONE_CRON_PHP_INVO', 'CRON_LOOP_SECONDS - durée pendant laquelle une invocation de cron.php continue de travailler. Les hébergeurs limités à un cron toutes les 5 minutes obtiennent quand même un passage par minute. 0 = un seul passage par invocation.');
tz_def('ADM_TICK_INTERVAL', 'Intervalle entre passages');
tz_def('ADM_CRON_TICK_SECONDS_HOW_OFTEN_AUTOMATION_RUNS', 'CRON_TICK_SECONDS - fréquence d\'exécution d\'Automation à l\'intérieur d\'une invocation. Automation attend un passage toutes les 60 secondes environ.');
tz_def('ADM_HTTP_TRIGGER_KEY', 'Clé de déclenchement HTTP');
tz_def('ADM_CRON_KEY_ONLY_NEEDED_TO_CALL_CRON_PHP_OVER_H', 'CRON_KEY - nécessaire uniquement pour appeler cron.php via HTTP (service de cron externe). La tâche cron du serveur n\'utilise pas cette clé. Générée automatiquement à l\'installation.');
tz_def('ADM_NOT_SET', 'Non définie');
tz_def('ADM_SHOW', 'afficher');
tz_def('ADM_HTTP_TRIGGER_URL', 'URL de déclenchement HTTP');
tz_def('ADM_OPTIONAL_USE_THIS_WITH_AN_EXTERNAL_CRON_SERV', 'Facultatif. À utiliser avec un service de cron externe si l\'hébergeur ne peut pas exécuter de cron local. Un appel HTTP = un passage.');
tz_def('ADM_HIDDEN_USE_SHOW_ABOVE', 'masquée &ndash; utilisez « afficher » ci-dessus');
tz_def('ADM_DATABASE_CLEANUP', 'Nettoyage de la base de données');
tz_def('ADM_AUTOMATION_TRIMS_TABLES_THAT_WOULD_OTHERWISE', 'Automation réduit les tables qui grandiraient sans fin. Les rapports archivés ne sont jamais supprimés. 0 désactive une règle.');
tz_def('ADM_LAST_CLEANUP_RUN', 'Dernier nettoyage');
tz_def('ADM_CLEANUP_RUNS_ONCE_PER_HOUR_FROM_AUTOMATION_A', 'Le nettoyage s\'exécute une fois par heure depuis Automation et supprime par lots ; sur un serveur ancien, le premier passage rattrape le retard en plusieurs fois.');
tz_def('ADM_CRON_JOB_COMMAND', 'Commande de la tâche cron');
tz_def('ADM_ADD_THIS_IN_CPANEL_CRON_JOBS_THE_PATH_IS_DET', 'À ajouter dans cPanel &rarr; Cron Jobs. Le chemin est détecté depuis cette installation.');
tz_def('ADM_CURRENT_STATUS', 'État actuel');
tz_def('ADM_WHEN_THE_CRON_JOB_IS_NOT_RUNNING_THE_GAME_ST', 'Si la tâche cron ne tourne pas, le jeu fonctionne quand même : les pages des joueurs traitent le passage, comme avant l\'introduction du cron.');
tz_def('ADM_ADD_THIS_IN_CPANEL_CRON_JOBS_WRITING_TO_CRON', 'À ajouter dans cPanel &rarr; Cron Jobs. Écrire dans cron.log plutôt que /dev/null permet de voir les erreurs en cas d\'échec.');
tz_def('ADM_SETTINGS', 'Paramètres');
tz_def('ADM_INVOCATION_LENGTH_SECONDS', 'Durée d\'une invocation (secondes)');
tz_def('ADM_0_A_SINGLE_TICK_PER_INVOCATION_MAXIMUM_3300', '0 = un seul passage par invocation. Maximum 3300 (55 minutes).');
tz_def('ADM_TICK_INTERVAL_SECONDS', 'Intervalle entre passages (secondes)');
tz_def('ADM_HOW_OFTEN_AUTOMATION_RUNS_INSIDE_ONE_INVOCAT', 'Fréquence d\'exécution d\'Automation dans une invocation. Sa propre garde attend environ 60 secondes ; descendre plus bas ajoute surtout de la charge sans rien traiter de nouveau.');
tz_def('ADM_RECOMMENDED_60_ALLOWED_RANGE_15_900', 'Recommandé : 60. Plage autorisée 15&ndash;900.');
tz_def('ADM_ONLY_NEEDED_WHEN_CALLING_CRON_PHP_OVER_HTTP', 'Nécessaire uniquement pour appeler cron.php via HTTP (par exemple depuis un service de cron externe). La tâche cron du serveur ne l\'utilise pas. La régénérer invalide toute URL configurée ailleurs.');
tz_def('ADM_GENERATE_A_NEW_KEY_ON_SAVE', 'Générer une nouvelle clé à la sauvegarde');
tz_def('ADM_RUNS_FROM_AUTOMATION_ONCE_PER_HOUR_ROWS_ARE', 'S\'exécute depuis Automation une fois par heure. Les lignes sont supprimées par lots ; sur un serveur ancien, le premier passage rattrape en plusieurs fois.');
tz_def('ADM_BATTLE_REPORTS_DAYS', 'Rapports de combat (jours)');
tz_def('ADM_UNARCHIVED_REPORTS_OLDER_THAN_THIS_ARE_DELET', 'Les rapports non archivés plus anciens sont supprimés. Les rapports archivés par un joueur ne sont jamais touchés. 0 désactive la règle.');
tz_def('ADM_0_KEEP_FOREVER', '0 = conserver indéfiniment.');
tz_def('ADM_CHAT_MESSAGES_DAYS', 'Messages du chat (jours)');
tz_def('ADM_THE_CHAT_WINDOW_ONLY_EVER_SHOWS_THE_LAST_13', 'La fenêtre de chat n\'affiche que les 13 derniers messages par alliance ; l\'historique plus ancien n\'est utilisé nulle part dans le jeu.');
tz_def('ADM_DELETED_MESSAGES_DAYS', 'Messages supprimés (jours)');
tz_def('ADM_ONLY_MESSAGES_DELETED_BY_BOTH_THE_SENDER_AND', 'Seuls les messages supprimés par l\'expéditeur ET le destinataire sont retirés &mdash; ils ne sont plus visibles par personne. Désactivé par défaut.');
tz_def('ADM_0_DISABLED_DEFAULT', '0 = désactivé (par défaut).');
tz_def('ADM_NEW_MECHANICS_AND_FUNCTIONS', 'Nouvelles mécaniques et fonctions');
tz_def('ADM_HERO_BASE_REGENERATION', 'Régénération de base du héros');
tz_def('ADM_HIT_POINTS_THE_HERO_RECOVERS_PER_DAY_INDEPEN', 'Points de vie récupérés par le héros chaque jour, indépendamment de l\'attribut de régénération et des objets équipés. 0 désactive.');
tz_def('ADM_HP_DAY', 'PV / jour');
tz_def('ADM_HERO_EXCHANGE_RATES', 'Taux de change du héros');
tz_def('ADM_RATES_OF_THE_EXCHANGE_OFFICE_IN_THE_AUCTION', 'Taux du bureau de change de la maison de ventes. L\'écart entre les deux sens constitue la marge, donc faire l\'aller-retour fait perdre de la valeur au lieu d\'en créer.');
tz_def('ADM_EXCHANGE_OFFICE_IN_THE_AUCTION_HOUSE_KEEP_TH', 'Bureau de change de la maison de ventes. Gardez la seconde valeur supérieure à la première, sinon les joueurs pourraient créer de l\'or à partir de rien.');
tz_def('ADM_1_GOLD', '1 or &rarr;');
tz_def('ADM_SILVER_1_GOLD', 'argent &rarr; 1 or');
tz_def('ADM_HERO_RESOURCE_PRODUCTION', 'Production de ressources du héros');
tz_def('ADM_OF_ONE_TYPE', 'd\'un seul type');
tz_def('ADM_DISPLAY_OASIS_IN_PROFILE', 'Afficher les oasis dans le profil');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_OASES_OF_EACH', 'Activer (désactiver) l\'affichage des oasis de chaque village dans le profil du joueur');
tz_def('ADM_ALLIANCE_INVITATION_MESSAGE', 'Message d\'invitation d\'alliance');
tz_def('ADM_ENABLE_DISABLE_SENDING_AN_IN_GAME_MESSAGE_TO', 'Activer (désactiver) l\'envoi d\'un message en jeu au joueur invité dans l\'alliance');
tz_def('ADM_NEW_ALLIANCE_EMBASSY_MECHANICS', 'Nouvelles mécaniques d\'alliance et d\'ambassade');
tz_def('ADM_NEW_FORUM_POST_MESSAGE', 'Message de nouveau sujet du forum');
tz_def('ADM_ENABLE_DISABLE_FORUM_SUBSCRIPTION_MESSAGES', 'Activer (désactiver) les messages d\'abonnement au forum');
tz_def('ADM_TRIBES_IMAGES_IN_PROFILE', 'Images des tribus dans le profil');
tz_def('ADM_ENABLE_DISABLE_DISPLAYING_IMAGES_OF_TRIBES', 'Activer (désactiver) l\'affichage des images des tribus');
tz_def('ADM_ENABLE_DISABLE_DISPLAYING_IMAGES_OF_TRIBES_W', 'Activer (désactiver) l\'affichage des images des tribus avec une description dans le profil des joueurs');
tz_def('ADM_NEW_TRIBE_HUNS', 'Nouvelle tribu : Huns');
tz_def('ADM_ENABLE_DISABLE_THE_HUNS_TRIBE', 'Activer (désactiver) la tribu des Huns');
tz_def('ADM_ENABLE_DISABLE_TRIBE_HUNS', 'Activer (désactiver) la tribu des Huns');
tz_def('ADM_NEW_TRIBE_EGYPTIANS', 'Nouvelle tribu : Égyptiens');
tz_def('ADM_ENABLE_DISABLE_THE_EGYPTIANS_TRIBE', 'Activer (désactiver) la tribu des Égyptiens');
tz_def('ADM_ENABLE_DISABLE_TRIBE_EGYPTIANS', 'Activer (désactiver) la tribu des Égyptiens');
tz_def('ADM_NEW_TRIBE_SPARTANS', 'Nouvelle tribu : Spartiates');
tz_def('ADM_ENABLE_DISABLE_THE_SPARTANS_TRIBE', 'Activer (désactiver) la tribu des Spartiates');
tz_def('ADM_ENABLE_DISABLE_TRIBE_SPARTANS', 'Activer (désactiver) la tribu des Spartiates');
tz_def('ADM_NEW_TRIBE_VIKINGS', 'Nouvelle tribu : Vikings');
tz_def('ADM_ENABLE_DISABLE_THE_VIKINGS_TRIBE', 'Activer (désactiver) la tribu des Vikings');
tz_def('ADM_ENABLE_DISABLE_TRIBE_VIKINGS', 'Activer (désactiver) la tribu des Vikings');
tz_def('ADM_MHS_IMAGES_IN_PROFILE', 'Images des MH dans le profil');
tz_def('ADM_ENABLE_DISABLE_DISPLAYING_IMAGES_OF_MULTIHUN', 'Activer (désactiver) l\'affichage des images des Multihunters');
tz_def('ADM_ENABLE_DISABLE_DISPLAYING_IMAGES_OF_MULTIHUN_2', 'Activer (désactiver) l\'affichage des images des Multihunters avec une description dans leur profil');
tz_def('ADM_DISPLAY_ARTIFACT_IN_PROFILE', 'Afficher l\'artefact dans le profil');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_THE_ARTIFACT', 'Activer (désactiver) l\'affichage de l\'artefact');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_THE_ARTIFACT_I', 'Activer (désactiver) l\'affichage de l\'artefact dans le profil du joueur, en face du village où il se trouve');
tz_def('ADM_DISPLAY_WOW_IN_PROFILE', 'Afficher la MdM dans le profil');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_THE_WONDER', 'Activer (désactiver) l\'affichage de la merveille');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_THE_WONDER_IN', 'Activer (désactiver) l\'affichage de la merveille dans le profil du joueur, en face du village où elle se trouve');
tz_def('ADM_VACATION_MODE', 'Mode vacances');
tz_def('ADM_ENABLE_DISABLE_VACATION_MODE', 'Activer (désactiver) le mode vacances');
tz_def('ADM_ENABLE_DISABLE_VACATION_MODE_WILL_BE_DISPLAY', 'Activer (désactiver) le mode vacances ; il sera affiché ou masqué dans le menu du profil du joueur');
tz_def('ADM_CATAPULT_TARGETS', 'Cibles des catapultes');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_CATAPULT_TARGE', 'Activer (désactiver) l\'affichage des cibles des catapultes');
tz_def('ADM_ENABLE_DISABLE_THE_DISPLAY_OF_THE_TARGETS_OF', 'Activer (désactiver) l\'affichage, au point de ralliement, des cibles des catapultes que vous avez envoyées');
tz_def('ADM_MANUAL_ON_NATURE_AND_NATARS', 'Manuel sur la Nature et les Tatars');
tz_def('ADM_ENABLE_DISABLE_MANUAL_INFO', 'Activer (désactiver) les infos du manuel');
tz_def('ADM_ENABLE_DISABLE_DISPLAYING_INFORMATION_IN_THE', 'Activer (désactiver) l\'affichage dans le manuel des informations sur les troupes de la Nature et des Tatars');
tz_def('ADM_DIRECT_LINKS_PLACEMENT', 'Emplacement des liens directs');
tz_def('ADM_LEFT_MENU_VS_RIGHT_MENU', 'Menu de gauche ou de droite');
tz_def('ADM_IF_ENABLED_THEN_THE_DIRECT_LINKS_WILL_BE_PLA', 'Si activé, les liens directs sont placés dans le menu de gauche ; si désactivé, dans le menu de droite comme dans le Novaterra original');
tz_def('ADM_MEDAL_VETERAN_PLAYER', 'Médaille joueur vétéran');
tz_def('ADM_3_YEARS', '3 ans');
tz_def('ADM_ENABLE_DISABLE_MEDAL_ACHIEVED_FOR_PLAYING_3', 'Activer (désactiver) la médaille des 3 ans de jeu');
tz_def('ADM_MEDAL_VETERAN_PLAYER_5A', 'Médaille joueur vétéran 5a');
tz_def('ADM_5_YEARS', '5 ans');
tz_def('ADM_ENABLE_DISABLE_MEDAL_ACHIEVED_FOR_PLAYING_5', 'Activer (désactiver) la médaille des 5 ans de jeu');
tz_def('ADM_MEDAL_VETERAN_PLAYER_10A', 'Médaille joueur vétéran 10a');
tz_def('ADM_10_YEARS', '10 ans');
tz_def('ADM_ENABLE_DISABLE_MEDAL_ACHIEVED_FOR_PLAYING_10', 'Activer (désactiver) la médaille des 10 ans de jeu');
tz_def('ADM_SPECIAL_MEDALS', 'Médailles spéciales');
tz_def('ADM_ENABLE_DISABLE_SPECIAL_MEDALS_ARTIFACT_HERO', 'Activer (désactiver) les médailles spéciales (artefact, héros, merveille, muraille, grand entrepôt, etc.)');
tz_def('ADM_SERVER_MILESTONES', 'Étapes du serveur');
tz_def('ADM_NOT_PRESENT_IN_CONFIG_PHP_YET_SAVING_THIS_FO', 'Pas encore présent dans config.php &mdash; enregistrer ce formulaire une fois l\'ajoutera (False par défaut jusque-là).');
tz_def('ADM_SERVER_MEDAL_RESET_TIMER', 'Minuteur de réinitialisation des médailles');
tz_def('ADM_ENABLE_DISABLE_THE_SERVER_MEDAL_RESET_TIMER', 'Activer (désactiver) le widget « Minuteur de réinitialisation des médailles » dans les Top 10 joueurs et alliances');
tz_def('ADM_T4_HERO_ITEMS_ADVENTURES_AUCTION', 'Héros T4 (objets, aventures, enchères)');
tz_def('ADM_ENABLE_DISABLE_THE_T4_HERO_ITEMS_ADVENTURES', 'Activer (désactiver) le système « Héros T4 (objets, aventures, enchères) »');
tz_def('ADM_REGISTRATION_BONUS_GOLD', 'Or de bienvenue à l\'inscription');
tz_def('ADM_GIVE_EVERY_NEWLY_REGISTERED_PLAYER_A_ONE_TIM', 'Offrir à chaque nouveau joueur un bonus d\'or unique à la création du compte');
tz_def('ADM_REGISTRATION_BONUS_GOLD_AMOUNT', 'Or de bienvenue &ndash; montant');
tz_def('ADM_HOW_MUCH_GOLD_EACH_NEW_PLAYER_RECEIVES_WHEN', 'Quantité d\'or reçue par chaque nouveau joueur quand le bonus est activé');
tz_def('ADM_ENABLE_DISABLE_A_ONE_TIME_GOLD_BONUS_GRANTED', 'Activer (désactiver) un bonus d\'or unique accordé à chaque nouveau joueur à la création du compte (les comptes système id&le;3 sont ignorés). Le montant est défini ci-dessous.');
tz_def('ADM_HOW_MUCH_GOLD_EACH_NEW_PLAYER_RECEIVES_WHEN_2', 'Quantité d\'or reçue par chaque nouveau joueur quand l\'option ci-dessus est True. Par défaut : 200.');
tz_def('ADM_FOR_THIS_SETTING_YOU_CAN_FIND_MORE_INFORMATI', 'Pour ce paramètre, vous trouverez plus d\'informations sur ce lien :');
tz_def('ADM_EDIT_CRON_AUTOMATION', 'Modifier Cron et automatisation');
tz_def('ADM_EDIT_NEW_MECHANICS_AND_FUNCTIONS', 'Modifier les nouvelles mécaniques et fonctions');
tz_def('ADM_ENGLISH', 'Anglais');
...
tz_def('ADM_2_HOURS', '2 heures');
tz_def('ADM_3_HOURS', '3 heures');
tz_def('ADM_5_HOURS', '5 heures');
tz_def('ADM_8_HOURS', '8 heures');
tz_def('ADM_10_HOURS', '10 heures');
tz_def('ADM_12_HOURS', '12 heures');
tz_def('ADM_16_HOURS', '16 heures');
tz_def('ADM_20_HOURS', '20 heures');
tz_def('ADM_24_HOURS_1_DAY', '24 heures (1 jour)');
tz_def('ADM_48_HOURS_2_DAYS', '48 heures (2 jours)');
tz_def('ADM_72_HOURS_3_DAYS', '72 heures (3 jours)');
tz_def('ADM_120_HOURS_5_DAYS', '120 heures (5 jours)');
tz_def('ADM_TRUE', 'True');
tz_def('ADM_FALSE', 'False');
tz_def('ADM_YES', 'Oui');
tz_def('ADM_NO', 'Non');
tz_def('ADM_NOVATERRA_OFFICIAL', 'Novaterra officiel');
tz_def('ADM_NOVATERRA_EXTENDED', 'Novaterra étendu');
tz_def('ADM_10_DEFAULT', '10 - par défaut');
tz_def('ADM_NONE', 'aucun');
tz_def('ADM_1_DAY', '1 jour');
tz_def('ADM_2_DAYS', '2 jours');
tz_def('ADM_3_DAYS', '3 jours');
tz_def('ADM_4_DAYS', '4 jours');
tz_def('ADM_5_DAYS', '5 jours');
tz_def('ADM_6_DAYS', '6 jours');
tz_def('ADM_7_DAYS', '7 jours');
tz_def('ADM_NONE_2', 'Aucun');
tz_def('ADM_CHRISTMAS', 'Noël');
tz_def('ADM_NEW_YEAR', 'Nouvel An');
tz_def('ADM_EASTER', 'Pâques');
tz_def('ADM_ENABLE', 'Activer');
tz_def('ADM_DISABLE', 'Désactiver');
tz_def('ADM_SAVE', 'ENREGISTRER');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_START', 'Début');
tz_def('ADM_END', 'Fin');
tz_def('ADM_DURATION', 'Durée');
tz_def('ADM_REASON', 'Motif');
tz_def('ADM_PLAYER', 'Joueur :');
tz_def('ADM_BASIC_INFO', '📝 Informations de base');
tz_def('ADM_HERO_NAME', 'Nom du héros');
tz_def('ADM_HERO_UNIT', 'Unité du héros');
tz_def('ADM_HEALTH', '❤ Santé');
tz_def('ADM_EXPERIENCE', '✨ Expérience');
tz_def('ADM_CURRENT_STATS', '📈 Statistiques actuelles');
tz_def('ADM_LEVEL', 'Niveau :');
tz_def('ADM_OF', 'sur');
tz_def('ADM_FREE', '(libres :');
tz_def('ADM_OFFENCE', 'Attaque :');
tz_def('ADM_DEFENCE', 'Défense :');
tz_def('ADM_OFF_BONUS', 'Bonus attaque :');
tz_def('ADM_DEF_BONUS', '| Bonus défense :');
tz_def('ADM_REGEN', 'Régén. :');
tz_def('ADM_RESOURCES', 'Ressources :');
tz_def('ADM_ADD_POINTS', '⚔ Ajouter des points');
tz_def('ADM_ATTRIBUTE', 'Attribut');
tz_def('ADM_CURRENT', 'Actuel');
tz_def('ADM_ADD', 'Ajouter');
tz_def('ADM_NEW', 'Nouveau');
tz_def('ADM_PRODUCED_RESOURCE', 'Ressource produite');
tz_def('ADM_LEVEL_NOU', 'Nouveau niveau :');
tz_def('ADM_BACK', '← Retour');
tz_def('ADM_SAVE_HERO', '💾 Enregistrer le héros');
tz_def('ADM_CLASSIC_HERO_EDITOR', '&laquo; éditeur de héros classique');
tz_def('ADM_ACTION_COMPLETED', 'Action effectuée.');
tz_def('ADM_ACTION_FAILED_CHECK_THE_VALUES_AND_TRY_AGAIN', 'Échec de l\\\'action (vérifiez les valeurs et réessayez).');
tz_def('ADM_SILVER', 'Argent');
tz_def('ADM_SET_BALANCE', 'Définir le solde');
tz_def('ADM_GRANT_ITEM', 'Attribuer un objet');
tz_def('ADM_QTY', 'Qté :');
tz_def('ADM_GRANT', 'Attribuer');
tz_def('ADM_ROW', 'Ligne');
tz_def('ADM_ITEM', 'Objet');
tz_def('ADM_SLOT', 'Emplacement');
tz_def('ADM_QTY_2', 'Qté');
tz_def('ADM_EQUIPPED', 'Équipé');
tz_def('ADM_DELETE', 'Supprimer');
tz_def('ADM_AUCTION', 'Enchère');
tz_def('ADM_ROLE', 'Rôle');
tz_def('ADM_PRICE', 'Prix');
tz_def('ADM_ENDS', 'Se termine');
tz_def('ADM_CANCEL', 'Annuler');
tz_def('ADM_ADVENTURES', 'Aventures');
tz_def('ADM_RUNNING', 'En cours :');
tz_def('ADM_OFFER', 'Offre');
tz_def('ADM_DIFFICULTY', 'Difficulté');
tz_def('ADM_EXPIRES', 'Expire');
tz_def('ADM_REMOVE', 'Retirer');
tz_def('ADM_PLAYER_HEROES', 'Héros du joueur');
tz_def('ADM_NONE_3', 'Aucun &nbsp;&nbsp;');
tz_def('ADM_ADD_HERO', 'Ajouter un héros');
tz_def('ADM_HERO_LEVEL', 'Niveau du héros');
tz_def('ADM_STATUS', 'Statut');
tz_def('ADM_ALIVE', 'Vivant');
tz_def('ADM_DEAD', 'Mort');
tz_def('ADM_DETAILS', 'Détails');
tz_def('ADM_POINT', 'Points');
tz_def('ADM_LEVEL_2', 'Niveau');
tz_def('ADM_OFFENCE_2', 'Attaque');
tz_def('ADM_DEFENCE_2', 'Défense');
tz_def('ADM_OFF_BONUS_2', 'Bonus attaque');
tz_def('ADM_DEF_BONUS_2', 'Bonus défense');
tz_def('ADM_REGENERATION', 'Régénération');
tz_def('ADM_RESOURCES_2', 'Ressources');
tz_def('ADM_HEALTH_2', 'Santé');
tz_def('ADM_EDIT', 'Modifier');
tz_def('ADM_T4_ITEMS_SILVER_AUCTIONS', 'Objets T4 / argent / enchères');
tz_def('ADM_KILL', 'Tuer');
tz_def('ADM_REVIVE', 'Ressusciter');
tz_def('ADM_VILLAGE_INFORMATION', 'Informations du village');
tz_def('ADM_OWNER', 'Propriétaire');
tz_def('ADM_NAME', 'Nom');
tz_def('ADM_POPULATION', 'Population');
tz_def('ADM_COORDS', 'Coordonnées');
tz_def('ADM_FIELD', 'Case');
tz_def('ADM_RES', 'Res');
tz_def('ADM_AMT', 'Qté');
tz_def('ADM_CAP', 'Cap.');
tz_def('ADM_PROD', 'Prod.');
tz_def('ADM_WOOD', 'Bois');
tz_def('ADM_CLAY', 'Argile');
tz_def('ADM_IRON', 'Fer');
tz_def('ADM_CROP', 'Céréales');
...
tz_def('ADM_TROOPS', 'Troupes');
tz_def('ADM_UPGRADES', 'Améliorations');
tz_def('ADM_ARTIFACT', 'Artefact');
tz_def('ADM_RESOURCE_FIELDS', 'Cases de ressources');
tz_def('ADM_BUILDINGS', 'Bâtiments');
tz_def('ADM_GID', 'GID');
tz_def('ADM_LVL', 'Niv.');
tz_def('ADM_VILLAGE_BUILD_LOG', 'Journal de construction du village →');
tz_def('ADM_CHANGE', 'Modifier');
tz_def('ADM_RENAME', 'Renommer');
tz_def('ADM_SHOW_INSTRUCTIONS', 'Afficher les instructions');
tz_def('ADM_RESOURCE_FIELDS_1_18', 'Cases de ressources (1-18)');
tz_def('ADM_VILLAGE_CENTER_19_38', 'Centre du village (19-38)');
tz_def('ADM_MODIFY_BUILDINGS', 'Modifier les bâtiments');
tz_def('ADM_SAVE_CHANGES', 'Enregistrer');
tz_def('ADM_CURRENT_LAYOUT_PREVIEW', 'Aperçu de la disposition actuelle');
tz_def('ADM_VILLAGE_CENTER', 'Centre du village');
tz_def('ADM_EDIT_PLAYER', '✏️ Modifier le joueur :');
tz_def('ADM_ACCOUNT_DETAILS', '👤 Détails du compte');
tz_def('ADM_USERNAME_2', '👤 Nom d\\\'utilisateur');
tz_def('ADM_SAVE_2', '💾 Enregistrer');
tz_def('ADM_TRIBE_2', '⚔️ Tribu');
tz_def('ADM_1_ROMAN', '1. Romains');
tz_def('ADM_2_TEUTON', '2. Teutons');
tz_def('ADM_3_GAUL', '3. Gaulois');
tz_def('ADM_4_NATURE', '4. Nature');
tz_def('ADM_5_NATARS', '5. Tatars');
tz_def('ADM_6_HUN', '6. Huns');
tz_def('ADM_7_EGYPTIAN', '7. Égyptiens');
tz_def('ADM_8_SPARTAN', '8. Spartiates');
tz_def('ADM_9_VIKING', '9. Vikings');
tz_def('ADM_LOCATION', '📍 Emplacement');
tz_def('ADM_E_MAIL', '✉️ E-mail');
tz_def('ADM_QUEST', '🎯 Quête');
tz_def('ADM_PROFILE_DESCRIPTION_LEFT', '📝 Description du profil (gauche)');
tz_def('ADM_PROFILE_DESCRIPTION_RIGHT', '📄 Description du profil (droite)');
tz_def('ADM_SUPORT_BBCODE_FOLOSE_TE_ENTER_PENTRU_LINII_N', 'BBCode pris en charge. Utilisez Entrée pour un saut de ligne.');
tz_def('ADM_MEDALS', '🏅 Médailles');
tz_def('ADM_CATEGORY', 'Catégorie');
tz_def('ADM_RANK', 'Rang');
tz_def('ADM_WEEK', 'Semaine');
tz_def('ADM_BB_CODE', 'BB-Code');
tz_def('ADM_BEGINNERS_PROTECTION', 'Protection des débutants');
tz_def('ADM_SAVE_CHANGES_2', '💾 Enregistrer');
tz_def('ADM_GO_BACK_TO_PLAYER', '« Retour au joueur');
tz_def('ADM_CHANGE_USERNAME', 'Changer le nom d\\\'utilisateur');
tz_def('ADM_DELETE_PLAYER_PERMANENTLY', 'SUPPRIMER LE JOUEUR DÉFINITIVEMENT');
tz_def('ADM_THIS_ACTION_CANNOT_BE_UNDONE', 'Cette action est irréversible !');
tz_def('ADM_PLAYER_TO_DELETE', '🗑️ Joueur à supprimer');
tz_def('ADM_PLUS_ENDS', 'Fin du Plus');
tz_def('ADM_WARNING', 'ATTENTION :');
tz_def('ADM_PERMANENTLY', 'définitivement');
tz_def('ADM_DELETED_THERE_IS_NO_RECOVERY', 'supprimé. Aucune récupération possible !');
tz_def('ADM_CONFIRM_WITH_YOUR_ADMIN_PASSWORD', 'Confirmez avec votre mot de passe administrateur :');
tz_def('ADM_CANCEL_2', '← Annuler');
tz_def('ADM_DELETE_PLAYER', '🗑️ SUPPRIMER LE JOUEUR');
tz_def('ADM_EDIT_SITTERS', 'Modifier les remplaçants :');
tz_def('ADM_SITTER_SETTINGS', '⚙️ Paramètres des remplaçants');
tz_def('ADM_USE_THE_PLAYER_S_UID_ENTER', '💡 Utilisez l\\\'UID du joueur. Saisissez');
tz_def('ADM_TO_DELETE_THE_SITTER_YOU_CAN_FIND_THE_UID_IN', 'pour supprimer le remplaçant. Vous trouverez l\\\'UID dans la recherche.');
tz_def('ADM_SITTER_1', '👤 Remplaçant 1');
tz_def('ADM_SITTER_2', '👤 Remplaçant 2');
tz_def('ADM_SAVE_SITTERS', '💾 Enregistrer les remplaçants');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_GOLD_MANAGEMENT', 'Gestion de l\'or');
tz_def('ADM_GIVE_EVERYONE_FREE_GOLD', 'Offrir de l\'or à tous');
tz_def('ADM_THIS_GOLD_WILL_BE_ADDED_TO_ALL_ACTIVE_PLAYER', 'Cet or sera ajouté à TOUS les joueurs actifs du serveur.');
tz_def('ADM_GIVE_GOLD', 'Offrir de l\'or');
tz_def('ADM_GOLD_HAS_BEEN_SUCCESSFULLY_ADDED_TO_ALL_PLAY', '✓ L\'or a bien été ajouté à tous les joueurs !');
tz_def('ADM_USER_GOLD', 'Or du joueur');
...
tz_def('ADM_ACTIVATE_NOVATERRA_PLUS_FOR_ALL_PLAYERS_ON_THE', 'Activer Novaterra Plus pour TOUS les joueurs du serveur.');
tz_def('ADM_DAYS', 'Jours');
tz_def('ADM_GIVE_PLUS', 'Offrir le Plus');
tz_def('ADM_PLUS_HAS_BEEN_SUCCESSFULLY_ACTIVATED_FOR_ALL', '✓ Le Plus a bien été activé pour tous les joueurs !');
tz_def('ADM_RESOURCE_BONUS', 'Bonus de ressources');
tz_def('ADM_GIVE_EVERYONE_RESOURCE_BONUS', 'Offrir le bonus de ressources à tous');
tz_def('ADM_ACTIVATE_A_25_BONUS_FOR_ALL_RESOURCES_FOR_AL', 'Activer un bonus de 25 % sur toutes les ressources pour TOUS les joueurs.');
tz_def('ADM_DAYS_2', 'jours');
tz_def('ADM_GIVE_RESOURCE_BONUS', 'Offrir le bonus de ressources');
tz_def('ADM_RESOURCE_BONUSES_HAVE_BEEN_ACTIVATED_FOR_ALL', '✓ Les bonus de ressources ont été activés pour tous les joueurs !');
tz_def('ADM_PUNISH_PLAYER', 'Sanctionner le joueur');
tz_def('ADM_OK', 'OK');
tz_def('ADM_DELETE_TROOPS', 'Supprimer les troupes');
tz_def('ADM_EMPTY_WAREHOUSES', 'Vider les entrepôts');
tz_def('ADM_STARTED_BY', 'Lancée par :');
tz_def('ADM_UID', '(UID :');
tz_def('ADM_ENABLE_MAINTENANCE', 'Activer la maintenance');
tz_def('ADM_DISABLE_MAINTENANCE', 'Désactiver la maintenance');
tz_def('ADM_STOP', 'Arrêter');
tz_def('ADM_SERVER_RESETTING', '⚠️ Réinitialisation du serveur');
tz_def('ADM_WARNING_IRREVERSIBLE_ACTION', 'ATTENTION ! Action irréversible');
tz_def('ADM_THIS_OPERATION_WILL_DELETE_ALL_DATA_PLAYERS', 'Cette opération supprimera TOUTES les données : joueurs, villages, alliances, rapports. Le serveur reviendra à son état initial.');
tz_def('ADM_THIS_SERVER_WILL_BE_RESET_TO_CREATE_NEW_GAME', 'Ce serveur sera réinitialisé afin d\'en créer un nouveau.');
tz_def('ADM_CLICK_BUTTON', 'Cliquez sur le bouton');
tz_def('ADM_RESET', 'Réinitialiser');
tz_def('ADM_TO_PROCEED', 'pour continuer.');
tz_def('ADM_PLEASE_WAIT_WHILE_THE_SERVER_IS_BEING_RESET', 'Veuillez patienter... réinitialisation du serveur en cours');
tz_def('ADM_BACK_2', '« Retour');
tz_def('ADM_RESET_SERVER', 'Réinitialiser le serveur');
tz_def('ADM_CLEAR_BANLIST_DATA', 'Effacer – liste de bannissements');
tz_def('ADM_TRUNCATE', '(TRUNCATE)');
tz_def('ADM_CLEAN', 'Nettoyer');
tz_def('ADM_SEND_MESSAGE_TO_ALL_PLAYERS', 'Envoyer un message à tous les joueurs');
tz_def('ADM_CONFIRM', 'Confirmer :');
tz_def('ADM_ARE_YOU_SURE_YOU_WANT_TO_SEND', 'Voulez-vous vraiment envoyer ?');
tz_def('ADM_SUBJECT', 'Objet :');
tz_def('ADM_YES_SEND', '✓ Oui, envoyer');
tz_def('ADM_SENDING_MESSAGES', 'Envoi des messages...');
tz_def('ADM_SUBJECT_2', 'Objet');
tz_def('ADM_MESSAGE_COLOR', 'Couleur du message');
tz_def('ADM_MESSAGE_CONTENT', 'Contenu du message');
tz_def('ADM_CONTINUA', 'Continuer');
tz_def('ADM_MASS_MESSAGE_SUCCESSFULLY_SENT_TO_ALL_PLAYER', '✓ Message groupé envoyé à tous les joueurs !');
tz_def('ADM_EX_MAINTENANCE', 'ex. : Maintenance');
tz_def('ADM_BLACK_SAU_E67E22', 'black ou #e67e22');
tz_def('ADM_WRITE_THE_MESSAGE_YOU_CAN_USE_URL_IMG', 'Rédigez le message... vous pouvez utiliser [url][img]');
tz_def('ADM_CONFIRMARE_SYSTEM_MESSAGE', 'Confirmation du message système');
tz_def('ADM_COLOR', 'Couleur :');
tz_def('ADM_SEND_SYSTEM_MESSAGE', '✓ Envoyer le message système');
tz_def('ADM_SENDING_SYSTEM_MESSAGE', 'Envoi du message système...');
tz_def('ADM_COLOR_2', 'Couleur');
tz_def('ADM_CONTINUE', 'Continuer');
tz_def('ADM_SYSTEM_MESSAGE_SENT_SUCCESSFULLY', '✓ Message système envoyé avec succès');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_FOUNDER', '👑 Fondateur :');
tz_def('ADM_MEMBERS', '👥 Membres :');
tz_def('ADM_POINTS', '🏆 Points :');
tz_def('ADM_ALLIANCE_DETAILS', '📋 Détails de l\'alliance');
tz_def('ADM_TAG', 'Tag');
tz_def('ADM_POINTS_2', 'Points');
tz_def('ADM_CAPACITY', 'Capacité');
tz_def('ADM_ALLIANCE_POSITIONS', '🛡 Rangs de l\'alliance');
tz_def('ADM_EDIT_ALLIANCE', '✏ Modifier l\'alliance');
tz_def('ADM_DELETE_2', '🗑 Supprimer');
tz_def('ADM_ALLIANCE_DESCRIPTION', '📖 Description de l\'alliance');
tz_def('ADM_ALLIANCE_NOTICE', '📢 Annonce de l\'alliance');
tz_def('ADM_PLAYER_2', 'Joueur');
tz_def('ADM_ALLIANCE_NEWS', '📰 Actualités de l\'alliance');
tz_def('ADM_EVENT', 'Événement');
tz_def('ADM_DIPLOMACY', '🤝 Diplomatie');
tz_def('ADM_TYPE', 'Type');
tz_def('ADM_EDIT_ALLIANCE_2', '✏️ Modifier l\'alliance :');
tz_def('ADM_BASIC_SETTINGS', '⚙️ Paramètres de base');
tz_def('ADM_ALLIANCE_TAG_MAX_8', 'Tag de l\'alliance (max 8)');
tz_def('ADM_ALLIANCE_NAME', 'Nom de l\'alliance');
tz_def('ADM_LEADER_FOUNDER', '👑 Chef (fondateur)');
tz_def('ADM_SCHIMB_FONDATORUL_ALIAN_EI', 'Changer le fondateur de l\'alliance');
tz_def('ADM_MAX_MEMBERS', '👥 Membres maximum');
tz_def('ADM_ALLIANCE_NOTICE_APARE_SUS', '📢 Annonce de l\'alliance (affichée en haut)');
tz_def('ADM_ALLIANCE_DESCRIPTION_PAGINA_PUBLIC', '📖 Description de l\'alliance (page publique)');
tz_def('ADM_SAVE_ALLIANCE', '💾 Enregistrer l\'alliance');
tz_def('ADM_MESAJ_SCURT_PENTRU_MEMBRI', 'Message court pour les membres...');
tz_def('ADM_DESCRIERE_LUNG_BBCODE_PERMIS', 'Description longue, BBCode autorisé...');
tz_def('ADM_DELETE_ALLIANCE', '🗑 Supprimer l\'alliance');
tz_def('ADM_ARE_YOU_SURE_YOU_WANT_TO_PERMANENTLY_DELETE', 'Voulez-vous vraiment supprimer définitivement ? :');
tz_def('ADM_MEMBERS_2', 'Membres :');
tz_def('ADM_POINTS_3', '| Points :');
tz_def('ADM_ALL_MEMBERS_WILL_BE_REMOVED_FROM_THE_ALLIANC', '⚠ Tous les membres seront retirés de l\'alliance ; les permissions, la diplomatie, les journaux et le forum de l\'alliance seront supprimés. L\'action est irréversible !');
tz_def('ADM_YES_DELETE', 'OUI, SUPPRIMER');
tz_def('ADM_MEDAL', 'Médaille');
tz_def('ADM_THIS_ALLIANCE_HAS_NO_MEDALS_YET', 'Cette alliance n\'a pas encore de médailles');
tz_def('ADM_AVERAGE_RANK', 'Rang moyen');
tz_def('ADM_DELETE_ALL', 'Tout supprimer');
tz_def('ADM_MEDAL_INFORMATION', 'Informations sur la médaille');
tz_def('ADM_MEDALS_2', 'Médailles');
tz_def('ADM_MEDAL_WEEK_BY_WEEK', 'Médailles semaine par semaine');
tz_def('ADM_CATEGORY_2', 'CATÉGORIE');
tz_def('ADM_RANK_2', 'RANG');
tz_def('ADM_WEEK_2', 'SEMAINE');
tz_def('ADM_POINTS_4', 'POINTS');
tz_def('ADM_MEDAL_2', 'MÉDAILLE');
tz_def('ADM_THIS_PLAYER_HAS_NO_MEDALS_YET', 'Ce joueur n\'a pas encore de médailles');
tz_def('ADM_UNIFIED_ADMIN_LOG_LAST_300_ACTIONS', '📋 Journal d\'administration – 300 dernières actions');
tz_def('ADM_CATEGORIE', 'Catégorie');
tz_def('ADM_DETALII', 'Détails');
tz_def('ADM_DATA', 'Date');
tz_def('ADM_DEBUG_ERROR_LOG', '🐞 Journal des erreurs');
tz_def('ADM_CAPTURE_IS', 'La capture est');
tz_def('ADM_AUTO_OFF', 'Arrêt automatique :');
tz_def('ADM_LOG_SIZE', 'Taille du journal :');
tz_def('ADM_TRANSPARENT_TO_PLAYERS_ERRORS_ARE_ONLY_WRITT', 'Transparent pour les joueurs : les erreurs sont uniquement écrites dans le fichier journal, jamais affichées en jeu, et le jeu n\'est pas affecté.');
tz_def('ADM_CAPTURE_SETTINGS', 'Paramètres de capture');
tz_def('ADM_WARNINGS', 'Avertissements');
tz_def('ADM_NOTICES', 'Remarques');
tz_def('ADM_DEPRECATED', 'Obsolète');
tz_def('ADM_FATAL_ERRORS', 'Erreurs fatales');
tz_def('ADM_MAX_FILE_SIZE_MB', 'Taille max du fichier (Mo) :');
tz_def('ADM_AUTO_OFF_AFTER_HOURS_0_NEVER', 'Arrêt automatique après (heures, 0 = jamais) :');
tz_def('ADM_SAVE_SETTINGS', 'Enregistrer les paramètres');
tz_def('ADM_BEYOND_THE_SIZE_CAP_THE_FILE_IS_ROTATED_TO_A', 'Au-delà de la limite, le fichier est basculé vers une seule');
tz_def('ADM_BACKUP_SO_THE_TOTAL_VOLUME_STAYS_BOUNDED', 'sauvegarde, le volume total reste donc borné.');
tz_def('ADM_DOWNLOAD_FULL_LOG', '⬇ Télécharger le journal complet');
tz_def('ADM_CLEAR_LOG', '🗑 Vider le journal');
tz_def('ADM_REFRESH', '↻ Actualiser');
tz_def('ADM_BACK_TO_VILLAGE', '← Retour au village');
tz_def('ADM_RESEARCH_LOG', '— Journal de recherche');
tz_def('ADM_LATEST_200_SEARCHES', '200 dernières recherches');
tz_def('ADM_NO_REGISTERED_SEARCHES', 'Aucune recherche enregistrée.');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_CHANGE_ACCESS', 'Modifier l\'accès');
tz_def('ADM_NORMAL_USER', 'Joueur normal');
tz_def('ADM_MULTIHUNTER', 'Multihunter');
tz_def('ADM_GIVE_PLAYERS_FREE_GOLD', 'Offrir de l\'or aux joueurs');
tz_def('ADM_CHANGE_PASSWORD', 'Changer le mot de passe :');
tz_def('ADM_THE_PASSWORD_IS_CHANGED_INSTANTLY_THE_PLAYER', 'Le mot de passe est changé immédiatement. Le joueur sera déconnecté. Aucun e-mail automatique n\'est envoyé.');
tz_def('ADM_NEW_PASSWORD', 'Nouveau mot de passe');
tz_def('ADM_GENERATE_SECURE_PASSWORD', '🎲 Générer un mot de passe sûr');
tz_def('ADM_CHANGE_PASSWORD_2', '🔐 Changer le mot de passe');
tz_def('ADM_INTRODU_PAROLA_NOU', 'Saisissez le nouveau mot de passe');
tz_def('ADM_SHOW_HIDE', 'Afficher/Masquer');
tz_def('ADM_PROTECTION', 'Protection :');
tz_def('ADM_CURRENT_STATUS_2', 'État actuel');
tz_def('ADM_1_DAY_2', '+1 jour');
tz_def('ADM_3_DAYS_2', '+3 jours');
tz_def('ADM_7_DAYS_2', '+7 jours');
tz_def('ADM_SET_TO_0_TO_REMOVE_PROTECTION_PROTECTION_IS', '💡 Mettez 0 pour retirer la protection. La protection court à partir de l\'enregistrement.');
tz_def('ADM_SAVE_PROTECTION', '💾 Enregistrer la protection');
tz_def('ADM_PLUS_BONUSES', '⭐ Plus et bonus :');
tz_def('ADM_THE_VALUES_ADD_UP_PUT_5_TO_ADD_5_DAYS_5_TO_R', 'ℹ️ Les valeurs s\'additionnent. Mettez 5 pour ajouter 5 jours, -5 pour en retirer 5.');
tz_def('ADM_CURRENT_ACTIVE_BONUSES', '📊 Bonus actuellement actifs');
tz_def('ADM_ADD_REMOVE_DAYS', '➕ Ajouter / retirer des jours');
tz_def('ADM_APPLY_BONUSES', '💾 Appliquer les bonus');
tz_def('ADM_WEEKLY_STATS', 'Statistiques hebdomadaires :');
tz_def('ADM_ACESTEA_SUNT_PUNCTELE', '📊 Voici les points');
tz_def('ADM_DIN_S_PT_M_NA_CURENT', 'de la semaine en cours');
tz_def('ADM_PENTRU_TOP_10_SE_RESETEAZ_AUTOMAT', 'pour le top 10. Réinitialisation automatique.');
tz_def('ADM_ATTACK', 'Attaque');
tz_def('ADM_RAID', 'Pillage');
tz_def('ADM_SAVE_WEEK', '💾 Enregistrer la semaine');
tz_def('ADM_OVERALL_POINTS', 'Points totaux :');
tz_def('ADM_ACESTEA_SUNT_PUNCTELE_2', '🛡️ Voici les points');
tz_def('ADM_TOTALE', 'totaux');
tz_def('ADM_DIN_STATISTICI_NU_CELE_S_PT_M_NALE_SE_ADUN_D', 'des statistiques (pas les hebdomadaires). Ils cumulent toutes les attaques.');
tz_def('ADM_ATTACK_POINTS', 'Points d\'attaque');
tz_def('ADM_DEFENCE_POINTS', 'Points de défense');
tz_def('ADM_SAVE_POINTS', '💾 Enregistrer les points');
tz_def('ADM_EDIT_ADDITIONAL', '⚙️ Informations supplémentaires :');
tz_def('ADM_ACCOUNT_CONTROL', '🔐 Contrôle du compte');
tz_def('ADM_ACCESS_LEVEL', 'Niveau d\'accès');
tz_def('ADM_0_BANNED', '0 - Banni');
tz_def('ADM_2_NORMAL_USER', '2 - Joueur normal');
tz_def('ADM_8_MULTIHUNTER', '8 - Multihunter');
tz_def('ADM_9_ADMIN', '9 - Administrateur');
tz_def('ADM_VACATION_MODE_2', '🏖 Mode vacances');
tz_def('ADM_0_DISABLED', '0 - Désactivé');
tz_def('ADM_1_ENABLED', '1 - Activé');
tz_def('ADM_PROTECTION_2', '🛡️ Protection');
tz_def('ADM_ZILE', 'jours');
tz_def('ADM_SITTERS', '👥 Remplaçants');
tz_def('ADM_SITTER_1_UID', 'Remplaçant 1 (UID)');
tz_def('ADM_SITTER_2_UID', 'Remplaçant 2 (UID)');
tz_def('ADM_STATISTICS_POINTS', '📊 Statistiques et points');
tz_def('ADM_CULTURE_POINTS', '🏛️ Points de culture');
tz_def('ADM_ATTACK_POINTS_2', '⚔️ Points d\'attaque');
tz_def('ADM_DEFENCE_POINTS_2', '🛡️ Points de défense');
tz_def('ADM_RESOURCES_RAIDED', '💎 Ressources pillées');
tz_def('ADM_TOTAL_ATTACK', '⚔️ Attaque totale');
tz_def('ADM_TOTAL_DEFENCE', '🛡️ Défense totale');
tz_def('ADM_GOLD_2', 'or');
tz_def('ADM_UID_2', 'UID');
tz_def('ADM_PLAYER_3', 'JOUEUR');
tz_def('ADM_VILLAGES_2', 'VILLAGES');
tz_def('ADM_POP_2', 'POP.');
tz_def('ADM_AID', 'AID');
tz_def('ADM_NAME_2', 'NOM');
tz_def('ADM_TAG_2', 'TAG');
tz_def('ADM_FOUNDER_2', 'FONDATEUR');
tz_def('ADM_VILLAGE_NAME', 'NOM DU VILLAGE');
tz_def('ADM_OWNER_2', 'PROPRIÉTAIRE');

//////////////////////////////////////////////////////////////////////////////////////////////////////
// PANOU DE ADMINISTRARE - sabloane (lot 7: natars, map, map_tile, artifact,
// goldShop, questEditor, multiacc, pushprot, blockReg, heatmap)
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_WW_VILLAGES', '🏰 Villages MdM');
tz_def('ADM_NUMBER', 'Numéro');
tz_def('ADM_PLAYER_ID', 'ID du joueur');
tz_def('ADM_ADD_ARTIFACTS', '✨ Ajouter des artefacts');
tz_def('ADM_ICON', 'Icône');
tz_def('ADM_DELETED_ARTIFACTS', '🗑️ Artefacts supprimés');
tz_def('ADM_EFFECT', 'Effet');
tz_def('ADM_OLD_OWNER', 'Ancien propriétaire');
tz_def('ADM_OLD_VILLAGE', 'Ancien village');
tz_def('ADM_ARTIFACTS_OVERVIEW', '📊 Vue des artefacts');
tz_def('ADM_RESTORE', 'Restaurer');
tz_def('ADM_INTERACTIVE_WORLD_MAP_SEARCH_PLAYERS_VILLAGE', 'Carte du monde interactive – recherchez joueurs, villages et artefacts');
tz_def('ADM_PLAYERS', 'Joueurs');
tz_def('ADM_ARTIFACTS', 'Artefacts');
tz_def('ADM_APPLY_FILTERS', 'Appliquer les filtres');
tz_def('ADM_TRIBES', 'Tribus');
tz_def('ADM_MULTIHUNTERS', 'Multihunters');
tz_def('ADM_CHECK_EDIT_MAP_TILE', 'Vérifier et modifier une case');
tz_def('ADM_CHECK_TILE', 'Vérifier la case');
tz_def('ADM_AREA_OF_EFFECT', 'Zone d\'effet');
tz_def('ADM_TIME_OF_CONQUER', 'Heure de conquête');
tz_def('ADM_TIME_OF_ACTIVATION', 'Heure d\'activation');
tz_def('ADM_RETURN_TO_NATARS', 'Rendre aux Tatars');
tz_def('ADM_SHOP_PROMO_CODES', 'Boutique et codes promo');
tz_def('ADM_DIRECTLY', 'directement.');
tz_def('ADM_CREATE_A_CODE', 'Créer un code');
tz_def('ADM_CODE', 'Code');
tz_def('ADM_MAX_USES_0', 'Utilisations max (0 = &infin;)');
tz_def('ADM_EXPIRES_IN_DAYS_0_NEVER', 'Expire dans (jours, 0 = jamais)');
tz_def('ADM_ONCE_PER_PLAYER', 'une fois par joueur');
tz_def('ADM_NOTE_OPTIONAL', 'Note (facultatif)');
tz_def('ADM_CREATE', 'Créer');
tz_def('ADM_CODES_ARE_CASE_INSENSITIVE_ALLOWED_CHARACTER', 'Les codes ne tiennent pas compte de la casse ; caractères autorisés : A-Z 0-9 . _ &ndash;');
tz_def('ADM_NO_PROMO_CODES_YET', 'Aucun code promo pour le moment.');
tz_def('ADM_USES', 'Utilisations');
tz_def('ADM_SCOPE', 'Portée');
tz_def('ADM_NOTE', 'Note');
tz_def('ADM_RECENT_REDEMPTIONS', 'Utilisations récentes');
tz_def('ADM_NO_REDEMPTIONS_YET', 'Aucune utilisation pour le moment.');
tz_def('ADM_WHEN', 'Quand');
tz_def('ADM_REASON_CAMPAIGN', 'motif / campagne');
tz_def('ADM_QUEST_2', 'Quête');
tz_def('ADM_EDITOR', 'Éditeur');
tz_def('ADM_QTYP_37', 'qtyp&nbsp;37');
tz_def('ADM_GET', 'reçoivent');
tz_def('ADM_EXTENDED', 'étendue');
tz_def('ADM_EVERYONE_ELSE', ', tous les autres');
tz_def('ADM_STANDARD', 'standard');
tz_def('ADM_REWARD_VALUES_ARE_LIVE_VIA', 'Les valeurs de récompense sont appliquées via');
tz_def('ADM_FIXED', 'fixe');
tz_def('ADM_STANDARD_QUEST_CORE25', 'Standard (quest_core25)');
tz_def('ADM_EXTENDED_QUEST_CORE', 'Étendue (quest_core)');
tz_def('ADM_ON', 'Actif');
tz_def('ADM_PLUS_DAYS', 'Plus (jours)');
tz_def('ADM_REQ_LEVEL', 'Niveau&nbsp;requis');
tz_def('ADM_QUEST_HOVER', 'Quête (survol)');
tz_def('ADM_SAVE_ALL_CHANGES', 'Enregistrer toutes les modifications');
tz_def('ADM_SAVES_EVERY_ROW_FOR_THE', 'Enregistre chaque ligne pour la variante');
tz_def('ADM_VARIANT', 'variante.');
tz_def('ADM_RESET_THIS_VARIANT_TO_DEFAULTS', 'Réinitialiser cette variante aux valeurs par défaut');
tz_def('ADM_MULTI_ACCOUNT', 'Multi-comptes');
tz_def('ADM_DETECTION', 'Détection');
tz_def('ADM_RISK_SCORE_NOT_PROOF', 'score de risque, pas une preuve');
tz_def('ADM_WINDOW_DAYS', 'Fenêtre (jours)');
tz_def('ADM_MIN_SCORE', 'Score min.');
tz_def('ADM_FOCUS_ON_UID_OPTIONAL', 'Cibler un UID (facultatif)');
tz_def('ADM_ANALYSE', 'Analyser');
tz_def('ADM_MAD_ON', 'ACTIVE');
tz_def('ADM_MAD_OFF', 'DESACTIVE');
tz_def('ADM_MAD_AUTO_BAN', 'Bannissement Automatique');
tz_def('ADM_MAD_ENABLE_DETECTION', 'Detection Multi-Compte');
tz_def('ADM_MAD_ENABLE_AUTO_BAN', 'Bannissement Automatique');
tz_def('ADM_MAD_AUTO_BAN_THRESHOLD', 'Seuil de score pour le bannissement automatique');
tz_def('ADM_MAD_AUTO_BAN_HINT', 'Lorsque les deux sont actives, toute paire atteignant le seuil est bannie automatiquement des le chargement de cette page ou l\'enregistrement de ces parametres.');
tz_def('ADM_MAD_AUTO_BAN_JUST_RAN', 'Le bannissement automatique vient de s\'executer');
tz_def('ADM_MAD_FULL_ADMIN_ONLY', 'Seul un administrateur complet peut modifier ces parametres.');
tz_def('ADM_MAD_DETECTION_DISABLED_NOTICE', 'La Detection Multi-Compte est actuellement desactivee. Activez-la ci-dessus pour rechercher des paires de comptes suspectes.');
tz_def('ADM_MAD_VIEW_PAIR', 'Voir');
tz_def('ADM_MAD_PLAYER_DASHBOARD', 'Administration Multi-Compte');
tz_def('ADM_MAD_BACK_TO_OVERVIEW', 'Retour a la Detection Multi-Compte');
tz_def('ADM_MAD_BANNED', 'Banni');
tz_def('ADM_MAD_ACTIVE', 'Actif');
tz_def('ADM_MAD_RELATED_PROTECTION_OFF_NOTICE', "La Protection des Comptes Lies est actuellement desactivee — le pillage entre comptes lies n'est pas bloque.");
tz_def('ADM_MAD_ACCOUNT_ACTIONS', 'Actions');
tz_def('ADM_MAD_BAN_ACCOUNT', 'Bannir le Compte');
tz_def('ADM_MAD_UNBAN_ACCOUNT', 'Debannir le Compte');
tz_def('ADM_MAD_BAN_REASON', 'Motif');
tz_def('ADM_MAD_RELATE_TO_UID', 'UID du compte lie');
tz_def('ADM_MAD_REASON_OPTIONAL', 'Motif (optionnel)');
tz_def('ADM_MAD_MARK_AS_RELATED', 'Marquer comme Lie');
tz_def('ADM_MAD_SUSPECTED_PAIRS', 'Paires Suspectes Detectees');
tz_def('ADM_MAD_NO_SUSPECTED_PAIRS', 'Aucune paire suspecte detectee pour ce compte.');
tz_def('ADM_MAD_OTHER_ACCOUNT', 'Compte');
tz_def('ADM_MAD_RELATED_ACCOUNTS', 'Comptes Lies Manuellement');
tz_def('ADM_MAD_NO_RELATED_ACCOUNTS', 'Aucun compte lie manuellement a celui-ci.');
tz_def('ADM_MAD_REASON', 'Motif');
tz_def('ADM_MAD_ADDED', 'Ajoute');
tz_def('ADM_MAD_REMOVE', 'Retirer');
tz_def('ADM_MAD_IPS_AND_DEVICES', 'IPs et Appareils');
tz_def('ADM_MAD_NO_FINGERPRINTS', 'Aucune empreinte IP/appareil enregistree pour le moment.');
tz_def('ADM_MAD_HITS', 'Occurrences');
tz_def('ADM_MAD_LAST_SEEN', 'Vu pour la derniere fois');
tz_def('ADM_MAD_BLOCKED_ATTEMPTS', 'Tentatives de Pillage/Transfert Bloquees');
tz_def('ADM_MAD_NO_BLOCKED_ATTEMPTS', 'Aucune tentative bloquee enregistree pour ce compte.');
tz_def('ADM_MAD_FROM', 'De');
tz_def('ADM_MAD_TO', 'Vers');
tz_def('ADM_MAD_RESOURCES', 'Ressources');
tz_def('ADM_MAD_WHEN', 'Quand');
tz_def('ADM_MAD_RECENT_LOGINS', 'Connexions Recentes');
tz_def('ADM_MAD_NO_LOGIN_RECORDS', 'Aucun enregistrement de connexion trouve.');
tz_def('ADM_MAD_BAN_HISTORY', 'Historique des Bannissements');
tz_def('ADM_MAD_NO_BAN_HISTORY', 'Aucun historique de bannissement pour ce compte.');
tz_def('ADM_MAD_STATUS', 'Statut');
tz_def('ADM_MAD_LIFTED', 'Leve');
tz_def('ADM_NO_ACCOUNT_PAIRS_AT_OR_ABOVE_THE_CURRENT_SCO', 'Aucune paire de comptes au niveau ou au-dessus du seuil actuel.');
tz_def('ADM_RISK', 'Risque');
tz_def('ADM_ACCOUNT_A', 'Compte A');
tz_def('ADM_ACCOUNT_B', 'Compte B');
tz_def('ADM_WHY', 'Pourquoi');
tz_def('ADM_LOGIN_LOG', 'journal de connexion');
tz_def('ADM_FOCUS', 'cibler');
tz_def('ADM_RESET_2', 'réinitialiser');
tz_def('ADM_DASHBOARD', 'Tableau de bord');
tz_def('ADM_PER_PLAYER', 'Par joueur');
tz_def('ADM_7_DAY_RESOURCE_BALANCE', 'Bilan des ressources sur 7 jours');
tz_def('ADM_HOURS_OF_PROD_ALLOWED', 'Heures de prod. autorisées');
tz_def('ADM_SHOW_2', 'Afficher');
tz_def('ADM_ALL_WITH_ACTIVITY', 'Tous avec activité');
tz_def('ADM_OVER_LIMIT_ONLY', 'Au-dessus de la limite uniquement');
tz_def('ADM_WW_ARTEFACT_OVERRIDDEN', 'MdM / artefact / dérogation');
tz_def('ADM_REFRESH_2', 'Actualiser');
tz_def('ADM_NO_INTER_PLAYER_TRANSFERS_RECORDED_IN_THIS_W', 'Aucun transfert entre joueurs enregistré dans cette fenêtre.');
tz_def('ADM_VILLAGES_POP', 'Villages / Pop.');
tz_def('ADM_PROD_H', 'Prod./h');
tz_def('ADM_RECEIVED_7D', 'Reçu (7 j)');
tz_def('ADM_LIMIT', 'Limite');
tz_def('ADM_USAGE', 'Utilisation');
tz_def('ADM_OVERRIDE', 'Dérogation');
tz_def('ADM_AUTO', 'Auto');
tz_def('ADM_CUSTOM_CAP', 'Plafond personnalisé');
tz_def('ADM_SAVE_3', 'Enregistrer');
tz_def('ADM_REGISTRATION', 'Inscription');
tz_def('ADM_BLOCKLIST', 'Liste de blocage');
tz_def('ADM_BLOCK_NEW_REGISTRATIONS_BY_A_SPECIFIC', 'Bloquer les nouvelles inscriptions par');
tz_def('ADM_USERNAME_3', 'nom d\'utilisateur');
tz_def('ADM_A_SPECIFIC', ', une');
tz_def('ADM_OR_A_WHOLE', ', ou tout un');
tz_def('ADM_E_MAIL_DOMAIN', 'domaine e-mail');
tz_def('ADM_ADD_A_BLOCK', 'Ajouter un blocage');
tz_def('ADM_E_MAIL_ADDRESS', 'Adresse e-mail');
tz_def('ADM_E_MAIL_DOMAIN_2', 'Domaine e-mail');
tz_def('ADM_VALUE', 'Valeur');
tz_def('ADM_ADD_BLOCK', 'Ajouter le blocage');
tz_def('ADM_DOMAIN_ENTER_JUST_THE_DOMAIN', 'Domaine : saisissez uniquement le domaine (');
tz_def('ADM_NO_REGISTRATION_BLOCKS_YET', 'Aucun blocage d\'inscription pour le moment.');
tz_def('ADM_ADDED', 'Ajouté');
tz_def('ADM_REASON_2', 'motif');
tz_def('ADM_REMOVE_2', 'retirer');
tz_def('ADM_WORLD_MAP', 'Carte du monde');
tz_def('ADM_HEATMAP', 'Carte de chaleur');
tz_def('ADM_GRID_RESOLUTION', 'Résolution de la grille');
tz_def('ADM_INACTIVE_AFTER_DAYS', 'Inactif après (jours)');
tz_def('ADM_REBUILD', 'Reconstruire');
tz_def('ADM_VILLAGE_DENSITY', 'Densité des villages');
tz_def('ADM_TRIBE_DENSITY', 'Densité des tribus');
tz_def('ADM_INACTIVITY', 'Inactivité');
tz_def('ADM_ATTACKS', 'Attaques');
tz_def('ADM_SUMMARY', 'Résumé');
tz_def('ADM_PLAYER_VILLAGES', 'Villages des joueurs');
tz_def('ADM_INACTIVE_VILLAGES', 'Villages inactifs');
tz_def('ADM_ATTACKS_IN_FLIGHT', 'Attaques en cours');
tz_def('ADM_LEGEND', 'Légende');
tz_def('ADM_TRIBE_TOTALS', 'Totaux par tribu');
tz_def('ADM_NO_PLAYER_VILLAGES_FOUND', 'Aucun village de joueur trouvé.');

//////////////////////////////////////////////////////////////////////////////////////////////////////
// PANOU DE ADMINISTRARE - sabloane (lot 8, final: restul de 26 de sabloane)
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_404_FILE_NOT_FOUND', '404 - Fichier introuvable');
tz_def('ADM_WE_LOOKED_404_TIMES_ALREADY_BUT_CAN_T_FIND_A', 'Nous avons cherché 404 fois sans rien trouver, pas même une croix marquant l\'endroit.');
tz_def('ADM_THIS_SYSTEM_IS_NOT_COMPLETE_YET_SO_THE_PAGE', 'Ce système n\'est pas encore terminé. La page n\'existe donc probablement pas.');
tz_def('ADM_NOT_FOUND', 'Introuvable');
tz_def('ADM_NEW_MESSAGE', 'Nouveau message');
tz_def('ADM_TO', 'à');
tz_def('ADM_RECIPIENT', 'Destinataire');
tz_def('ADM_SEND_MESSAGE', 'Envoyer le message');
tz_def('ADM_PLAYER_NOT_FOUND', 'Joueur introuvable.');
tz_def('ADM_GO_BACK', 'Retour');
tz_def('ADM_MESSAGE_FROM_ADMIN', 'Message de l\'administrateur');
tz_def('ADM_WRITE_YOUR_MESSAGE_HERE', 'Rédigez votre message ici...');
tz_def('ADM_TROOP', 'Troupe');
tz_def('ADM_ARMOURY', 'Armurerie');
tz_def('ADM_BLACKSMITH', 'Forge');
tz_def('ADM_BACK_3', 'Retour');
tz_def('ADM_NOW', 'Actuel :');
tz_def('ADM_CREATE_USERS', '👤 Créer des joueurs');
tz_def('ADM_SUBMITTING_THIS_FORM_WILL_CREATE_NEW_USERS_A', 'L\'envoi de ce formulaire créera de nouveaux joueurs et/ou villages sur votre serveur !');
tz_def('ADM_MANY_ACCOUNTS_1_VILLAGE', 'Plusieurs comptes (1 village)');
tz_def('ADM_1_ACCOUNT_MANY_VILLAGES', '1 compte (plusieurs villages)');
tz_def('ADM_BASE_NAME', 'Nom de base');
tz_def('ADM_4_20_CHARACTERS_EX_FARM_5_FARM1_FARM5_SINGLE', '4 à 20 caractères. Ex. : Farm | 5 → Farm1..Farm5. Compte unique : FarmLord | 5 villages.');
tz_def('ADM_WARNING_2', 'Attention :');
tz_def('ADM_LARGE_VALUES_MAY_FREEZE_THE_SERVER', 'des valeurs élevées peuvent bloquer le serveur !');
tz_def('ADM_HOW_MANY_ACCOUNTS', 'Combien de comptes');
tz_def('ADM_HOW_MANY_VILLAGES', 'Combien de villages');
tz_def('ADM_1_200_SINGLE_ONLY', '1 - 200 (compte unique)');
tz_def('ADM_ENABLE_BEGINNER_PROTECTION', 'Activer la protection des débutants');
tz_def('ADM_CREATE_2', '+ Créer');
tz_def('ADM_ADD_VILLAGE', 'Ajouter un village');
tz_def('ADM_COORDINATES_X_Y', 'Coordonnées (X|Y)');
tz_def('ADM_ADD_VILLAGE_2', 'AJOUTER LE VILLAGE');
tz_def('ADM_TO_ENSURE_THAT_YOU_WON_T_GET_BANNED_AGAIN_IN', 'Pour éviter d\'être banni à nouveau, lisez attentivement le règlement');
tz_def('ADM_GAME_RULES', '» Règles du jeu');
tz_def('ADM_TO_CONTINUE_PLAYING_CONTACT_THE_MULTIHUNTER', 'Pour continuer à jouer, contactez le Multihunter et clarifiez la situation avec lui');
tz_def('ADM_WRITE_MESSAGE', '» Écrire un message');
tz_def('ADM_HEED_THE_FOLLOWING_ADVICE_WHEN_WRITING_YOUR', 'Tenez compte des conseils suivants en rédigeant votre message :');
tz_def('ADM_THERE_IS_ALWAYS_A_REASON_FOR_A_BAN', '● Il y a toujours une raison à un bannissement.');
tz_def('ADM_TRY_TO_THINK_ABOUT_POSSIBLE_REASONS_FOR_THIS', 'Réfléchissez aux raisons possibles de ce bannissement');
tz_def('ADM_AND_PUT_THINGS_STRAIGHT_WITH_THE_MULTIHUNTER', 'et clarifiez la situation avec le Multihunter.');
tz_def('ADM_MULTIHUNTERS_CAN_REVIEW_ENORMOUS_AMOUNTS_OF', '● Les Multihunters peuvent consulter énormément d\'informations sur les comptes.');
tz_def('ADM_STICK_TO_THE_TRUTH', 'Restez fidèle à la vérité');
tz_def('ADM_AND_DO_NOT_MAKE_EXCUSES_TO_JUSTIFY_YOUR_VIOL', 'et ne cherchez pas d\'excuses pour justifier votre infraction.');
tz_def('ADM_BE_COOPERATIVE_AND_INSIGHTFUL_THIS_MIGHT_RED', '● Soyez coopératif et lucide, cela peut réduire la sanction.');
tz_def('ADM_CALM_AND_POLITE', 'calme et poli');
tz_def('ADM_WHILE_TALKING_TO_THE_MULTIHUNTER_AND_TELLING', 'en parlant au Multihunter et en lui exposant votre point de vue.');
tz_def('ADM_INCLUDES_RESOURCES_MAIN_BUILDING_RALLY_POINT', 'Comprend les ressources, le bâtiment principal, le point de ralliement, l\'entrepôt, le silo, la muraille, la place du marché, la résidence, des troupes (pour monter le héros) et une cachette.');
tz_def('ADM_IF_THE_MULTIHUNTER_DOES_NOT_ANSWER_IMMEDIATE', '● Si le Multihunter ne répond pas immédiatement, c\'est qu\'il n\'est probablement pas connecté. Envoyer plusieurs messages n\'accélérera pas la résolution, surtout s\'il n\'a pas encore lu le premier.');
tz_def('ADM_IF_YOU_HAVE_REALLY_BEEN_BANNED_UNJUSTLY_TRY', '● Si vous avez vraiment été banni injustement, essayez de rester');
tz_def('ADM_RESOURCE', 'Ressource');
tz_def('ADM_AMOUNT', 'Quantité');
tz_def('ADM_MAXIMUM_CAPACITY', 'Capacité maximale');
tz_def('ADM_BACK_TO_VILLAGE_2', '← Retour au village');
tz_def('ADM_ADMIN_CONTROL', 'Administration');
tz_def('ADM_SERVER_ADMINISTRATION', 'Administration du serveur');
tz_def('ADM_SECURE_ACCESS_TO_NOVATERRA_PANEL', 'Accès sécurisé au panneau Novaterra');
tz_def('ADM_PASSWORD', 'Mot de passe');
tz_def('ADM_ACCESS_PANEL', 'Accéder au panneau');
tz_def('ADM_ENTER_ADMIN_USERNAME', 'Saisissez le nom d\'administrateur');
tz_def('ADM_ROMANS', 'Romains');
tz_def('ADM_TEUTONS', 'Teutons');
tz_def('ADM_GAULS', 'Gaulois');
tz_def('ADM_RESET_GOLD_FOR_ALL_PLAYERS', 'Réinitialiser l\'or de tous les joueurs');
tz_def('ADM_RESET_ALL_PLAYERS_GOLD', 'Réinitialiser l\'or de tous les joueurs');
tz_def('ADM_THIS_ACTION_WILL_SET_THE_GOLD_TO', 'Cette action mettra l\'or à');
tz_def('ADM_FOR_ALL_PLAYERS_FROM_THE_SERVER', 'pour TOUS les joueurs du serveur.');
tz_def('ADM_WARNING_THE_ACTION_IS_IRREVERSIBLE_MAKE_SURE', '⚠️ ATTENTION : l\'action est irréversible ! Assurez-vous d\'avoir une sauvegarde.');
tz_def('ADM_RESET_GOLD_NOW', 'RÉINITIALISER L\'OR MAINTENANT');
tz_def('ADM_ALL_PLAYERS_GOLD_HAS_BEEN_RESET', '✓ L\'or de tous les joueurs a été réinitialisé !');
tz_def('ADM_RESET_ALL_PLAYERS_PLUS', 'Réinitialiser le Plus de tous les joueurs');
tz_def('ADM_THIS_ACTION_WILL_DISABLE_NOVATERRA_PLUS_FOR_AL', 'Cette action désactivera Novaterra Plus pour TOUS les joueurs.');
tz_def('ADM_PLUS_IT_WILL_BE_SET_TO_0_DAYS_FOR_EVERYONE', '⚠️ Le Plus sera mis à 0 jour pour tout le monde.');
tz_def('ADM_RESET_PLUS_NOW', 'RÉINITIALISER LE PLUS MAINTENANT');
tz_def('ADM_PLUS_ALL_THE_PLAYERS_HAVE_BEEN_RESET', '✓ Le Plus de tous les joueurs a été réinitialisé !');
tz_def('ADM_RESET_ALL_RESOURCE_BONUSES', 'Réinitialiser tous les bonus de ressources');
tz_def('ADM_THIS_ACTION_WILL_DISABLE_THE_25_BONUS_FOR_AL', 'Cette action désactivera le bonus de 25 % sur TOUTES les ressources chez tous les joueurs.');
tz_def('ADM_ALL_RESOURCE_BONUSES_WILL_BE_SET_TO_0_DAYS', '⚠️ Tous les bonus de ressources seront mis à 0 jour.');
tz_def('ADM_RESET_RESOURCE_BONUS', 'RÉINITIALISER LE BONUS DE RESSOURCES');
tz_def('ADM_RESOURCE_BONUSES_HAVE_BEEN_RESET_FOR_ALL_PLA', '✓ Les bonus de ressources ont été réinitialisés pour tous les joueurs !');
tz_def('ADM_IGM_REPORTS_LOOKUP', 'Recherche de messages / rapports');
tz_def('ADM_IGM_BY_ID', 'Message par ID');
tz_def('ADM_GO', 'Aller');
tz_def('ADM_REPORT_BY_ID', 'Rapport par ID');
tz_def('ADM_ENTER_MESSAGE_ID', 'Saisissez l\'ID du message...');
tz_def('ADM_ENTER_REPORT_ID', 'Saisissez l\'ID du rapport...');
tz_def('ADM_SITTER_1_2', 'Remplaçant 1');
tz_def('ADM_SITTER_2_2', 'Remplaçant 2');
tz_def('ADM_CULTURE_POINTS_2', 'Points de culture');
tz_def('ADM_ATTACK_POINTS_THIS_WEEK', 'Points d\'attaque (cette semaine)');
tz_def('ADM_DEFENCE_POINTS_THIS_WEEK', 'Points de défense (cette semaine)');
tz_def('ADM_RESOURCES_RAIDED_THIS_WEEK', 'Ressources pillées (cette semaine)');
tz_def('ADM_TOTAL_ATTACK_POINTS', 'Points d\'attaque totaux');
tz_def('ADM_TOTAL_DEFENCE_POINTS', 'Points de défense totaux');
tz_def('ADM_EDIT_PLAYER_ADDITIONAL_INFO', 'Modifier les infos supplémentaires du joueur');
tz_def('ADM_THE_ACCOUNT_WILL_BE_DELETED_IN', 'Le compte sera supprimé dans');
tz_def('ADM_CANCEL_3', '✖ Annuler');
tz_def('ADM_CANCEL_DELETION', 'Annuler la suppression');
tz_def('ADM_DESCRIPTION', 'Description');
tz_def('ADM_AGE', 'Âge');
tz_def('ADM_GENDER', 'Sexe');
tz_def('ADM_LOCATION_2', 'Lieu');
tz_def('ADM_LAST_IP', 'Dernière IP');
tz_def('ADM_LANGUAGE', 'Langue');
tz_def('ADM_BAN_USER_2', '&raquo; Bannir le joueur');
tz_def('ADM_SEND_MESSAGE_2', '&raquo; Envoyer un message');
tz_def('ADM_EDIT_PLUS_RES_BONUS', '&raquo; Modifier Plus et bonus de res.');
tz_def('ADM_EDIT_SITTERS_2', '&raquo; Modifier les remplaçants');
tz_def('ADM_EDIT_PROTECTION', '&raquo; Modifier la protection');
tz_def('ADM_EDIT_PASSWORD', '&raquo; Modifier le mot de passe');
tz_def('ADM_EDIT_OVERALL_OFF_DEF', '&raquo; Modifier attaque et défense totales');
tz_def('ADM_EDIT_WEEKLY_OFF_DEF_RAID', '&raquo; Modifier attaque, défense, pillage hebdo');
tz_def('ADM_USER_LOGIN_LOG', '&raquo; Journal de connexion');
tz_def('ADM_USER_ILLEGAL_LOG', '&raquo; Journal des infractions');
tz_def('ADM_RECOUNT_POPULATION', 'Recompter la population');
tz_def('ADM_EMAIL_2', 'E-MAIL');
tz_def('ADM_IP', 'IP');
tz_def('ADM_TRIBE_3', 'Tribu :');
tz_def('ADM_VILLAGES_3', 'Villages :');
tz_def('ADM_POP_3', 'Pop. :');
tz_def('ADM_COORDS_2', 'Coordonnées :');
tz_def('ADM_ILLEGALS_LOG', '🚨 Journal des infractions :');
tz_def('ADM_DETECTED_OFFENCES', 'Infractions détectées');
tz_def('ADM_BACK_TO_PLAYER', '← Retour au joueur');
tz_def('ADM_LOGIN_LOG_2', '🔐 Journal de connexion :');
tz_def('ADM_RECENT_LOGIN_ATTEMPTS', 'Tentatives de connexion récentes');
tz_def('ADM_LOG_ID', 'ID du journal');
tz_def('ADM_IP_ADDRESS', 'Adresse IP');
tz_def('ADM_INFO', 'Info');
tz_def('ADM_BUILD_LOG', '— Journal de construction');
tz_def('ADM_LATEST_200_ACTION', '200 dernières actions');
tz_def('ADM_NO_ACTION_RECORDED_YET', 'Aucune action enregistrée.');
tz_def('ADM_POPULATION_2', 'POPULATION');
tz_def('ADM_COORDINATES', 'COORDONNÉES');
tz_def('ADM_TROOPS_2', 'TROUPES');

//////////////////////////////////////////////////////////////////////////////////////////////////////
// PANOU DE ADMINISTRARE - texte lungi si pe mai multe randuri (curatare finala)
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('ADM_E_MAIL_ADDRESS_2', 'adresse e-mail');
tz_def('ADM_E_G_AN_OBSCENE_USERNAME_OR_THE_ENTIRE', '(p. ex. un nom obscène, ou tout le');
tz_def('ADM_DOMAIN_MATCHING_IS_EXACT_AND_CASE_INSENSITIV', 'domaine). La correspondance est exacte et insensible à la casse. Les comptes existants ne sont pas touchés &mdash; seules les nouvelles inscriptions le sont.');
tz_def('ADM_WITH_OR_WITHOUT_THE_LEADING_E_MAIL_THE_FULL', '), avec ou sans le &ldquo;@&rdquo; initial. E-mail : l\'adresse complète. Nom d\'utilisateur : le nom exact.');
tz_def('ADM_SILVER_2', 'argent &nbsp;|&nbsp;');
tz_def('ADM_OF_EACH', 'de chaque &nbsp;|&nbsp;');
tz_def('ADM_HOURLY_RESOURCES_PRODUCED_BY_EACH_POINT_THE', 'Ressources horaires produites par chaque point investi dans l\'attribut Ressources du héros, dans le village où il se trouve. Les joueurs choisissent librement entre répartir sur les quatre ressources ou concentrer sur une seule.');
tz_def('ADM_HOURLY_RESOURCES_PER_POINT_INVESTED_IN_THE_H', 'Ressources horaires par point investi dans l\'attribut Ressources du héros. La première valeur s\'applique quand le bonus est réparti sur les quatre ressources, la seconde quand il est concentré sur une seule. Les deux évoluent avec la vitesse du serveur.');
tz_def('ADM_HIT_POINTS_THE_HERO_RECOVERS_PER_DAY_ON_TOP', 'Points de vie récupérés par le héros chaque jour, en plus des points investis dans l\'attribut de régénération et des objets équipés. Sans cela, un héros sans point de régénération ne guérirait jamais et finirait par mourir en aventure. Évolue avec la vitesse du serveur. 0 désactive.');
tz_def('ADM_HOW_LONG_ONE_CRON_PHP_INVOCATION_KEEPS_WORKI', 'Durée pendant laquelle une invocation de cron.php continue de travailler. La plupart des hébergements mutualisés n\'autorisent un cron que toutes les 5 minutes, alors qu\'Automation attend un passage par minute &mdash; une invocation enchaîne donc plusieurs passages. Utilisez 300 pour un cron "*/5". Mettez 0 uniquement si votre hébergeur autorise un cron par minute.');
tz_def('ADM_ENABLE_DISABLE_IF_A_PLAYER_LEAVES_AT_LEAST_O', 'Activer (désactiver) : si un joueur laisse au moins un message dans un sujet du forum, il recevra des messages en jeu l\'informant de nouvelles réponses dans ce même sujet (il y est donc techniquement « abonné »)');
tz_def('ADM_ENABLE_DISABLE_THE_SERVER_MILESTONES_WIDGET', 'Activer (désactiver) le widget « Étapes du serveur » (premier joueur à fonder un 2e village, atteindre 1000 de population, capturer un artefact, conquérir une MdM, conquérir un plan de MdM, fonder une alliance ou conquérir le village d\'un autre joueur), affiché en haut de Statistiques &raquo; Général');
tz_def('ADM_CREATE_PROMO_VOUCHER_CODES_PLAYERS_REDEEM_FO', 'Créez des codes promo que les joueurs échangent contre de l\'or sur la page Plus. Définissez un montant d\'or fixe, une limite d\'utilisations facultative, si chaque joueur peut l\'utiliser une seule fois, et une expiration facultative. Pour une récompense unique de chasseur de bugs, créez un code avec 1 utilisation max &mdash; ou utilisez');
tz_def('ADM_DENSITY_OVERLAYS_ON_THE_WORLD_GRID_TO_HELP_W', 'Superpositions de densité sur la grille du monde pour aider à l\'équilibre de départ : où les villages se regroupent, quelles tribus dominent une région, où se trouvent les joueurs inactifs (zones mortes / bons emplacements de départ) et où les attaques arrivent actuellement. Le nord (+y) est en haut.');
tz_def('ADM_HEURISTIC_CORRELATION_OF_ACCOUNT_PAIRS_BY_SH', 'Corrélation heuristique de paires de comptes par IP partagée, sous-réseau, empreinte d\'appareil/navigateur (User-Agent), horaires de connexion qui se chevauchent et flux de transferts de ressources. Il s\'agit d\'un');
tz_def('ADM_USE_IT_TO_PRIORITISE_WHICH_PAIRS_A_HUMAN_SHO', '&mdash; utilisez-le pour prioriser les paires qu\'un humain doit examiner. Rien n\'est banni automatiquement, sauf si l\'administrateur active le Bannissement Automatique ci-dessous.');
tz_def('ADM_ROW_CAP_REACHED_WHILE_SCANNING_LOGIN_HISTORY', 'Limite de lignes atteinte lors de l\'analyse de l\'historique de connexion (fenêtre large / serveur très actif). Les résultats restent valides mais peuvent être incomplets &mdash; réduisez la fenêtre pour une couverture complète.');
tz_def('ADM_RECEIVED_FROM_OTHER_PLAYERS_VERSUS_AN_AUTOMA', '(reçues d\'autres joueurs) par rapport à une limite automatique dérivée de la production horaire du joueur (');
tz_def('ADM_OF_PRODUCTION_PER_WINDOW_WW_VILLAGES_AND_ART', 'de production par fenêtre). Les villages MdM et les villages à artefact sont marqués comme exceptions d\'approvisionnement. Définissez une dérogation manuelle pour exempter un joueur (MdM / de confiance) ou fixer un plafond personnalisé. Rien n\'est bloqué automatiquement &mdash; ceci offre visibilité et contrôle à un modérateur humain.');
tz_def('ADM_THE_7_DAY_BALANCE_FILLS_IN_AS_MERCHANT_DELIV', 'Le bilan sur 7 jours se remplit à mesure que les livraisons de marchands entre joueurs différents sont traitées après l\'activation de cette fonction.');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
// STATISTICI GRAFICE (Novaterra Plus)
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
tz_def('PLUSSTATS_NEEDPLUS', 'Les statistiques graphiques sont une fonction Novaterra Plus. Activez Plus pour voir l\'évolution de votre compte.');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
tz_def('TZ_WW_NATARS', 'Tatars');
tz_def('CONF_SERV_NATARS_WW_START_DELAY', 'Debut de la Merveille des Tatars');
tz_def('CONF_SERV_NATARS_WW_START_DELAY_TOOLTIP', 'Combien de jours apres l\'apparition des plans de construction les Tatars commencent leur propre Merveille du Monde. Ajuste selon la vitesse du serveur. 0 desactive.');
...
tz_def('TZ_WS_VS_NATARS', 'Contre les Tatars');
