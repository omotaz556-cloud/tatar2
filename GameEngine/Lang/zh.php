...
//COPYRIGHT
tz_def('NOVATERRA_COPYRIGHT', 'Novaterra 100% 开源 Novaterra 克隆。');
...
tz_def('Q2_REWARD', '你的奖励:</p>1 天 Novaterra');
...
tz_def('BEFORE_REGISTER', '在注册账号前你应阅读 Novaterra <a href="/anleitung.php" target="_blank">游戏指南</a> 来了解三个种族各自的优势和劣势。');
...
$lang['index'][0][13] = '与其他真实玩家或对抗、或合作，征服Novaterra游戏世界。';
$lang['index'][0][14] = '新闻';
$lang['index'][0][15] = 'FAQ';
$lang['index'][0][16] = '截图';
$lang['forum'] = '论坛';
...
tz_def('TZ_EVENT', '事件');
tz_def('TZ_FEATURES_OF_NOVATERRA', 'Novaterra 的功能');
...
tz_def('TZ_RELEASED_BY_NOVATERRA_TEAM', '发布者：Novaterra 团队');
tz_def('TZ_RELEASE_BY_NOVATERRA', '[发布者：Novaterra]');
...
tz_def('TZ_ADDITIONALLY_THE_NOVATERRA_TEAM_WILL', '此外，Novaterra 团队不会向账户所有者以外的任何人提供有关封禁的信息。');
tz_def('TZ_ADVERTISEMENT_OF_ANY_KIND_THAT_HAS', '未经 Novaterra 团队许可的任何形式广告均不允许。');
...
tz_def('TZ_ANY_SALES_OR_PURCHASES_CONCERNING', '任何涉及真实货币、关于账户、单位、村庄、资源、服务或 Novaterra 任何其他方面的买卖均不允许。出售 Novaterra 账户以及与拍卖网站或其他金钱交易相关的任何间接转让（即使作为礼物）均不允许。');
...
tz_def('TZ_BLACKMAILING_PLAYERS_IN_A_WAY_THAT', '以违反 Novaterra 任何规则（依据一般条款与条件）的方式勒索玩家。');
...
tz_def('TZ_HERE_YOU_CAN_CHANGE_NOVATERRA_S_DISP', '您可以在此更改 Novaterra 显示的时间以符合您的时区。');
...
tz_def('TZ_INCITING_MANIPULATING_ENCOURAGING', '煽动、操纵、鼓励、协助或与他人串通违反任何 Novaterra 规则均不允许。这些规则无一例外地适用于将要删除或正在删除账户的玩家。');
...
tz_def('TZ_IN_ORDER_TO_PLAY_NOVATERRA_YOU_NEED', '要游玩 Novaterra，您需要一个有效的电子邮件地址以接收激活码。在特殊情况下，此邮件可能无法送达。');
tz_def('TZ_IN_ORDER_TO_QUIT_THE_ALLIANCE_YOU', '出于安全原因，退出联盟时您必须再次输入密码。');
tz_def('TZ_IN_ORDER_TO_SWITCH_AN_ACCOUNT_WITH', '若要在同一游戏世界与他人互换账户，双方必须从该账户当前注册的电子邮件地址向 admin@novaterra.com 发送电子邮件。邮件须包含以下信息：');
tz_def('TZ_IN_THE_BEGINNING_YOUR_SMALL_VILLAG', '一开始，您的小村庄只有一座建筑。');
tz_def('TZ_IN_NOVATERRA_YOU_ARE_NOT_ALONE_YOU_I', '在 Novaterra 中您并不孤单；您会与 Novaterra 世界中成千上万的其他玩家互动。');
...
tz_def('TZ_NOW_YOU_KNOW_EVERYTHING_IMPORTANT', '现在您已了解关于 Novaterra 的所有重要内容。注册后即可开始游戏！');
...
tz_def('TZ_RESOURCES_BUILDINGS_VILLAGES_OR_TR', '暂停期间损失的资源、建筑、村庄或部队不计为处罚，且不会由 Novaterra 团队补偿。任何玩家无权就因暂停而损失的 Plus/金币时间索要赔付或补偿。');
...
tz_def('TZ_THERE_ARE_FOUR_DIFFERENT_TYPES_OF', 'Novaterra 中有四种不同的资源：木材、黏土、铁和粮食。');
tz_def('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG', '对于代理人造成的损害不予补偿。账户所有者对其账户所选代理人的行为负全部责任。如果账户代理人不遵守这些规则及 Novaterra 的一般条款与条件，账户所有者和代理人均可能被追责并受罚。');
tz_def('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG_2', '对于知晓账户密码者造成的损害不予补偿。获得密码的人须遵守 Novaterra 规则及一般条款与条件。');
tz_def('TZ_THERE_IS_NO_SPECIAL_TREATMENT_FOR', '在游戏规则方面，对 Novaterra Plus/金币用户没有特殊待遇，无论是处理案件所需时间还是处罚。');
...
tz_def('TZ_THE_FOLLOWING_SET_OF_RULES_ARE_IN', '以下规则与 Novaterra 的一般条款与条件相结合。您应熟悉一般条款与条件，以确认哪些被允许、哪些被禁止，尤其是在账户因违反规则被封禁的情况下。');
...
tz_def('TZ_THE_NOVATERRA_TEAM_RESERVES_THE_RIGH', 'Novaterra 团队保留随时更改规则的权利。');
...
tz_def('TZ_ML_CHANGELOG_120BUGS', '修复超过 120 个 bug，神器完全修复，投石车和冲车完全修复，自动化塔塔/神器/世界奇迹村庄/世界奇迹建筑图纸，新战斗公式（比旧的更精确），神器自动激活，重写了大量代码。详见 readme 文件！');
tz_def('TZ_ML_CHANGELOG_NEWFORUM', '全新论坛系统，Novaterra 式陷阱公式，修复总管，使用 Plus 时铁匠铺和兵工厂双研究队列');
...
tz_def('TZ_ML_GPACK_ALTER_APPEARANCE', '使用图形包，您可以改变 Novaterra 的外观。您可以从列表中选择一个，或提供自定义路径。');
tz_def('TZ_ML_QUESTIONS_MULTIHUNTER', '。如果您有疑问或想举报违规行为，可以给多猎手发消息。');
tz_def('TZ_ML_AWAY_NO_SITTER', '如果您打算长时间离开且不想设置代理人，可以启用');
tz_def('TZ_ML_ACCOUNT_FROZEN', '。在此期间，您的账户基本处于冻结状态。资源、部队或研究都不会推进，您的村庄也不会被攻击。请记住，这只冻结您的 Novaterra，而非时间。');
...
tz_def('MANUAL_NEW_FEATURES_DESC', '这些是你在原版 Novaterra T3.6 游戏中找不到的新功能。你可以在此详细了解所有新功能。');
tz_def('MANUAL_FAQ', 'Novaterra 常见问题');
