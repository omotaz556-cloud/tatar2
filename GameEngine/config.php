...
define('CRON_KEY', '75e57250309029c71b2774b352769dad94f6fac96c410100');
...
define("COMMENCE","1787176066");

// ***** Server Start Date / Time
define("START_DATE", "20.08.2026");
define("START_TIME", "00:47");
...
if (!function_exists('tz_rtl_stylesheet_tag')) {
    ...
    function tz_rtl_stylesheet_tag($langCode = null, $relPath = '') {
        ...
        if (is_file($rtlDiskPath)) {
            ...
            $tag .= "\n\t" . '<link href="' . htmlspecialchars($rtlHref, ENT_QUOTES) . '?rtl-left70-size980-footer90-align-cap3-homefixed18-natural-scroll" rel="stylesheet" type="text/css" />';
        }
